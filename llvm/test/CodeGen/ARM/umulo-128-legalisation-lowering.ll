...
; ARMV7-NEXT:    orrs r10, r2, r0
; ARMV7-NEXT:    ldr r2, [sp, #88]
...
; ARMV7-NEXT:    ldr r1, [sp, #16] @ 4-byte Reload
...
; ARMV7-NEXT:    str r2, [r8, #8]
; ARMV7-NEXT:    adcs r1, r7, r1
; ARMV7-NEXT:    str r1, [r8, #12]
; ARMV7-NEXT:    orr r1, r3, r9
; ARMV7-NEXT:    ldr r2, [sp, #24] @ 4-byte Reload
; ARMV7-NEXT:    orr r1, r1, r11
