...
; RUN: llc -mtriple=riscv32 -mattr=+zve32x -mattr=+zvmedia %s -o - | FileCheck --check-prefix=RV32ZVMEDIA %s
...
; RUN: llc -mtriple=riscv64 -mattr=+zve32x -mattr=+zvmedia %s -o - | FileCheck --check-prefix=RV64ZVMEDIA %s
...
; RV32ZVMEDIA: .attribute 5, "rv32i2p1_zicsr2p0_zve32x1p0_zvl32b1p0_zvmedia1p0"
...
; RV64ZVMEDIA: .attribute 5, "rv64i2p1_zicsr2p0_zve32x1p0_zvl32b1p0_zvmedia1p0"
