...
; RUN: llc -mtriple=riscv32 -mattr=+zve32x -mattr=+experimental-zvcd %s -o - | FileCheck --check-prefix=RV32ZVCD %s
...
; RUN: llc -mtriple=riscv64 -mattr=+zve32x -mattr=+experimental-zvcd %s -o - | FileCheck --check-prefix=RV64ZVCD %s
...
; RV32ZVCD: .attribute 5, "rv32i2p1_zicsr2p0_zvcd0p1_zve32x1p0_zvl32b1p0"
...
; RV64ZVCD: .attribute 5, "rv64i2p1_zicsr2p0_zvcd0p1_zve32x1p0_zvl32b1p0"
