...
; CHECK-NEXT:    lw a0, 520(sp)
; CHECK-NEXT:    sw a0, 52(sp) # 4-byte Folded Spill
; CHECK-NEXT:    lw a0, 524(sp)
; CHECK-NEXT:    sw a0, 48(sp) # 4-byte Folded Spill
; CHECK-NEXT:    lw a0, 528(sp)
; CHECK-NEXT:    sw a0, 44(sp) # 4-byte Folded Spill
; CHECK-NEXT:    lw a0, 532(sp)
; CHECK-NEXT:    sw a0, 40(sp) # 4-byte Folded Spill
; CHECK-NEXT:    lui a0, %hi(Y1)
; CHECK-NEXT:    lw s5, %lo(Y1)(a0)
; CHECK-NEXT:    lw s9, %lo(Y1+4)(a0)
; CHECK-NEXT:    lw s10, %lo(Y1+8)(a0)
; CHECK-NEXT:    lw s11, %lo(Y1+12)(a0)
; CHECK-NEXT:    sw s5, 296(sp)
; CHECK-NEXT:    sw s9, 300(sp)
; CHECK-NEXT:    sw s10, 304(sp)
; CHECK-NEXT:    sw s11, 308(sp)
...
; CHECK-NEXT:    sw a4, 396(sp)
; CHECK-NEXT:    sw a5, 400(sp)
; CHECK-NEXT:    sw a6, 404(sp)
; CHECK-NEXT:    call __subtf3
...
; CHECK-NEXT:    sw s5, 200(sp)
; CHECK-NEXT:    sw s9, 204(sp)
; CHECK-NEXT:    sw s10, 208(sp)
; CHECK-NEXT:    sw s11, 212(sp)
...
; CHECK-NEXT:    call __multf3
; CHECK-NEXT:    lw s0, 232(sp)
; CHECK-NEXT:    lw s6, 236(sp)
; CHECK-NEXT:    lw s7, 240(sp)
; CHECK-NEXT:    lw s8, 244(sp)
...
; CHECK-NEXT:    lw a3, 48(sp) # 4-byte Folded Reload
; CHECK-NEXT:    sw a3, 364(sp)
; CHECK-NEXT:    lw a3, 44(sp) # 4-byte Folded Reload
; CHECK-NEXT:    sw a3, 368(sp)
; CHECK-NEXT:    lw a3, 40(sp) # 4-byte Folded Reload
; CHECK-NEXT:    sw a3, 372(sp)
; CHECK-NEXT:    call __multf3
...
; CHECK-NEXT:    sw s0, 168(sp)
; CHECK-NEXT:    sw s6, 172(sp)
; CHECK-NEXT:    sw s7, 176(sp)
; CHECK-NEXT:    sw s8, 180(sp)
; CHECK-NEXT:    call __addtf3
...
; CHECK-NEXT:    sw s5, 120(sp)
; CHECK-NEXT:    sw s9, 124(sp)
; CHECK-NEXT:    sw s10, 128(sp)
; CHECK-NEXT:    sw s11, 132(sp)
; CHECK-NEXT:    call __multf3
; CHECK-NEXT:    lw a3, 136(sp)
; CHECK-NEXT:    lw a4, 140(sp)
; CHECK-NEXT:    lw a5, 144(sp)
; CHECK-NEXT:    lw a6, 148(sp)
...
; CHECK-NEXT:    sw a4, 76(sp)
; CHECK-NEXT:    sw a5, 80(sp)
; CHECK-NEXT:    sw a6, 84(sp)
; CHECK-NEXT:    call __addtf3
