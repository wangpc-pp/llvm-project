...
; SSE-NEXT:    pshuflw $212, {{[-0-9]+}}(%r{{[sb]}}p), %xmm6 # 16-byte Folded Reload
; SSE-NEXT:    # xmm6 = mem[0,1,1,3,4,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm6 = xmm6[0,0,2,1]
; SSE-NEXT:    pand %xmm9, %xmm6
; SSE-NEXT:    por %xmm7, %xmm6
; SSE-NEXT:    pshuflw $96, {{[-0-9]+}}(%r{{[sb]}}p), %xmm7 # 16-byte Folded Reload
; SSE-NEXT:    # xmm7 = mem[0,0,2,1,4,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm7 = xmm7[0,1,1,3]
; SSE-NEXT:    movdqa %xmm8, %xmm10
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm1 = xmm11[2,1,3,3,4,5,6,7]
...
; SSE-NEXT:    pandn %xmm2, %xmm4
; SSE-NEXT:    pshufhw {{.*#+}} xmm2 = xmm11[0,1,2,3,6,5,7,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm2 = xmm2[0,2,2,3]
...
; AVX-NEXT:    movq {{[0-9]+}}(%rsp), %rax
; AVX-NEXT:    movq {{[0-9]+}}(%rsp), %r10
; AVX-NEXT:    vmovdqa (%r10), %xmm14
; AVX-NEXT:    vmovdqa (%rax), %xmm4
; AVX-NEXT:    vpunpcklbw {{.*#+}} xmm1 = xmm4[0],xmm14[0],xmm4[1],xmm14[1],xmm4[2],xmm14[2],xmm4[3],xmm14[3],xmm4[4],xmm14[4],xmm4[5],xmm14[5],xmm4[6],xmm14[6],xmm4[7],xmm14[7]
...
; AVX-NEXT:    vpunpcklbw {{.*#+}} xmm12 = xmm9[0],xmm0[0],xmm9[1],xmm0[1],xmm9[2],xmm0[2],xmm9[3],xmm0[3],xmm9[4],xmm0[4],xmm9[5],xmm0[5],xmm9[6],xmm0[6],xmm9[7],xmm0[7]
...
; AVX-NEXT:    vpunpcklbw {{.*#+}} xmm3 = xmm8[0],xmm2[0],xmm8[1],xmm2[1],xmm8[2],xmm2[2],xmm8[3],xmm2[3],xmm8[4],xmm2[4],xmm8[5],xmm2[5],xmm8[6],xmm2[6],xmm8[7],xmm2[7]
...
; AVX-NEXT:    vpunpckhbw {{.*#+}} xmm3 = xmm4[8],xmm14[8],xmm4[9],xmm14[9],xmm4[10],xmm14[10],xmm4[11],xmm14[11],xmm4[12],xmm14[12],xmm4[13],xmm14[13],xmm4[14],xmm14[14],xmm4[15],xmm14[15]
...
; AVX-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm0[0,1,2,3,4,5,5,7]
...
; AVX-NEXT:    vpunpckhbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm8, %xmm0 # 16-byte Folded Reload
; AVX-NEXT:    # xmm0 = xmm8[8],mem[8],xmm8[9],mem[9],xmm8[10],mem[10],xmm8[11],mem[11],xmm8[12],mem[12],xmm8[13],mem[13],xmm8[14],mem[14],xmm8[15],mem[15]
; AVX-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vpshufd {{.*#+}} xmm4 = xmm0[2,3,2,3]
; AVX-NEXT:    vpmovzxwq {{.*#+}} xmm4 = xmm4[0],zero,zero,zero,xmm4[1],zero,zero,zero
; AVX-NEXT:    vpshufd {{.*#+}} xmm9 = xmm0[3,3,3,3]
...
; AVX-NEXT:    vinsertf128 $1, %xmm3, %ymm1, %ymm1
; AVX-NEXT:    vpunpcklbw {{.*#+}} xmm12 = xmm5[0],xmm13[0],xmm5[1],xmm13[1],xmm5[2],xmm13[2],xmm5[3],xmm13[3],xmm5[4],xmm13[4],xmm5[5],xmm13[5],xmm5[6],xmm13[6],xmm5[7],xmm13[7]
...
; AVX-NEXT:    vshufps {{.*#+}} ymm3 = ymm3[0,2,2,3,4,6,6,7]
; AVX-NEXT:    vandps %ymm7, %ymm3, %ymm3
; AVX-NEXT:    vorps %ymm1, %ymm3, %ymm9
; AVX-NEXT:    vmovdqa 16(%rcx), %xmm4
; AVX-NEXT:    vmovdqa 16(%rdx), %xmm1
; AVX-NEXT:    vpunpcklbw {{.*#+}} xmm10 = xmm1[0],xmm4[0],xmm1[1],xmm4[1],xmm1[2],xmm4[2],xmm1[3],xmm4[3],xmm1[4],xmm4[4],xmm1[5],xmm4[5],xmm1[6],xmm4[6],xmm1[7],xmm4[7]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm10[0,1,2,3,4,4,6,5]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm13 = xmm10[0,1,2,3,4,6,6,7]
; AVX-NEXT:    vinsertf128 $1, %xmm13, %ymm3, %ymm0
...
; AVX-NEXT:    vblendps {{.*#+}} ymm9 = ymm0[0],ymm9[1],ymm0[2],ymm9[3],ymm0[4],ymm9[5],ymm0[6],ymm9[7]
; AVX-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX-NEXT:    vpunpckhbw {{.*#+}} xmm6 = xmm0[8],xmm6[8],xmm0[9],xmm6[9],xmm0[10],xmm6[10],xmm0[11],xmm6[11],xmm0[12],xmm6[12],xmm0[13],xmm6[13],xmm0[14],xmm6[14],xmm0[15],xmm6[15]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm6[0,1,2,3,4,4,6,5]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm8 = xmm6[0,1,2,3,4,6,6,7]
; AVX-NEXT:    vinsertf128 $1, %xmm8, %ymm0, %ymm0
; AVX-NEXT:    vpunpckhbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm5, %xmm5 # 16-byte Folded Reload
; AVX-NEXT:    # xmm5 = xmm5[8],mem[8],xmm5[9],mem[9],xmm5[10],mem[10],xmm5[11],mem[11],xmm5[12],mem[12],xmm5[13],mem[13],xmm5[14],mem[14],xmm5[15],mem[15]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm8 = xmm5[0,1,2,3,4,5,5,7]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm15 = xmm5[0,1,2,3,6,5,7,7]
; AVX-NEXT:    vinsertf128 $1, %xmm15, %ymm8, %ymm8
; AVX-NEXT:    vshufps {{.*#+}} ymm0 = ymm0[0,2,2,3,4,6,6,7]
; AVX-NEXT:    vandnps %ymm0, %ymm7, %ymm0
; AVX-NEXT:    vshufps {{.*#+}} ymm8 = ymm8[0,2,2,3,4,6,6,7]
; AVX-NEXT:    vandps %ymm7, %ymm8, %ymm8
; AVX-NEXT:    vorps %ymm0, %ymm8, %ymm0
; AVX-NEXT:    vpunpckhbw {{.*#+}} xmm1 = xmm1[8],xmm4[8],xmm1[9],xmm4[9],xmm1[10],xmm4[10],xmm1[11],xmm4[11],xmm1[12],xmm4[12],xmm1[13],xmm4[13],xmm1[14],xmm4[14],xmm1[15],xmm4[15]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm4 = xmm1[0,1,2,3,4,4,6,5]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm8 = xmm1[0,1,2,3,4,6,6,7]
...
; AVX-NEXT:    vpmovzxwq {{.*#+}} xmm8 = xmm8[0],zero,zero,zero,xmm8[1],zero,zero,zero
; AVX-NEXT:    vpshufd {{.*#+}} xmm13 = xmm3[3,3,3,3]
...
; AVX-NEXT:    vblendps {{.*#+}} ymm13 = ymm4[0],ymm0[1],ymm4[2],ymm0[3],ymm4[4],ymm0[5],ymm4[6],ymm0[7]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm6[0,0,2,1,4,5,6,7]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm6[0,2,2,3,4,5,6,7]
...
; AVX-NEXT:    vorps %ymm1, %ymm3, %ymm1
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0],ymm0[1],ymm1[2],ymm0[3],ymm1[4],ymm0[5],ymm1[6],ymm0[7]
...
; AVX-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0],ymm0[1],ymm3[2],ymm0[3],ymm3[4],ymm0[5],ymm3[6],ymm0[7]
...
; AVX2-NEXT:    vpunpckhbw {{.*#+}} xmm12 = xmm11[8],xmm10[8],xmm11[9],xmm10[9],xmm11[10],xmm10[10],xmm11[11],xmm10[11],xmm11[12],xmm10[12],xmm11[13],xmm10[13],xmm11[14],xmm10[14],xmm11[15],xmm10[15]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm7 = xmm12[0,1,2,3,4,5,5,7]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm10 = xmm12[0,1,2,3,6,5,7,7]
...
; AVX2-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vpunpcklbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm9, %xmm10 # 16-byte Folded Reload
; AVX2-NEXT:    # xmm10 = xmm9[0],mem[0],xmm9[1],mem[1],xmm9[2],mem[2],xmm9[3],mem[3],xmm9[4],mem[4],xmm9[5],mem[5],xmm9[6],mem[6],xmm9[7],mem[7]
; AVX2-NEXT:    vmovdqa %xmm9, %xmm6
...
; AVX2-NEXT:    vpunpcklbw {{.*#+}} xmm13 = xmm4[0],xmm5[0],xmm4[1],xmm5[1],xmm4[2],xmm5[2],xmm4[3],xmm5[3],xmm4[4],xmm5[4],xmm4[5],xmm5[5],xmm4[6],xmm5[6],xmm4[7],xmm5[7]
...
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm9 = xmm14[0,1,2,3,6,5,7,7]
; AVX2-NEXT:    vinserti128 $1, %xmm9, %ymm0, %ymm0
...
; AVX2-NEXT:    vpblendd {{.*#+}} ymm7 = ymm7[0],ymm0[1],ymm7[2],ymm0[3],ymm7[4],ymm0[5],ymm7[6],ymm0[7]
; AVX2-NEXT:    vpunpckhbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm6, %xmm0 # 16-byte Folded Reload
; AVX2-NEXT:    # xmm0 = xmm6[8],mem[8],xmm6[9],mem[9],xmm6[10],mem[10],xmm6[11],mem[11],xmm6[12],mem[12],xmm6[13],mem[13],xmm6[14],mem[14],xmm6[15],mem[15]
; AVX2-NEXT:    vpshufd {{.*#+}} xmm2 = xmm0[2,3,2,3]
; AVX2-NEXT:    vpmovzxwq {{.*#+}} xmm2 = xmm2[0],zero,zero,zero,xmm2[1],zero,zero,zero
; AVX2-NEXT:    vpshufd {{.*#+}} xmm9 = xmm0[3,3,3,3]
; AVX2-NEXT:    vpmovzxwq {{.*#+}} xmm9 = xmm9[0],zero,zero,zero,xmm9[1],zero,zero,zero
; AVX2-NEXT:    vinserti128 $1, %xmm9, %ymm2, %ymm2
; AVX2-NEXT:    vpunpckhbw {{.*#+}} xmm9 = xmm15[8],xmm8[8],xmm15[9],xmm8[9],xmm15[10],xmm8[10],xmm15[11],xmm8[11],xmm15[12],xmm8[12],xmm15[13],xmm8[13],xmm15[14],xmm8[14],xmm15[15],xmm8[15]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm8 = xmm9[0,1,2,3,4,4,6,5]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm15 = xmm9[0,1,2,3,4,6,6,7]
; AVX2-NEXT:    vinserti128 $1, %xmm15, %ymm8, %ymm8
; AVX2-NEXT:    vpshufd {{.*#+}} ymm8 = ymm8[2,1,3,3,6,5,7,7]
; AVX2-NEXT:    vpblendw {{.*#+}} ymm2 = ymm2[0],ymm8[1],ymm2[2,3,4],ymm8[5],ymm2[6,7,8],ymm8[9],ymm2[10,11,12],ymm8[13],ymm2[14,15]
...
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm8 = xmm4[0,1,2,3,4,6,6,7]
...
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm8 = xmm1[0,1,2,3,6,5,7,7]
...
; AVX2-NEXT:    vpblendd {{.*#+}} ymm8 = ymm2[0],ymm3[1],ymm2[2],ymm3[3],ymm2[4],ymm3[5],ymm2[6],ymm3[7]
...
; AVX2-NEXT:    vpblendw {{.*#+}} ymm0 = ymm0[0],ymm2[1],ymm0[2,3,4],ymm2[5],ymm0[6,7,8],ymm2[9],ymm0[10,11,12],ymm2[13],ymm0[14,15]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm4[0,0,2,1,4,5,6,7]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm4[0,2,2,3,4,5,6,7]
; AVX2-NEXT:    vinserti128 $1, %xmm3, %ymm2, %ymm2
...
; AVX2-NEXT:    vpblendd {{.*#+}} ymm9 = ymm0[0],ymm1[1],ymm0[2],ymm1[3],ymm0[4],ymm1[5],ymm0[6],ymm1[7]
; AVX2-NEXT:    vpmovzxwq {{.*#+}} xmm0 = xmm10[0],zero,zero,zero,xmm10[1],zero,zero,zero
; AVX2-NEXT:    vpshufd {{.*#+}} xmm1 = xmm10[1,1,1,1]
; AVX2-NEXT:    vpmovzxwq {{.*#+}} xmm1 = xmm1[0],zero,zero,zero,xmm1[1],zero,zero,zero
; AVX2-NEXT:    vinserti128 $1, %xmm1, %ymm0, %ymm0
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm11[0,0,2,1,4,5,6,7]
; AVX2-NEXT:    vpmovzxdq {{.*#+}} xmm1 = xmm1[0],zero,xmm1[1],zero
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm11[0,2,2,3,4,5,6,7]
; AVX2-NEXT:    vpmovzxdq {{.*#+}} xmm2 = xmm2[0],zero,xmm2[1],zero
...
; AVX2-NEXT:    vinserti128 $1, %xmm2, %ymm1, %ymm1
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm14[0,1,1,3,4,5,6,7]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm14[2,1,3,3,4,5,6,7]
; AVX2-NEXT:    vinserti128 $1, %xmm3, %ymm2, %ymm2
...
; AVX2-NEXT:    vpmovzxwq {{.*#+}} xmm1 = xmm2[0],zero,zero,zero,xmm2[1],zero,zero,zero
...
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm12[2,1,3,3,4,5,6,7]
...
; AVX2-FP-NEXT:    vpunpcklbw {{.*#+}} xmm1 = xmm6[0],xmm7[0],xmm6[1],xmm7[1],xmm6[2],xmm7[2],xmm6[3],xmm7[3],xmm6[4],xmm7[4],xmm6[5],xmm7[5],xmm6[6],xmm7[6],xmm6[7],xmm7[7]
...
; AVX2-FP-NEXT:    vpunpcklbw {{.*#+}} xmm4 = xmm15[0],xmm5[0],xmm15[1],xmm5[1],xmm15[2],xmm5[2],xmm15[3],xmm5[3],xmm15[4],xmm5[4],xmm15[5],xmm5[5],xmm15[6],xmm5[6],xmm15[7],xmm5[7]
...
; AVX2-FP-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm6[8],xmm7[8],xmm6[9],xmm7[9],xmm6[10],xmm7[10],xmm6[11],xmm7[11],xmm6[12],xmm7[12],xmm6[13],xmm7[13],xmm6[14],xmm7[14],xmm6[15],xmm7[15]
...
; AVX2-FP-NEXT:    vpunpckhbw {{.*#+}} xmm1 = xmm15[8],xmm5[8],xmm15[9],xmm5[9],xmm15[10],xmm5[10],xmm15[11],xmm5[11],xmm15[12],xmm5[12],xmm15[13],xmm5[13],xmm15[14],xmm5[14],xmm15[15],xmm5[15]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm1, %ymm1, %ymm2
; AVX2-FP-NEXT:    vmovdqu %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vpunpckhbw {{.*#+}} xmm10 = xmm10[8],xmm3[8],xmm10[9],xmm3[9],xmm10[10],xmm3[10],xmm10[11],xmm3[11],xmm10[12],xmm3[12],xmm10[13],xmm3[13],xmm10[14],xmm3[14],xmm10[15],xmm3[15]
...
; AVX2-FP-NEXT:    vmovdqa 16(%rax), %xmm11
; AVX2-FP-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm11[0],xmm12[0],xmm11[1],xmm12[1],xmm11[2],xmm12[2],xmm11[3],xmm12[3],xmm11[4],xmm12[4],xmm11[5],xmm12[5],xmm11[6],xmm12[6],xmm11[7],xmm12[7]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm3
; AVX2-FP-NEXT:    vmovdqa 16(%r9), %xmm9
; AVX2-FP-NEXT:    vmovdqa 16(%r8), %xmm8
; AVX2-FP-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm8[0],xmm9[0],xmm8[1],xmm9[1],xmm8[2],xmm9[2],xmm8[3],xmm9[3],xmm8[4],xmm9[4],xmm8[5],xmm9[5],xmm8[6],xmm9[6],xmm8[7],xmm9[7]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm2
; AVX2-FP-NEXT:    vpshufb %ymm14, %ymm3, %ymm0
; AVX2-FP-NEXT:    vpshufb %ymm13, %ymm2, %ymm1
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm15 = ymm1[0,1,2],ymm0[3],ymm1[4,5,6],ymm0[7],ymm1[8,9,10],ymm0[11],ymm1[12,13,14],ymm0[15]
; AVX2-FP-NEXT:    vmovdqa 16(%rcx), %xmm7
; AVX2-FP-NEXT:    vmovdqa 16(%rdx), %xmm6
; AVX2-FP-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm6[0],xmm7[0],xmm6[1],xmm7[1],xmm6[2],xmm7[2],xmm6[3],xmm7[3],xmm6[4],xmm7[4],xmm6[5],xmm7[5],xmm6[6],xmm7[6],xmm6[7],xmm7[7]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm1
; AVX2-FP-NEXT:    vmovdqa 16(%rsi), %xmm5
; AVX2-FP-NEXT:    vmovdqa 16(%rdi), %xmm4
; AVX2-FP-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm4[0],xmm5[0],xmm4[1],xmm5[1],xmm4[2],xmm5[2],xmm4[3],xmm5[3],xmm4[4],xmm5[4],xmm4[5],xmm5[5],xmm4[6],xmm5[6],xmm4[7],xmm5[7]
...
; AVX2-FP-NEXT:    vpshufb {{.*#+}} ymm13 = ymm1[8,9,8,9,4,5,6,7,12,13,10,11,12,13,10,11,24,25,28,29,20,21,22,23,28,29,30,31,28,29,30,31]
...
; AVX2-FP-NEXT:    vpunpckhbw {{.*#+}} xmm8 = xmm8[8],xmm9[8],xmm8[9],xmm9[9],xmm8[10],xmm9[10],xmm8[11],xmm9[11],xmm8[12],xmm9[12],xmm8[13],xmm9[13],xmm8[14],xmm9[14],xmm8[15],xmm9[15]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm11, %ymm11, %ymm9
; AVX2-FP-NEXT:    vpshufb {{.*#+}} ymm11 = ymm9[0,1,2,3,8,9,8,9,8,9,8,9,12,13,10,11,16,17,18,19,24,25,28,29,24,25,28,29,28,29,30,31]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm8, %ymm8, %ymm8
; AVX2-FP-NEXT:    vpshufb {{.*#+}} ymm12 = ymm8[0,1,2,3,8,9,10,11,8,9,10,11,10,11,14,15,16,17,18,19,28,29,26,27,28,29,26,27,30,31,30,31]
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm11 = ymm12[0,1,2],ymm11[3],ymm12[4,5,6],ymm11[7],ymm12[8,9,10],ymm11[11],ymm12[12,13,14],ymm11[15]
; AVX2-FP-NEXT:    vpunpckhbw {{.*#+}} xmm6 = xmm6[8],xmm7[8],xmm6[9],xmm7[9],xmm6[10],xmm7[10],xmm6[11],xmm7[11],xmm6[12],xmm7[12],xmm6[13],xmm7[13],xmm6[14],xmm7[14],xmm6[15],xmm7[15]
...
; AVX2-FP-NEXT:    vpshufb {{.*#+}} ymm7 = ymm6[8,9,8,9,4,5,6,7,12,13,10,11,12,13,10,11,24,25,28,29,20,21,22,23,28,29,30,31,28,29,30,31]
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm5 = ymm5[0],ymm7[1],ymm5[2,3,4],ymm7[5],ymm5[6,7,8],ymm7[9],ymm5[10,11,12],ymm7[13],ymm5[14,15]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm11 = ymm5[0],ymm11[1],ymm5[2],ymm11[3],ymm5[4],ymm11[5],ymm5[6],ymm11[7]
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} ymm12 = [0,1,0,1,0,1,0,1,8,9,10,11,4,5,2,3,0,1,4,5,0,1,4,5,8,9,10,11,4,5,6,7]
; AVX2-FP-NEXT:    vpshufb %ymm12, %ymm9, %ymm5
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} ymm9 = [0,1,2,3,0,1,2,3,8,9,10,11,2,3,6,7,4,5,2,3,4,5,2,3,8,9,10,11,6,7,6,7]
; AVX2-FP-NEXT:    vpshufb %ymm9, %ymm8, %ymm7
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm5 = ymm7[0,1,2],ymm5[3],ymm7[4,5,6],ymm5[7],ymm7[8,9,10],ymm5[11],ymm7[12,13,14],ymm5[15]
; AVX2-FP-NEXT:    vpmovsxwq {{.*#+}} xmm8 = [1284,1798]
; AVX2-FP-NEXT:    vpshufb %xmm8, %xmm4, %xmm7
; AVX2-FP-NEXT:    vpmovzxwq {{.*#+}} xmm4 = xmm4[0],zero,zero,zero,xmm4[1],zero,zero,zero
; AVX2-FP-NEXT:    vinserti128 $1, %xmm7, %ymm4, %ymm4
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} ymm7 = [0,1,0,1,4,5,2,3,4,5,2,3,12,13,14,15,0,1,4,5,4,5,6,7,4,5,6,7,12,13,14,15]
...
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm4 = ymm4[0],ymm5[1],ymm4[2],ymm5[3],ymm4[4],ymm5[5],ymm4[6],ymm5[7]
; AVX2-FP-NEXT:    vpshufb %ymm12, %ymm3, %ymm3
; AVX2-FP-NEXT:    vpshufb %ymm9, %ymm2, %ymm2
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm2 = ymm2[0,1,2],ymm3[3],ymm2[4,5,6],ymm3[7],ymm2[8,9,10],ymm3[11],ymm2[12,13,14],ymm3[15]
...
; AVX2-FP-NEXT:    vpshufb %ymm7, %ymm1, %ymm1
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm0 = ymm0[0],ymm1[1],ymm0[2,3,4],ymm1[5],ymm0[6,7,8],ymm1[9],ymm0[10,11,12],ymm1[13],ymm0[14,15]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0],ymm2[1],ymm0[2],ymm2[3],ymm0[4],ymm2[5],ymm0[6],ymm2[7]
...
; AVX2-FP-NEXT:    vpshufb %xmm8, %xmm10, %xmm3
; AVX2-FP-NEXT:    vpmovzxwq {{.*#+}} xmm5 = xmm10[0],zero,zero,zero,xmm10[1],zero,zero,zero
; AVX2-FP-NEXT:    vinserti128 $1, %xmm3, %ymm5, %ymm3
...
; AVX2-FCP-NEXT:    movq {{[0-9]+}}(%rsp), %rax
; AVX2-FCP-NEXT:    movq {{[0-9]+}}(%rsp), %r10
; AVX2-FCP-NEXT:    vmovdqa (%r10), %xmm7
; AVX2-FCP-NEXT:    vmovdqa (%rax), %xmm6
; AVX2-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm1 = xmm6[0],xmm7[0],xmm6[1],xmm7[1],xmm6[2],xmm7[2],xmm6[3],xmm7[3],xmm6[4],xmm7[4],xmm6[5],xmm7[5],xmm6[6],xmm7[6],xmm6[7],xmm7[7]
...
; AVX2-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm4 = xmm15[0],xmm5[0],xmm15[1],xmm5[1],xmm15[2],xmm5[2],xmm15[3],xmm5[3],xmm15[4],xmm5[4],xmm15[5],xmm5[5],xmm15[6],xmm5[6],xmm15[7],xmm5[7]
...
; AVX2-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm6[8],xmm7[8],xmm6[9],xmm7[9],xmm6[10],xmm7[10],xmm6[11],xmm7[11],xmm6[12],xmm7[12],xmm6[13],xmm7[13],xmm6[14],xmm7[14],xmm6[15],xmm7[15]
...
; AVX2-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm1 = xmm15[8],xmm5[8],xmm15[9],xmm5[9],xmm15[10],xmm5[10],xmm15[11],xmm5[11],xmm15[12],xmm5[12],xmm15[13],xmm5[13],xmm15[14],xmm5[14],xmm15[15],xmm5[15]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm1, %ymm1, %ymm2
; AVX2-FCP-NEXT:    vmovdqu %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm10 = xmm10[8],xmm3[8],xmm10[9],xmm3[9],xmm10[10],xmm3[10],xmm10[11],xmm3[11],xmm10[12],xmm3[12],xmm10[13],xmm3[13],xmm10[14],xmm3[14],xmm10[15],xmm3[15]
...
; AVX2-FCP-NEXT:    vmovdqa 16(%rax), %xmm11
; AVX2-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm11[0],xmm12[0],xmm11[1],xmm12[1],xmm11[2],xmm12[2],xmm11[3],xmm12[3],xmm11[4],xmm12[4],xmm11[5],xmm12[5],xmm11[6],xmm12[6],xmm11[7],xmm12[7]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm3
; AVX2-FCP-NEXT:    vmovdqa 16(%r9), %xmm9
; AVX2-FCP-NEXT:    vmovdqa 16(%r8), %xmm8
; AVX2-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm8[0],xmm9[0],xmm8[1],xmm9[1],xmm8[2],xmm9[2],xmm8[3],xmm9[3],xmm8[4],xmm9[4],xmm8[5],xmm9[5],xmm8[6],xmm9[6],xmm8[7],xmm9[7]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm2
; AVX2-FCP-NEXT:    vpshufb %ymm14, %ymm3, %ymm0
; AVX2-FCP-NEXT:    vpshufb %ymm13, %ymm2, %ymm1
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm15 = ymm1[0,1,2],ymm0[3],ymm1[4,5,6],ymm0[7],ymm1[8,9,10],ymm0[11],ymm1[12,13,14],ymm0[15]
; AVX2-FCP-NEXT:    vmovdqa 16(%rcx), %xmm7
; AVX2-FCP-NEXT:    vmovdqa 16(%rdx), %xmm6
; AVX2-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm6[0],xmm7[0],xmm6[1],xmm7[1],xmm6[2],xmm7[2],xmm6[3],xmm7[3],xmm6[4],xmm7[4],xmm6[5],xmm7[5],xmm6[6],xmm7[6],xmm6[7],xmm7[7]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm1
; AVX2-FCP-NEXT:    vmovdqa 16(%rsi), %xmm5
; AVX2-FCP-NEXT:    vmovdqa 16(%rdi), %xmm4
; AVX2-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm4[0],xmm5[0],xmm4[1],xmm5[1],xmm4[2],xmm5[2],xmm4[3],xmm5[3],xmm4[4],xmm5[4],xmm4[5],xmm5[5],xmm4[6],xmm5[6],xmm4[7],xmm5[7]
...
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} ymm13 = ymm1[8,9,8,9,4,5,6,7,12,13,10,11,12,13,10,11,24,25,28,29,20,21,22,23,28,29,30,31,28,29,30,31]
...
; AVX2-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm8 = xmm8[8],xmm9[8],xmm8[9],xmm9[9],xmm8[10],xmm9[10],xmm8[11],xmm9[11],xmm8[12],xmm9[12],xmm8[13],xmm9[13],xmm8[14],xmm9[14],xmm8[15],xmm9[15]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm11, %ymm11, %ymm9
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} ymm11 = ymm9[0,1,2,3,8,9,8,9,8,9,8,9,12,13,10,11,16,17,18,19,24,25,28,29,24,25,28,29,28,29,30,31]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm8, %ymm8, %ymm8
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} ymm12 = ymm8[0,1,2,3,8,9,10,11,8,9,10,11,10,11,14,15,16,17,18,19,28,29,26,27,28,29,26,27,30,31,30,31]
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm11 = ymm12[0,1,2],ymm11[3],ymm12[4,5,6],ymm11[7],ymm12[8,9,10],ymm11[11],ymm12[12,13,14],ymm11[15]
; AVX2-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm6 = xmm6[8],xmm7[8],xmm6[9],xmm7[9],xmm6[10],xmm7[10],xmm6[11],xmm7[11],xmm6[12],xmm7[12],xmm6[13],xmm7[13],xmm6[14],xmm7[14],xmm6[15],xmm7[15]
; AVX2-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm4 = xmm4[8],xmm5[8],xmm4[9],xmm5[9],xmm4[10],xmm5[10],xmm4[11],xmm5[11],xmm4[12],xmm5[12],xmm4[13],xmm5[13],xmm4[14],xmm5[14],xmm4[15],xmm5[15]
...
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} ymm7 = ymm6[8,9,8,9,4,5,6,7,12,13,10,11,12,13,10,11,24,25,28,29,20,21,22,23,28,29,30,31,28,29,30,31]
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm5 = ymm5[0],ymm7[1],ymm5[2,3,4],ymm7[5],ymm5[6,7,8],ymm7[9],ymm5[10,11,12],ymm7[13],ymm5[14,15]
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm11 = ymm5[0],ymm11[1],ymm5[2],ymm11[3],ymm5[4],ymm11[5],ymm5[6],ymm11[7]
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm12 = [0,1,0,1,0,1,0,1,8,9,10,11,4,5,2,3,0,1,4,5,0,1,4,5,8,9,10,11,4,5,6,7]
; AVX2-FCP-NEXT:    vpshufb %ymm12, %ymm9, %ymm5
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm9 = [0,1,2,3,0,1,2,3,8,9,10,11,2,3,6,7,4,5,2,3,4,5,2,3,8,9,10,11,6,7,6,7]
; AVX2-FCP-NEXT:    vpshufb %ymm9, %ymm8, %ymm7
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm5 = ymm7[0,1,2],ymm5[3],ymm7[4,5,6],ymm5[7],ymm7[8,9,10],ymm5[11],ymm7[12,13,14],ymm5[15]
; AVX2-FCP-NEXT:    vpmovsxwq {{.*#+}} xmm8 = [1284,1798]
; AVX2-FCP-NEXT:    vpshufb %xmm8, %xmm4, %xmm7
; AVX2-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm4 = xmm4[0],zero,zero,zero,xmm4[1],zero,zero,zero
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm7, %ymm4, %ymm4
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm7 = [0,1,0,1,4,5,2,3,4,5,2,3,12,13,14,15,0,1,4,5,4,5,6,7,4,5,6,7,12,13,14,15]
...
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm4 = ymm4[0],ymm5[1],ymm4[2],ymm5[3],ymm4[4],ymm5[5],ymm4[6],ymm5[7]
; AVX2-FCP-NEXT:    vpshufb %ymm12, %ymm3, %ymm3
; AVX2-FCP-NEXT:    vpshufb %ymm9, %ymm2, %ymm2
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm2 = ymm2[0,1,2],ymm3[3],ymm2[4,5,6],ymm3[7],ymm2[8,9,10],ymm3[11],ymm2[12,13,14],ymm3[15]
...
; AVX2-FCP-NEXT:    vpshufb %ymm7, %ymm1, %ymm1
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm0 = ymm0[0],ymm1[1],ymm0[2,3,4],ymm1[5],ymm0[6,7,8],ymm1[9],ymm0[10,11,12],ymm1[13],ymm0[14,15]
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0],ymm2[1],ymm0[2],ymm2[3],ymm0[4],ymm2[5],ymm0[6],ymm2[7]
...
; AVX2-FCP-NEXT:    vpshufb %xmm8, %xmm10, %xmm3
; AVX2-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm5 = xmm10[0],zero,zero,zero,xmm10[1],zero,zero,zero
...
; AVX2-FCP-NEXT:    vmovdqa %ymm11, 224(%rax)
...
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm4 = xmm2[0,1,2,3,6,5,7,7]
...
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm3 = xmm9[8],xmm8[8],xmm9[9],xmm8[9],xmm9[10],xmm8[10],xmm9[11],xmm8[11],xmm9[12],xmm8[12],xmm9[13],xmm8[13],xmm9[14],xmm8[14],xmm9[15],xmm8[15]
...
; AVX512-NEXT:    vinserti128 $1, %xmm10, %ymm4, %ymm10
...
; AVX512-NEXT:    vpblendw {{.*#+}} ymm2 = ymm10[0,1,2],ymm2[3],ymm10[4,5,6],ymm2[7],ymm10[8,9,10],ymm2[11],ymm10[12,13,14],ymm2[15]
...
; AVX512-NEXT:    vmovdqa 16(%rdx), %xmm4
; AVX512-NEXT:    vinserti64x4 $1, %ymm2, %zmm0, %zmm20
; AVX512-NEXT:    vpunpcklbw {{.*#+}} xmm15 = xmm4[0],xmm5[0],xmm4[1],xmm5[1],xmm4[2],xmm5[2],xmm4[3],xmm5[3],xmm4[4],xmm5[4],xmm4[5],xmm5[5],xmm4[6],xmm5[6],xmm4[7],xmm5[7]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm15[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm15[0,1,2,3,4,6,6,7]
...
; AVX512-NEXT:    vpshufd {{.*#+}} xmm18 = xmm0[2,3,2,3]
; AVX512-NEXT:    vpmovzxwq {{.*#+}} xmm18 = xmm18[0],zero,zero,zero,xmm18[1],zero,zero,zero
; AVX512-NEXT:    vpshufd {{.*#+}} xmm19 = xmm0[3,3,3,3]
; AVX512-NEXT:    vpmovzxwq {{.*#+}} xmm19 = xmm19[0],zero,zero,zero,xmm19[1],zero,zero,zero
; AVX512-NEXT:    vinserti32x4 $1, %xmm19, %ymm18, %ymm10
; AVX512-NEXT:    vpshufd {{.*#+}} ymm6 = ymm17[2,1,3,3,6,5,7,7]
; AVX512-NEXT:    vpblendw {{.*#+}} ymm6 = ymm10[0],ymm6[1],ymm10[2,3,4],ymm6[5],ymm10[6,7,8],ymm6[9],ymm10[10,11,12],ymm6[13],ymm10[14,15]
; AVX512-NEXT:    vpmovzxwq {{.*#+}} xmm10 = xmm0[0],zero,zero,zero,xmm0[1],zero,zero,zero
; AVX512-NEXT:    vpshufd {{.*#+}} xmm0 = xmm0[1,1,1,1]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm7 = xmm15[0,0,2,1,4,5,6,7]
; AVX512-NEXT:    vpmovzxdq {{.*#+}} xmm7 = xmm7[0],zero,xmm7[1],zero
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm15 = xmm15[0,2,2,3,4,5,6,7]
; AVX512-NEXT:    vpmovzxdq {{.*#+}} xmm15 = xmm15[0],zero,xmm15[1],zero
; AVX512-NEXT:    vpmovzxwq {{.*#+}} xmm0 = xmm0[0],zero,zero,zero,xmm0[1],zero,zero,zero
; AVX512-NEXT:    vinserti128 $1, %xmm0, %ymm10, %ymm0
; AVX512-NEXT:    vinserti128 $1, %xmm15, %ymm7, %ymm7
; AVX512-NEXT:    vpblendw {{.*#+}} ymm0 = ymm0[0],ymm7[1],ymm0[2,3,4],ymm7[5],ymm0[6,7,8],ymm7[9],ymm0[10,11,12],ymm7[13],ymm0[14,15]
; AVX512-NEXT:    vinserti64x4 $1, %ymm6, %zmm0, %zmm15
...
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm7 = xmm0[0,1,2,3,4,6,6,7]
...
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm10 = xmm7[0,1,2,3,4,5,5,7]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm11 = xmm7[0,1,2,3,6,5,7,7]
...
; AVX512-NEXT:    vpshufd {{.*#+}} ymm10 = ymm10[0,2,2,3,4,6,6,7]
; AVX512-NEXT:    vpblendw {{.*#+}} ymm6 = ymm10[0,1,2],ymm6[3],ymm10[4,5,6],ymm6[7],ymm10[8,9,10],ymm6[11],ymm10[12,13,14],ymm6[15]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm10 = xmm7[0,1,1,3,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm7 = xmm7[2,1,3,3,4,5,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm7, %ymm10, %ymm7
; AVX512-NEXT:    vpshufd {{.*#+}} ymm0 = ymm0[0,0,2,1,4,4,6,5]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm7 = ymm7[0,0,2,1,4,4,6,5]
; AVX512-NEXT:    vpblendw {{.*#+}} ymm0 = ymm7[0,1,2],ymm0[3],ymm7[4,5,6],ymm0[7],ymm7[8,9,10],ymm0[11],ymm7[12,13,14],ymm0[15]
; AVX512-NEXT:    vinserti64x4 $1, %ymm6, %zmm0, %zmm11
...
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm6 = xmm4[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm6, %ymm5, %ymm5
; AVX512-NEXT:    vinserti128 $1, %xmm3, %ymm2, %ymm2
; AVX512-NEXT:    vpshufd {{.*#+}} ymm3 = ymm5[2,1,3,3,6,5,7,7]
; AVX512-NEXT:    vpblendw {{.*#+}} ymm2 = ymm2[0],ymm3[1],ymm2[2,3,4],ymm3[5],ymm2[6,7,8],ymm3[9],ymm2[10,11,12],ymm3[13],ymm2[14,15]
; AVX512-NEXT:    vpmovzxwq {{.*#+}} xmm3 = xmm0[0],zero,zero,zero,xmm0[1],zero,zero,zero
; AVX512-NEXT:    vpshufd {{.*#+}} xmm0 = xmm0[1,1,1,1]
; AVX512-NEXT:    vpmovzxwq {{.*#+}} xmm0 = xmm0[0],zero,zero,zero,xmm0[1],zero,zero,zero
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm4[0,0,2,1,4,5,6,7]
; AVX512-NEXT:    vpmovzxdq {{.*#+}} xmm5 = xmm5[0],zero,xmm5[1],zero
; AVX512-NEXT:    vinserti128 $1, %xmm0, %ymm3, %ymm0
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm4[0,2,2,3,4,5,6,7]
; AVX512-NEXT:    vpmovzxdq {{.*#+}} xmm3 = xmm3[0],zero,xmm3[1],zero
...
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm6 = xmm4[0,1,2,3,6,5,7,7]
; AVX512-NEXT:    vinserti128 $1, %xmm6, %ymm5, %ymm5
...
; AVX512-NEXT:    vpblendw {{.*#+}} ymm3 = ymm5[0,1,2],ymm3[3],ymm5[4,5,6],ymm3[7],ymm5[8,9,10],ymm3[11],ymm5[12,13,14],ymm3[15]
...
; AVX512-NEXT:    vpshufd {{.*#+}} xmm4 = xmm3[2,3,2,3]
...
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm8 = xmm6[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm8, %ymm7, %ymm7
; AVX512-NEXT:    vinserti128 $1, %xmm5, %ymm4, %ymm4
; AVX512-NEXT:    vpshufd {{.*#+}} ymm5 = ymm7[2,1,3,3,6,5,7,7]
; AVX512-NEXT:    vpblendw {{.*#+}} ymm4 = ymm4[0],ymm5[1],ymm4[2,3,4],ymm5[5],ymm4[6,7,8],ymm5[9],ymm4[10,11,12],ymm5[13],ymm4[14,15]
; AVX512-NEXT:    vpmovzxwq {{.*#+}} xmm5 = xmm3[0],zero,zero,zero,xmm3[1],zero,zero,zero
; AVX512-NEXT:    vpshufd {{.*#+}} xmm3 = xmm3[1,1,1,1]
; AVX512-NEXT:    vpmovzxwq {{.*#+}} xmm3 = xmm3[0],zero,zero,zero,xmm3[1],zero,zero,zero
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm7 = xmm6[0,0,2,1,4,5,6,7]
; AVX512-NEXT:    vpmovzxdq {{.*#+}} xmm7 = xmm7[0],zero,xmm7[1],zero
; AVX512-NEXT:    vinserti128 $1, %xmm3, %ymm5, %ymm3
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm6[0,2,2,3,4,5,6,7]
; AVX512-NEXT:    vpmovzxdq {{.*#+}} xmm5 = xmm5[0],zero,xmm5[1],zero
; AVX512-NEXT:    vinserti128 $1, %xmm5, %ymm7, %ymm5
; AVX512-NEXT:    vpblendw {{.*#+}} ymm3 = ymm3[0],ymm5[1],ymm3[2,3,4],ymm5[5],ymm3[6,7,8],ymm5[9],ymm3[10,11,12],ymm5[13],ymm3[14,15]
...
; AVX512-NEXT:    vmovdqa32 %zmm11, %zmm2 {%k1}
...
; AVX512-FCP-NEXT:    vpmovsxwq {{.*#+}} ymm15 = [2312,2826,3340,3854]
...
; AVX512-FCP-NEXT:    vmovdqa {{.*#+}} ymm10 = [0,1,0,1,4,5,2,3,4,5,2,3,12,13,14,15,0,1,4,5,4,5,6,7,4,5,6,7,12,13,14,15]
...
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm2, %zmm0, %zmm11
...
; AVX512-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm13 = xmm2[0],xmm3[0],xmm2[1],xmm3[1],xmm2[2],xmm3[2],xmm2[3],xmm3[3],xmm2[4],xmm3[4],xmm2[5],xmm3[5],xmm2[6],xmm3[6],xmm2[7],xmm3[7]
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm13, %ymm13, %ymm13
; AVX512-FCP-NEXT:    vpshufb {{.*#+}} ymm12 = ymm13[u,u,8,9,u,u,u,u,u,u,10,11,u,u,u,u,u,u,28,29,u,u,u,u,u,u,30,31,u,u,u,u]
; AVX512-FCP-NEXT:    vpblendw {{.*#+}} ymm1 = ymm1[0],ymm12[1],ymm1[2,3,4],ymm12[5],ymm1[6,7,8],ymm12[9],ymm1[10,11,12],ymm12[13],ymm1[14,15]
; AVX512-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm12 = xmm0[0],zero,zero,zero,xmm0[1],zero,zero,zero
...
; AVX512-FCP-NEXT:    vpshufb {{.*#+}} ymm12 = ymm13[u,u,0,1,u,u,u,u,u,u,2,3,u,u,u,u,u,u,20,21,u,u,u,u,u,u,22,23,u,u,u,u]
; AVX512-FCP-NEXT:    vpblendw {{.*#+}} ymm0 = ymm0[0],ymm12[1],ymm0[2,3,4],ymm12[5],ymm0[6,7,8],ymm12[9],ymm0[10,11,12],ymm12[13],ymm0[14,15]
...
; AVX512-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm4 = xmm4[0],xmm5[0],xmm4[1],xmm5[1],xmm4[2],xmm5[2],xmm4[3],xmm5[3],xmm4[4],xmm5[4],xmm4[5],xmm5[5],xmm4[6],xmm5[6],xmm4[7],xmm5[7]
...
; AVX512-FCP-NEXT:    vpshufb %xmm13, %xmm4, %xmm6
...
; AVX512-FCP-NEXT:    vmovdqa32 %zmm18, %zmm11 {%k1}
...
; AVX512DQ-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm4[8],xmm3[8],xmm4[9],xmm3[9],xmm4[10],xmm3[10],xmm4[11],xmm3[11],xmm4[12],xmm3[12],xmm4[13],xmm3[13],xmm4[14],xmm3[14],xmm4[15],xmm3[15]
; AVX512DQ-NEXT:    vmovdqa64 %xmm4, %xmm21
; AVX512DQ-NEXT:    vmovdqa64 %xmm3, %xmm22
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm5 = xmm2[0,1,2,3,4,4,6,5]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm6 = xmm2[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm6, %ymm5, %ymm5
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm5 = ymm5[2,1,3,3,6,5,7,7]
; AVX512DQ-NEXT:    vpblendw {{.*#+}} ymm1 = ymm1[0],ymm5[1],ymm1[2,3,4],ymm5[5],ymm1[6,7,8],ymm5[9],ymm1[10,11,12],ymm5[13],ymm1[14,15]
...
; AVX512DQ-NEXT:    vpmovzxdq {{.*#+}} xmm5 = xmm5[0],zero,xmm5[1],zero
...
; AVX512DQ-NEXT:    vpunpckhbw {{.*#+}} xmm9 = xmm8[8],xmm7[8],xmm8[9],xmm7[9],xmm8[10],xmm7[10],xmm8[11],xmm7[11],xmm8[12],xmm7[12],xmm8[13],xmm7[13],xmm8[14],xmm7[14],xmm8[15],xmm7[15]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm14 = xmm9[0,1,2,3,4,5,5,7]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm15 = xmm9[0,1,2,3,6,5,7,7]
...
; AVX512DQ-NEXT:    vpblendw {{.*#+}} ymm2 = ymm14[0,1,2],ymm2[3],ymm14[4,5,6],ymm2[7],ymm14[8,9,10],ymm2[11],ymm14[12,13,14],ymm2[15]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm14 = xmm1[0,0,2,1,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm1[0,2,2,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm1, %ymm14, %ymm1
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm1 = ymm1[0,0,2,1,4,4,6,5]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm14 = xmm9[0,1,1,3,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm9 = xmm9[2,1,3,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm9, %ymm14, %ymm9
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm9 = ymm9[0,0,2,1,4,4,6,5]
; AVX512DQ-NEXT:    vpblendw {{.*#+}} ymm1 = ymm9[0,1,2],ymm1[3],ymm9[4,5,6],ymm1[7],ymm9[8,9,10],ymm1[11],ymm9[12,13,14],ymm1[15]
; AVX512DQ-NEXT:    movw $-21846, %cx # imm = 0xAAAA
; AVX512DQ-NEXT:    kmovw %ecx, %k1
; AVX512DQ-NEXT:    vinserti32x8 $1, %ymm2, %zmm1, %zmm17 {%k1}
; AVX512DQ-NEXT:    vpunpcklbw {{.*#+}} xmm1 = xmm11[0],xmm10[0],xmm11[1],xmm10[1],xmm11[2],xmm10[2],xmm11[3],xmm10[3],xmm11[4],xmm10[4],xmm11[5],xmm10[5],xmm11[6],xmm10[6],xmm11[7],xmm10[7]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} xmm2 = xmm1[2,3,2,3]
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} xmm2 = xmm2[0],zero,zero,zero,xmm2[1],zero,zero,zero
; AVX512DQ-NEXT:    vpshufd {{.*#+}} xmm9 = xmm1[3,3,3,3]
...
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm15[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm3, %ymm14, %ymm3
; AVX512DQ-NEXT:    vinserti128 $1, %xmm9, %ymm2, %ymm2
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm3 = ymm3[2,1,3,3,6,5,7,7]
...
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} xmm3 = xmm1[0],zero,zero,zero,xmm1[1],zero,zero,zero
...
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm15[0,2,2,3,4,5,6,7]
; AVX512DQ-NEXT:    vpmovzxdq {{.*#+}} xmm3 = xmm3[0],zero,xmm3[1],zero
; AVX512DQ-NEXT:    vinserti128 $1, %xmm3, %ymm9, %ymm3
...
; AVX512DQ-NEXT:    vpunpcklbw {{.*#+}} xmm3 = xmm15[0],xmm14[0],xmm15[1],xmm14[1],xmm15[2],xmm14[2],xmm15[3],xmm14[3],xmm15[4],xmm14[4],xmm15[5],xmm14[5],xmm15[6],xmm14[6],xmm15[7],xmm14[7]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm3[0,1,2,3,4,4,6,5]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm3[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm2, %ymm1, %ymm16
; AVX512DQ-NEXT:    vmovdqa 16(%r9), %xmm2
; AVX512DQ-NEXT:    vmovdqa 16(%r8), %xmm1
...
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm9 = xmm0[0,1,2,3,4,5,5,7]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm4 = xmm0[0,1,2,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm4, %ymm9, %ymm4
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm9 = xmm3[0,0,2,1,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm3[0,2,2,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm3, %ymm9, %ymm3
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm9 = xmm0[0,1,1,3,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm0[2,1,3,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm0, %ymm9, %ymm0
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm9 = ymm16[0,2,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm4 = ymm4[0,2,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vpblendw {{.*#+}} ymm4 = ymm4[0,1,2],ymm9[3],ymm4[4,5,6],ymm9[7],ymm4[8,9,10],ymm9[11],ymm4[12,13,14],ymm9[15]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm3 = ymm3[0,0,2,1,4,4,6,5]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm0 = ymm0[0,0,2,1,4,4,6,5]
; AVX512DQ-NEXT:    vpblendw {{.*#+}} ymm0 = ymm0[0,1,2],ymm3[3],ymm0[4,5,6],ymm3[7],ymm0[8,9,10],ymm3[11],ymm0[12,13,14],ymm3[15]
; AVX512DQ-NEXT:    vinserti32x8 $1, %ymm4, %zmm0, %zmm18 {%k1}
...
; AVX512DQ-NEXT:    vpunpckhbw {{.*#+}} xmm9 = xmm13[8],xmm12[8],xmm13[9],xmm12[9],xmm13[10],xmm12[10],xmm13[11],xmm12[11],xmm13[12],xmm12[12],xmm13[13],xmm12[13],xmm13[14],xmm12[14],xmm13[15],xmm12[15]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm10 = xmm9[0,1,2,3,4,4,6,5]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm11 = xmm9[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm11, %ymm10, %ymm10
; AVX512DQ-NEXT:    vinserti128 $1, %xmm4, %ymm3, %ymm3
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm4 = ymm10[2,1,3,3,6,5,7,7]
...
; AVX512DQ-NEXT:    vpshufd {{.*#+}} xmm0 = xmm0[1,1,1,1]
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} xmm0 = xmm0[0],zero,zero,zero,xmm0[1],zero,zero,zero
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm10 = xmm9[0,0,2,1,4,5,6,7]
; AVX512DQ-NEXT:    vpmovzxdq {{.*#+}} xmm10 = xmm10[0],zero,xmm10[1],zero
; AVX512DQ-NEXT:    vinserti128 $1, %xmm0, %ymm4, %ymm0
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm9[0,2,2,3,4,5,6,7]
...
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm4 = xmm1[0,1,2,3,6,5,7,7]
...
; AVX512DQ-NEXT:    vinserti32x8 $1, %ymm2, %zmm0, %zmm10 {%k1}
...
; AVX512DQ-FCP-NEXT:    vpshufb %xmm13, %xmm2, %xmm3
...
; AVX512DQ-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm3 = xmm4[8],xmm0[8],xmm4[9],xmm0[9],xmm4[10],xmm0[10],xmm4[11],xmm0[11],xmm4[12],xmm0[12],xmm4[13],xmm0[13],xmm4[14],xmm0[14],xmm4[15],xmm0[15]
...
; AVX512DQ-FCP-NEXT:    vmovdqa {{.*#+}} ymm14 = [0,1,2,3,8,9,10,11,8,9,10,11,10,11,14,15,0,1,2,3,12,13,10,11,12,13,10,11,14,15,14,15]
; AVX512DQ-FCP-NEXT:    vpshufb %ymm14, %ymm3, %ymm4
; AVX512DQ-FCP-NEXT:    vpblendw {{.*#+}} ymm2 = ymm4[0,1,2],ymm2[3],ymm4[4,5,6],ymm2[7],ymm4[8,9,10],ymm2[11],ymm4[12,13,14],ymm2[15]
; AVX512DQ-FCP-NEXT:    vmovdqa {{.*#+}} ymm15 = [0,1,0,1,0,1,0,1,8,9,10,11,4,5,2,3,0,1,4,5,0,1,4,5,8,9,10,11,4,5,6,7]
...
; AVX512DQ-FCP-NEXT:    vinserti32x8 $1, %ymm2, %zmm1, %zmm17 {%k1}
; AVX512DQ-FCP-NEXT:    vmovdqa 16(%rsi), %xmm10
; AVX512DQ-FCP-NEXT:    vmovdqa 16(%rdi), %xmm9
; AVX512DQ-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm3 = xmm9[0],xmm10[0],xmm9[1],xmm10[1],xmm9[2],xmm10[2],xmm9[3],xmm10[3],xmm9[4],xmm10[4],xmm9[5],xmm10[5],xmm9[6],xmm10[6],xmm9[7],xmm10[7]
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm3, %ymm3, %ymm1
; AVX512DQ-FCP-NEXT:    vpshufb %ymm11, %ymm1, %ymm4
; AVX512DQ-FCP-NEXT:    vmovdqa 16(%rcx), %xmm8
; AVX512DQ-FCP-NEXT:    vmovdqa 16(%rdx), %xmm7
; AVX512DQ-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm5 = xmm7[0],xmm8[0],xmm7[1],xmm8[1],xmm7[2],xmm8[2],xmm7[3],xmm8[3],xmm7[4],xmm8[4],xmm7[5],xmm8[5],xmm7[6],xmm8[6],xmm7[7],xmm8[7]
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm5, %ymm5, %ymm5
; AVX512DQ-FCP-NEXT:    vpshufb {{.*#+}} ymm6 = ymm5[u,u,8,9,u,u,u,u,u,u,10,11,u,u,u,u,u,u,28,29,u,u,u,u,u,u,30,31,u,u,u,u]
; AVX512DQ-FCP-NEXT:    vpblendw {{.*#+}} ymm4 = ymm4[0],ymm6[1],ymm4[2,3,4],ymm6[5],ymm4[6,7,8],ymm6[9],ymm4[10,11,12],ymm6[13],ymm4[14,15]
; AVX512DQ-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm6 = xmm3[0],zero,zero,zero,xmm3[1],zero,zero,zero
; AVX512DQ-FCP-NEXT:    vpshufb %xmm13, %xmm3, %xmm3
; AVX512DQ-FCP-NEXT:    vmovdqa64 %xmm13, %xmm29
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm3, %ymm6, %ymm3
; AVX512DQ-FCP-NEXT:    vpshufb {{.*#+}} ymm5 = ymm5[u,u,0,1,u,u,u,u,u,u,2,3,u,u,u,u,u,u,20,21,u,u,u,u,u,u,22,23,u,u,u,u]
; AVX512DQ-FCP-NEXT:    vpblendw {{.*#+}} ymm3 = ymm3[0],ymm5[1],ymm3[2,3,4],ymm5[5],ymm3[6,7,8],ymm5[9],ymm3[10,11,12],ymm5[13],ymm3[14,15]
; AVX512DQ-FCP-NEXT:    vinserti64x4 $1, %ymm4, %zmm3, %zmm16
; AVX512DQ-FCP-NEXT:    vmovdqa 16(%r10), %xmm6
; AVX512DQ-FCP-NEXT:    vmovdqa 16(%rax), %xmm5
...
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm3, %ymm3, %ymm0
; AVX512DQ-FCP-NEXT:    vmovdqa 16(%r9), %xmm4
; AVX512DQ-FCP-NEXT:    vmovdqa 16(%r8), %xmm3
; AVX512DQ-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm13 = xmm3[0],xmm4[0],xmm3[1],xmm4[1],xmm3[2],xmm4[2],xmm3[3],xmm4[3],xmm3[4],xmm4[4],xmm3[5],xmm4[5],xmm3[6],xmm4[6],xmm3[7],xmm4[7]
...
; AVX512DQ-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm7[8],xmm8[8],xmm7[9],xmm8[9],xmm7[10],xmm8[10],xmm7[11],xmm8[11],xmm7[12],xmm8[12],xmm7[13],xmm8[13],xmm7[14],xmm8[14],xmm7[15],xmm8[15]
...
; AVX512DQ-FCP-NEXT:    vinserti64x4 $1, %ymm2, %zmm0, %zmm0
; AVX512DQ-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm1 = xmm5[8],xmm6[8],xmm5[9],xmm6[9],xmm5[10],xmm6[10],xmm5[11],xmm6[11],xmm5[12],xmm6[12],xmm5[13],xmm6[13],xmm5[14],xmm6[14],xmm5[15],xmm6[15]
; AVX512DQ-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm3[8],xmm4[8],xmm3[9],xmm4[9],xmm3[10],xmm4[10],xmm3[11],xmm4[11],xmm3[12],xmm4[12],xmm3[13],xmm4[13],xmm3[14],xmm4[14],xmm3[15],xmm4[15]
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm1, %ymm1, %ymm1
...
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm3, %ymm3, %ymm3
; AVX512DQ-FCP-NEXT:    vpshufb %ymm14, %ymm3, %ymm5
...
; AVX512BW-NEXT:    movq {{[0-9]+}}(%rsp), %r10
; AVX512BW-NEXT:    movq {{[0-9]+}}(%rsp), %r11
; AVX512BW-NEXT:    vmovdqa64 (%rsi), %xmm22
; AVX512BW-NEXT:    vmovdqa 16(%rsi), %xmm11
; AVX512BW-NEXT:    vmovdqa64 (%rdi), %xmm24
; AVX512BW-NEXT:    vmovdqa 16(%rdi), %xmm12
; AVX512BW-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm24[8],xmm22[8],xmm24[9],xmm22[9],xmm24[10],xmm22[10],xmm24[11],xmm22[11],xmm24[12],xmm22[12],xmm24[13],xmm22[13],xmm24[14],xmm22[14],xmm24[15],xmm22[15]
...
; AVX512BW-NEXT:    vpmovsxbw {{.*#+}} ymm5 = [4,20,0,0,5,21,0,0,6,22,0,0,7,23,0,0]
; AVX512BW-NEXT:    vpermt2w %ymm6, %ymm5, %ymm0
...
; AVX512BW-NEXT:    vpermt2w %zmm16, %zmm10, %zmm20
; AVX512BW-NEXT:    movw $-21846, %cx # imm = 0xAAAA
; AVX512BW-NEXT:    kmovd %ecx, %k1
...
; AVX512BW-NEXT:    vinserti32x4 $1, %xmm21, %ymm20, %ymm1
...
; AVX512BW-NEXT:    vinserti32x4 $1, %xmm23, %ymm21, %ymm2
; AVX512BW-NEXT:    vpblendw {{.*#+}} ymm1 = ymm1[0],ymm2[1],ymm1[2,3,4],ymm2[5],ymm1[6,7,8],ymm2[9],ymm1[10,11,12],ymm2[13],ymm1[14,15]
; AVX512BW-NEXT:    vpermt2w %ymm20, %ymm5, %ymm16
; AVX512BW-NEXT:    vinserti64x4 $1, %ymm16, %zmm1, %zmm16
; AVX512BW-NEXT:    vpunpcklbw {{.*#+}} xmm1 = xmm17[0],xmm15[0],xmm17[1],xmm15[1],xmm17[2],xmm15[2],xmm17[3],xmm15[3],xmm17[4],xmm15[4],xmm17[5],xmm15[5],xmm17[6],xmm15[6],xmm17[7],xmm15[7]
; AVX512BW-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm19[0],xmm18[0],xmm19[1],xmm18[1],xmm19[2],xmm18[2],xmm19[3],xmm18[3],xmm19[4],xmm18[4],xmm19[5],xmm18[5],xmm19[6],xmm18[6],xmm19[7],xmm18[7]
; AVX512BW-NEXT:    vpermt2w %zmm1, %zmm10, %zmm2
; AVX512BW-NEXT:    vmovdqa32 %zmm2, %zmm16 {%k1}
...
; AVX512BW-NEXT:    vpshufd {{.*#+}} xmm11 = xmm1[1,1,1,1]
; AVX512BW-NEXT:    vpmovzxwq {{.*#+}} xmm11 = xmm11[0],zero,zero,zero,xmm11[1],zero,zero,zero
; AVX512BW-NEXT:    vinserti128 $1, %xmm11, %ymm2, %ymm2
...
; AVX512BW-NEXT:    vpblendw {{.*#+}} ymm2 = ymm2[0],ymm12[1],ymm2[2,3,4],ymm12[5],ymm2[6,7,8],ymm12[9],ymm2[10,11,12],ymm12[13],ymm2[14,15]
; AVX512BW-NEXT:    vpermt2w %ymm11, %ymm5, %ymm1
; AVX512BW-NEXT:    vinserti64x4 $1, %ymm1, %zmm2, %zmm1
; AVX512BW-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm17[8],xmm15[8],xmm17[9],xmm15[9],xmm17[10],xmm15[10],xmm17[11],xmm15[11],xmm17[12],xmm15[12],xmm17[13],xmm15[13],xmm17[14],xmm15[14],xmm17[15],xmm15[15]
...
; AVX512BW-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm24[0],xmm22[0],xmm24[1],xmm22[1],xmm24[2],xmm22[2],xmm24[3],xmm22[3],xmm24[4],xmm22[4],xmm24[5],xmm22[5],xmm24[6],xmm22[6],xmm24[7],xmm22[7]
; AVX512BW-NEXT:    vpmovzxwq {{.*#+}} xmm11 = xmm2[0],zero,zero,zero,xmm2[1],zero,zero,zero
; AVX512BW-NEXT:    vpshufd {{.*#+}} xmm12 = xmm2[1,1,1,1]
; AVX512BW-NEXT:    vpmovzxwq {{.*#+}} xmm12 = xmm12[0],zero,zero,zero,xmm12[1],zero,zero,zero
; AVX512BW-NEXT:    vinserti128 $1, %xmm12, %ymm11, %ymm11
...
; AVX512BW-NEXT:    vpshuflw {{.*#+}} xmm12 = xmm3[0,2,2,3,4,5,6,7]
; AVX512BW-NEXT:    vpmovzxdq {{.*#+}} xmm12 = xmm12[0],zero,xmm12[1],zero
; AVX512BW-NEXT:    vinserti128 $1, %xmm12, %ymm4, %ymm4
; AVX512BW-NEXT:    vpblendw {{.*#+}} ymm4 = ymm11[0],ymm4[1],ymm11[2,3,4],ymm4[5],ymm11[6,7,8],ymm4[9],ymm11[10,11,12],ymm4[13],ymm11[14,15]
; AVX512BW-NEXT:    vpermt2w %ymm3, %ymm5, %ymm2
; AVX512BW-NEXT:    vinserti64x4 $1, %ymm2, %zmm4, %zmm2
; AVX512BW-NEXT:    vpunpcklbw {{.*#+}} xmm3 = xmm7[0],xmm6[0],xmm7[1],xmm6[1],xmm7[2],xmm6[2],xmm7[3],xmm6[3],xmm7[4],xmm6[4],xmm7[5],xmm6[5],xmm7[6],xmm6[6],xmm7[7],xmm6[7]
...
; AVX512DQ-BW-NEXT:    movq {{[0-9]+}}(%rsp), %r10
; AVX512DQ-BW-NEXT:    movq {{[0-9]+}}(%rsp), %r11
; AVX512DQ-BW-NEXT:    vmovdqa64 (%rsi), %xmm22
; AVX512DQ-BW-NEXT:    vmovdqa 16(%rsi), %xmm11
; AVX512DQ-BW-NEXT:    vmovdqa64 (%rdi), %xmm24
; AVX512DQ-BW-NEXT:    vmovdqa 16(%rdi), %xmm12
; AVX512DQ-BW-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm24[8],xmm22[8],xmm24[9],xmm22[9],xmm24[10],xmm22[10],xmm24[11],xmm22[11],xmm24[12],xmm22[12],xmm24[13],xmm22[13],xmm24[14],xmm22[14],xmm24[15],xmm22[15]
...
; AVX512DQ-BW-NEXT:    vpmovsxbw {{.*#+}} ymm5 = [4,20,0,0,5,21,0,0,6,22,0,0,7,23,0,0]
; AVX512DQ-BW-NEXT:    vpermt2w %ymm6, %ymm5, %ymm0
...
; AVX512DQ-BW-NEXT:    vpermt2w %zmm16, %zmm10, %zmm20
; AVX512DQ-BW-NEXT:    movw $-21846, %cx # imm = 0xAAAA
; AVX512DQ-BW-NEXT:    kmovd %ecx, %k1
...
; AVX512DQ-BW-NEXT:    vinserti32x4 $1, %xmm21, %ymm20, %ymm1
...
; AVX512DQ-BW-NEXT:    vinserti32x4 $1, %xmm23, %ymm21, %ymm2
; AVX512DQ-BW-NEXT:    vpblendw {{.*#+}} ymm1 = ymm1[0],ymm2[1],ymm1[2,3,4],ymm2[5],ymm1[6,7,8],ymm2[9],ymm1[10,11,12],ymm2[13],ymm1[14,15]
; AVX512DQ-BW-NEXT:    vpermt2w %ymm20, %ymm5, %ymm16
; AVX512DQ-BW-NEXT:    vinserti64x4 $1, %ymm16, %zmm1, %zmm16
; AVX512DQ-BW-NEXT:    vpunpcklbw {{.*#+}} xmm1 = xmm17[0],xmm15[0],xmm17[1],xmm15[1],xmm17[2],xmm15[2],xmm17[3],xmm15[3],xmm17[4],xmm15[4],xmm17[5],xmm15[5],xmm17[6],xmm15[6],xmm17[7],xmm15[7]
; AVX512DQ-BW-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm19[0],xmm18[0],xmm19[1],xmm18[1],xmm19[2],xmm18[2],xmm19[3],xmm18[3],xmm19[4],xmm18[4],xmm19[5],xmm18[5],xmm19[6],xmm18[6],xmm19[7],xmm18[7]
; AVX512DQ-BW-NEXT:    vpermt2w %zmm1, %zmm10, %zmm2
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm2, %zmm16 {%k1}
...
; AVX512DQ-BW-NEXT:    vpshufd {{.*#+}} xmm11 = xmm1[1,1,1,1]
; AVX512DQ-BW-NEXT:    vpmovzxwq {{.*#+}} xmm11 = xmm11[0],zero,zero,zero,xmm11[1],zero,zero,zero
; AVX512DQ-BW-NEXT:    vinserti128 $1, %xmm11, %ymm2, %ymm2
...
; AVX512DQ-BW-NEXT:    vpblendw {{.*#+}} ymm2 = ymm2[0],ymm12[1],ymm2[2,3,4],ymm12[5],ymm2[6,7,8],ymm12[9],ymm2[10,11,12],ymm12[13],ymm2[14,15]
; AVX512DQ-BW-NEXT:    vpermt2w %ymm11, %ymm5, %ymm1
; AVX512DQ-BW-NEXT:    vinserti64x4 $1, %ymm1, %zmm2, %zmm1
; AVX512DQ-BW-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm17[8],xmm15[8],xmm17[9],xmm15[9],xmm17[10],xmm15[10],xmm17[11],xmm15[11],xmm17[12],xmm15[12],xmm17[13],xmm15[13],xmm17[14],xmm15[14],xmm17[15],xmm15[15]
...
; AVX512DQ-BW-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm24[0],xmm22[0],xmm24[1],xmm22[1],xmm24[2],xmm22[2],xmm24[3],xmm22[3],xmm24[4],xmm22[4],xmm24[5],xmm22[5],xmm24[6],xmm22[6],xmm24[7],xmm22[7]
; AVX512DQ-BW-NEXT:    vpmovzxwq {{.*#+}} xmm11 = xmm2[0],zero,zero,zero,xmm2[1],zero,zero,zero
; AVX512DQ-BW-NEXT:    vpshufd {{.*#+}} xmm12 = xmm2[1,1,1,1]
; AVX512DQ-BW-NEXT:    vpmovzxwq {{.*#+}} xmm12 = xmm12[0],zero,zero,zero,xmm12[1],zero,zero,zero
; AVX512DQ-BW-NEXT:    vinserti128 $1, %xmm12, %ymm11, %ymm11
...
; AVX512DQ-BW-NEXT:    vpshuflw {{.*#+}} xmm12 = xmm3[0,2,2,3,4,5,6,7]
; AVX512DQ-BW-NEXT:    vpmovzxdq {{.*#+}} xmm12 = xmm12[0],zero,xmm12[1],zero
; AVX512DQ-BW-NEXT:    vinserti128 $1, %xmm12, %ymm4, %ymm4
; AVX512DQ-BW-NEXT:    vpblendw {{.*#+}} ymm4 = ymm11[0],ymm4[1],ymm11[2,3,4],ymm4[5],ymm11[6,7,8],ymm4[9],ymm11[10,11,12],ymm4[13],ymm11[14,15]
; AVX512DQ-BW-NEXT:    vpermt2w %ymm3, %ymm5, %ymm2
; AVX512DQ-BW-NEXT:    vinserti64x4 $1, %ymm2, %zmm4, %zmm2
; AVX512DQ-BW-NEXT:    vpunpcklbw {{.*#+}} xmm3 = xmm7[0],xmm6[0],xmm7[1],xmm6[1],xmm7[2],xmm6[2],xmm7[3],xmm6[3],xmm7[4],xmm6[4],xmm7[5],xmm6[5],xmm7[6],xmm6[6],xmm7[7],xmm6[7]
...
; AVX-NEXT:    vorps %ymm6, %ymm7, %ymm13
...
; AVX-NEXT:    vorps %ymm1, %ymm3, %ymm1
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0],ymm13[1],ymm1[2],ymm13[3],ymm1[4],ymm13[5],ymm1[6],ymm13[7]
...
; AVX-NEXT:    vpunpckhbw {{.*#+}} xmm5 = xmm8[8],xmm0[8],xmm8[9],xmm0[9],xmm8[10],xmm0[10],xmm8[11],xmm0[11],xmm8[12],xmm0[12],xmm8[13],xmm0[13],xmm8[14],xmm0[14],xmm8[15],xmm0[15]
...
; AVX-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm9[8],xmm0[8],xmm9[9],xmm0[9],xmm9[10],xmm0[10],xmm9[11],xmm0[11],xmm9[12],xmm0[12],xmm9[13],xmm0[13],xmm9[14],xmm0[14],xmm9[15],xmm0[15]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm2[0,1,1,3,4,5,6,7]
...
; AVX-NEXT:    vorps %ymm3, %ymm4, %ymm13
; AVX-NEXT:    vmovdqa 16(%rsi), %xmm7
; AVX-NEXT:    vmovdqa 16(%rdi), %xmm6
; AVX-NEXT:    vpunpckhbw {{.*#+}} xmm10 = xmm6[8],xmm7[8],xmm6[9],xmm7[9],xmm6[10],xmm7[10],xmm6[11],xmm7[11],xmm6[12],xmm7[12],xmm6[13],xmm7[13],xmm6[14],xmm7[14],xmm6[15],xmm7[15]
...
; AVX-NEXT:    vpunpckhbw {{.*#+}} xmm1 = xmm3[8],xmm4[8],xmm3[9],xmm4[9],xmm3[10],xmm4[10],xmm3[11],xmm4[11],xmm3[12],xmm4[12],xmm3[13],xmm4[13],xmm3[14],xmm4[14],xmm3[15],xmm4[15]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm15 = xmm1[0,0,2,1,4,5,6,7]
; AVX-NEXT:    vpmovzxdq {{.*#+}} xmm15 = xmm15[0],zero,xmm15[1],zero
; AVX-NEXT:    vpshuflw {{.*#+}} xmm14 = xmm1[0,2,2,3,4,5,6,7]
...
; AVX-NEXT:    vblendps {{.*#+}} ymm13 = ymm0[0],ymm13[1],ymm0[2],ymm13[3],ymm0[4],ymm13[5],ymm0[6],ymm13[7]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm5[0,1,2,3,4,4,6,5]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm5 = xmm5[0,1,2,3,4,6,6,7]
; AVX-NEXT:    vinsertf128 $1, %xmm5, %ymm0, %ymm0
; AVX-NEXT:    vpshufhw {{.*#+}} xmm5 = xmm2[0,1,2,3,4,5,5,7]
...
; AVX-NEXT:    vorps %ymm0, %ymm2, %ymm0
; AVX-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm1[0,1,2,3,4,4,6,5]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm1[0,1,2,3,4,6,6,7]
...
; AVX-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm6[0],xmm7[0],xmm6[1],xmm7[1],xmm6[2],xmm7[2],xmm6[3],xmm7[3],xmm6[4],xmm7[4],xmm6[5],xmm7[5],xmm6[6],xmm7[6],xmm6[7],xmm7[7]
...
; AVX-NEXT:    vpshufhw {{.*#+}} xmm5 = xmm9[0,1,2,3,6,5,7,7]
; AVX-NEXT:    vinsertf128 $1, %xmm5, %ymm4, %ymm4
; AVX-NEXT:    vshufps {{.*#+}} ymm2 = ymm2[0,2,2,3,4,6,6,7]
...
; AVX-NEXT:    vpshufd {{.*#+}} xmm5 = xmm0[1,1,1,1]
; AVX-NEXT:    vpmovzxwq {{.*#+}} xmm5 = xmm5[0],zero,zero,zero,xmm5[1],zero,zero,zero
; AVX-NEXT:    vpmovzxwq {{.*#+}} xmm7 = xmm0[0],zero,zero,zero,xmm0[1],zero,zero,zero
; AVX-NEXT:    vinsertf128 $1, %xmm5, %ymm7, %ymm5
; AVX-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm7 # 16-byte Reload
; AVX-NEXT:    vpunpckhbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm7, %xmm8 # 16-byte Folded Reload
; AVX-NEXT:    # xmm8 = xmm7[8],mem[8],xmm7[9],mem[9],xmm7[10],mem[10],xmm7[11],mem[11],xmm7[12],mem[12],xmm7[13],mem[13],xmm7[14],mem[14],xmm7[15],mem[15]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm7 = xmm8[0,0,2,1,4,5,6,7]
...
; AVX-NEXT:    vorps %ymm7, %ymm5, %ymm5
; AVX-NEXT:    vblendps {{.*#+}} ymm7 = ymm5[0],ymm2[1],ymm5[2],ymm2[3],ymm5[4],ymm2[5],ymm5[6],ymm2[7]
...
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm14 = xmm15[0,1,1,3,4,5,6,7]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm13 = xmm15[2,1,3,3,4,5,6,7]
...
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm10 = xmm11[0,1,2,3,4,6,6,7]
; AVX2-NEXT:    vinserti128 $1, %xmm10, %ymm9, %ymm9
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm10 = xmm15[0,1,2,3,4,5,5,7]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm11 = xmm15[0,1,2,3,6,5,7,7]
; AVX2-NEXT:    vinserti128 $1, %xmm11, %ymm10, %ymm10
; AVX2-NEXT:    vpblendw {{.*#+}} ymm9 = ymm10[0,1,2,3,4],ymm9[5],ymm10[6],ymm9[7],ymm10[8,9,10,11,12],ymm9[13],ymm10[14],ymm9[15]
; AVX2-NEXT:    vpshufd {{.*#+}} ymm9 = ymm9[0,2,2,3,4,6,6,7]
; AVX2-NEXT:    vpblendd {{.*#+}} ymm8 = ymm8[0],ymm9[1],ymm8[2],ymm9[3],ymm8[4],ymm9[5],ymm8[6],ymm9[7]
...
; AVX2-NEXT:    vpunpckhbw {{.*#+}} xmm4 = xmm9[8],xmm11[8],xmm9[9],xmm11[9],xmm9[10],xmm11[10],xmm9[11],xmm11[11],xmm9[12],xmm11[12],xmm9[13],xmm11[13],xmm9[14],xmm11[14],xmm9[15],xmm11[15]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm4[0,0,2,1,4,5,6,7]
; AVX2-NEXT:    vpmovzxdq {{.*#+}} xmm2 = xmm2[0],zero,xmm2[1],zero
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm4[0,2,2,3,4,5,6,7]
; AVX2-NEXT:    vpmovzxdq {{.*#+}} xmm3 = xmm3[0],zero,xmm3[1],zero
; AVX2-NEXT:    vinserti128 $1, %xmm3, %ymm2, %ymm2
; AVX2-NEXT:    vpblendw {{.*#+}} ymm10 = ymm1[0],ymm2[1],ymm1[2,3,4],ymm2[5],ymm1[6,7,8],ymm2[9],ymm1[10,11,12],ymm2[13],ymm1[14,15]
...
; AVX2-NEXT:    vmovdqa 16(%r8), %xmm3
; AVX2-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm3[8],xmm5[8],xmm3[9],xmm5[9],xmm3[10],xmm5[10],xmm3[11],xmm5[11],xmm3[12],xmm5[12],xmm3[13],xmm5[13],xmm3[14],xmm5[14],xmm3[15],xmm5[15]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm2[0,1,1,3,4,5,6,7]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm15 = xmm2[2,1,3,3,4,5,6,7]
; AVX2-NEXT:    vinserti128 $1, %xmm15, %ymm0, %ymm0
; AVX2-NEXT:    vpblendw {{.*#+}} ymm0 = ymm0[0],ymm1[1],ymm0[2],ymm1[3],ymm0[4,5,6,7,8],ymm1[9],ymm0[10],ymm1[11],ymm0[12,13,14,15]
; AVX2-NEXT:    vpshufd {{.*#+}} ymm0 = ymm0[0,0,2,1,4,4,6,5]
; AVX2-NEXT:    vpblendd {{.*#+}} ymm10 = ymm10[0],ymm0[1],ymm10[2],ymm0[3],ymm10[4],ymm0[5],ymm10[6],ymm0[7]
; AVX2-NEXT:    vpshufd {{.*#+}} xmm0 = xmm8[2,3,2,3]
; AVX2-NEXT:    vpmovzxwq {{.*#+}} xmm0 = xmm0[0],zero,zero,zero,xmm0[1],zero,zero,zero
; AVX2-NEXT:    vpshufd {{.*#+}} xmm1 = xmm8[3,3,3,3]
; AVX2-NEXT:    vpmovzxwq {{.*#+}} xmm1 = xmm1[0],zero,zero,zero,xmm1[1],zero,zero,zero
; AVX2-NEXT:    vinserti128 $1, %xmm1, %ymm0, %ymm0
...
; AVX2-NEXT:    vpblendw {{.*#+}} ymm0 = ymm0[0],ymm1[1],ymm0[2,3,4],ymm1[5],ymm0[6,7,8],ymm1[9],ymm0[10,11,12],ymm1[13],ymm0[14,15]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm13[0,1,2,3,4,4,6,5]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm4 = xmm13[0,1,2,3,4,6,6,7]
; AVX2-NEXT:    vinserti128 $1, %xmm4, %ymm1, %ymm1
...
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm6 = xmm4[0,0,2,1,4,5,6,7]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm7 = xmm4[0,2,2,3,4,5,6,7]
; AVX2-NEXT:    vinserti128 $1, %xmm7, %ymm6, %ymm6
...
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm7 = xmm3[2,1,3,3,4,5,6,7]
...
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} ymm12 = [0,1,2,3,0,1,2,3,8,9,10,11,2,3,6,7,4,5,2,3,4,5,2,3,8,9,10,11,6,7,6,7]
; AVX2-FP-NEXT:    vpshufb %ymm12, %ymm1, %ymm1
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm0 = ymm1[0,1,2],ymm0[3],ymm1[4,5,6],ymm0[7],ymm1[8,9,10],ymm0[11],ymm1[12,13,14],ymm0[15]
...
; AVX2-FP-NEXT:    vpshufb {{.*#+}} ymm2 = ymm2[0,1,0,1,4,5,2,3,4,5,2,3,12,13,14,15,16,17,20,21,20,21,22,23,20,21,22,23,28,29,30,31]
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm1 = ymm1[0],ymm2[1],ymm1[2,3,4],ymm2[5],ymm1[6,7,8],ymm2[9],ymm1[10,11,12],ymm2[13],ymm1[14,15]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm1[0],ymm0[1],ymm1[2],ymm0[3],ymm1[4],ymm0[5],ymm1[6],ymm0[7]
; AVX2-FP-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FP-NEXT:    vpshufb %ymm12, %ymm7, %ymm2
...
; AVX2-FP-NEXT:    vpmovzxwq {{.*#+}} xmm15 = xmm0[0],zero,zero,zero,xmm0[1],zero,zero,zero
; AVX2-FP-NEXT:    vinserti128 $1, %xmm1, %ymm15, %ymm1
; AVX2-FP-NEXT:    vmovdqa 48(%rcx), %xmm15
; AVX2-FP-NEXT:    vmovdqa 48(%rdx), %xmm2
; AVX2-FP-NEXT:    vpunpckhbw {{.*#+}} xmm14 = xmm2[8],xmm15[8],xmm2[9],xmm15[9],xmm2[10],xmm15[10],xmm2[11],xmm15[11],xmm2[12],xmm15[12],xmm2[13],xmm15[13],xmm2[14],xmm15[14],xmm2[15],xmm15[15]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm14, %ymm14, %ymm14
; AVX2-FP-NEXT:    vpshufb {{.*#+}} ymm13 = ymm14[0,1,0,1,4,5,2,3,4,5,2,3,12,13,14,15,16,17,20,21,20,21,22,23,20,21,22,23,28,29,30,31]
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm1 = ymm1[0],ymm13[1],ymm1[2,3,4],ymm13[5],ymm1[6,7,8],ymm13[9],ymm1[10,11,12],ymm13[13],ymm1[14,15]
...
; AVX2-FP-NEXT:    vpshufb %ymm13, %ymm6, %ymm1
; AVX2-FP-NEXT:    vpshufb {{.*#+}} ymm6 = ymm7[0,1,2,3,8,9,10,11,8,9,10,11,10,11,14,15,16,17,18,19,28,29,26,27,28,29,26,27,30,31,30,31]
...
; AVX2-FP-NEXT:    vpshufb %ymm7, %ymm14, %ymm6
; AVX2-FP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
...
; AVX2-FP-NEXT:    vpshufb %ymm12, %ymm1, %ymm4
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm3 = ymm4[0,1,2],ymm3[3],ymm4[4,5,6],ymm3[7],ymm4[8,9,10],ymm3[11],ymm4[12,13,14],ymm3[15]
; AVX2-FP-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm2[0],xmm15[0],xmm2[1],xmm15[1],xmm2[2],xmm15[2],xmm2[3],xmm15[3],xmm2[4],xmm15[4],xmm2[5],xmm15[5],xmm2[6],xmm15[6],xmm2[7],xmm15[7]
...
; AVX2-FP-NEXT:    vpshufb {{.*#+}} ymm7 = ymm14[8,9,8,9,4,5,6,7,12,13,10,11,12,13,10,11,24,25,28,29,20,21,22,23,28,29,30,31,28,29,30,31]
...
; AVX2-FP-NEXT:    vpshufb %ymm14, %ymm1, %ymm4
; AVX2-FP-NEXT:    vpshufb %ymm12, %ymm3, %ymm5
...
; AVX2-FP-NEXT:    vpshufb {{.*#+}} ymm6 = ymm5[0,1,0,1,4,5,2,3,4,5,2,3,12,13,14,15,16,17,20,21,20,21,22,23,20,21,22,23,28,29,30,31]
...
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm1 = ymm2[0,1,2],ymm1[3],ymm2[4,5,6],ymm1[7],ymm2[8,9,10],ymm1[11],ymm2[12,13,14],ymm1[15]
; AVX2-FP-NEXT:    vpshufb {{.*#+}} ymm2 = ymm5[8,9,8,9,4,5,6,7,12,13,10,11,12,13,10,11,24,25,28,29,20,21,22,23,28,29,30,31,28,29,30,31]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
; AVX2-FP-NEXT:    vpshufb %ymm9, %ymm0, %ymm0
...
; AVX2-FP-NEXT:    vpshufb %ymm14, %ymm6, %ymm3
; AVX2-FP-NEXT:    vpshufb %ymm12, %ymm8, %ymm5
...
; AVX2-FP-NEXT:    vpshufb {{.*#+}} ymm11 = ymm15[0,1,0,1,4,5,2,3,4,5,2,3,12,13,14,15,16,17,20,21,20,21,22,23,20,21,22,23,28,29,30,31]
...
; AVX2-FP-NEXT:    vpshufb {{.*#+}} ymm6 = ymm6[0,1,2,3,8,9,8,9,8,9,8,9,12,13,10,11,16,17,18,19,24,25,28,29,24,25,28,29,28,29,30,31]
; AVX2-FP-NEXT:    vpshufb {{.*#+}} ymm8 = ymm8[0,1,2,3,8,9,10,11,8,9,10,11,10,11,14,15,16,17,18,19,28,29,26,27,28,29,26,27,30,31,30,31]
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm6 = ymm8[0,1,2],ymm6[3],ymm8[4,5,6],ymm6[7],ymm8[8,9,10],ymm6[11],ymm8[12,13,14],ymm6[15]
...
; AVX2-FP-NEXT:    vpshufb %ymm12, %ymm2, %ymm4
...
; AVX2-FP-NEXT:    vpmovsxwq {{.*#+}} xmm9 = [1284,1798]
; AVX2-FP-NEXT:    vpshufb %xmm9, %xmm3, %xmm5
...
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} ymm15 = [0,1,2,3,8,9,8,9,8,9,8,9,12,13,10,11,0,1,2,3,8,9,12,13,8,9,12,13,12,13,14,15]
...
; AVX2-FP-NEXT:    vpshufb %xmm9, %xmm8, %xmm9
...
; AVX2-FP-NEXT:    vpshufb {{.*#+}} ymm3 = ymm3[0,1,2,3,8,9,10,11,8,9,10,11,10,11,14,15,16,17,18,19,28,29,26,27,28,29,26,27,30,31,30,31]
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm2 = ymm3[0,1,2],ymm2[3],ymm3[4,5,6],ymm2[7],ymm3[8,9,10],ymm2[11],ymm3[12,13,14],ymm2[15]
; AVX2-FP-NEXT:    vpshufb %ymm14, %ymm5, %ymm3
...
; AVX2-FP-NEXT:    vmovdqa %ymm7, 192(%rax)
; AVX2-FP-NEXT:    vmovups (%rsp), %ymm0 # 32-byte Reload
...
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm12 = [0,1,2,3,0,1,2,3,8,9,10,11,2,3,6,7,4,5,2,3,4,5,2,3,8,9,10,11,6,7,6,7]
; AVX2-FCP-NEXT:    vpshufb %ymm12, %ymm1, %ymm1
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm0 = ymm1[0,1,2],ymm0[3],ymm1[4,5,6],ymm0[7],ymm1[8,9,10],ymm0[11],ymm1[12,13,14],ymm0[15]
...
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} ymm2 = ymm2[0,1,0,1,4,5,2,3,4,5,2,3,12,13,14,15,16,17,20,21,20,21,22,23,20,21,22,23,28,29,30,31]
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm1 = ymm1[0],ymm2[1],ymm1[2,3,4],ymm2[5],ymm1[6,7,8],ymm2[9],ymm1[10,11,12],ymm2[13],ymm1[14,15]
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm1[0],ymm0[1],ymm1[2],ymm0[3],ymm1[4],ymm0[5],ymm1[6],ymm0[7]
; AVX2-FCP-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FCP-NEXT:    vpshufb %ymm12, %ymm7, %ymm2
...
; AVX2-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm15 = xmm0[0],zero,zero,zero,xmm0[1],zero,zero,zero
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm1, %ymm15, %ymm1
; AVX2-FCP-NEXT:    vmovdqa 48(%rcx), %xmm15
; AVX2-FCP-NEXT:    vmovdqa 48(%rdx), %xmm2
; AVX2-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm14 = xmm2[8],xmm15[8],xmm2[9],xmm15[9],xmm2[10],xmm15[10],xmm2[11],xmm15[11],xmm2[12],xmm15[12],xmm2[13],xmm15[13],xmm2[14],xmm15[14],xmm2[15],xmm15[15]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm14, %ymm14, %ymm14
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} ymm13 = ymm14[0,1,0,1,4,5,2,3,4,5,2,3,12,13,14,15,16,17,20,21,20,21,22,23,20,21,22,23,28,29,30,31]
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm1 = ymm1[0],ymm13[1],ymm1[2,3,4],ymm13[5],ymm1[6,7,8],ymm13[9],ymm1[10,11,12],ymm13[13],ymm1[14,15]
...
; AVX2-FCP-NEXT:    vpshufb %ymm13, %ymm6, %ymm1
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} ymm6 = ymm7[0,1,2,3,8,9,10,11,8,9,10,11,10,11,14,15,16,17,18,19,28,29,26,27,28,29,26,27,30,31,30,31]
...
; AVX2-FCP-NEXT:    vpshufb %ymm7, %ymm14, %ymm6
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
...
; AVX2-FCP-NEXT:    vpshufb %ymm12, %ymm1, %ymm4
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm3 = ymm4[0,1,2],ymm3[3],ymm4[4,5,6],ymm3[7],ymm4[8,9,10],ymm3[11],ymm4[12,13,14],ymm3[15]
; AVX2-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm2[0],xmm15[0],xmm2[1],xmm15[1],xmm2[2],xmm15[2],xmm2[3],xmm15[3],xmm2[4],xmm15[4],xmm2[5],xmm15[5],xmm2[6],xmm15[6],xmm2[7],xmm15[7]
...
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} ymm7 = ymm14[8,9,8,9,4,5,6,7,12,13,10,11,12,13,10,11,24,25,28,29,20,21,22,23,28,29,30,31,28,29,30,31]
...
; AVX2-FCP-NEXT:    vpshufb %ymm14, %ymm1, %ymm4
; AVX2-FCP-NEXT:    vpshufb %ymm12, %ymm3, %ymm5
...
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} ymm6 = ymm5[0,1,0,1,4,5,2,3,4,5,2,3,12,13,14,15,16,17,20,21,20,21,22,23,20,21,22,23,28,29,30,31]
...
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm1 = ymm2[0,1,2],ymm1[3],ymm2[4,5,6],ymm1[7],ymm2[8,9,10],ymm1[11],ymm2[12,13,14],ymm1[15]
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} ymm2 = ymm5[8,9,8,9,4,5,6,7,12,13,10,11,12,13,10,11,24,25,28,29,20,21,22,23,28,29,30,31,28,29,30,31]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
; AVX2-FCP-NEXT:    vpshufb %ymm9, %ymm0, %ymm0
...
; AVX2-FCP-NEXT:    vpshufb %ymm14, %ymm6, %ymm3
; AVX2-FCP-NEXT:    vpshufb %ymm12, %ymm8, %ymm5
...
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} ymm11 = ymm15[0,1,0,1,4,5,2,3,4,5,2,3,12,13,14,15,16,17,20,21,20,21,22,23,20,21,22,23,28,29,30,31]
...
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} ymm6 = ymm6[0,1,2,3,8,9,8,9,8,9,8,9,12,13,10,11,16,17,18,19,24,25,28,29,24,25,28,29,28,29,30,31]
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} ymm8 = ymm8[0,1,2,3,8,9,10,11,8,9,10,11,10,11,14,15,16,17,18,19,28,29,26,27,28,29,26,27,30,31,30,31]
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm6 = ymm8[0,1,2],ymm6[3],ymm8[4,5,6],ymm6[7],ymm8[8,9,10],ymm6[11],ymm8[12,13,14],ymm6[15]
...
; AVX2-FCP-NEXT:    vpshufb %ymm12, %ymm2, %ymm4
...
; AVX2-FCP-NEXT:    vpmovsxwq {{.*#+}} xmm9 = [1284,1798]
; AVX2-FCP-NEXT:    vpshufb %xmm9, %xmm3, %xmm5
...
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm15 = [0,1,2,3,8,9,8,9,8,9,8,9,12,13,10,11,0,1,2,3,8,9,12,13,8,9,12,13,12,13,14,15]
...
; AVX2-FCP-NEXT:    vpshufb %xmm9, %xmm8, %xmm9
...
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} ymm3 = ymm3[0,1,2,3,8,9,10,11,8,9,10,11,10,11,14,15,16,17,18,19,28,29,26,27,28,29,26,27,30,31,30,31]
...
; AVX2-FCP-NEXT:    vmovdqa %ymm0, 128(%rax)
; AVX2-FCP-NEXT:    vmovdqa %ymm6, 224(%rax)
; AVX2-FCP-NEXT:    vmovdqa %ymm7, 192(%rax)
; AVX2-FCP-NEXT:    vmovups (%rsp), %ymm0 # 32-byte Reload
...
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm1[0,2,2,3,4,5,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm5, %ymm4, %ymm4
...
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm4 = xmm1[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm1[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm1, %ymm4, %ymm1
; AVX512-NEXT:    vmovdqu %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512-NEXT:    vmovdqa (%r9), %xmm4
; AVX512-NEXT:    vmovdqa %xmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512-NEXT:    vmovdqa 48(%r9), %xmm13
; AVX512-NEXT:    vmovdqa (%r8), %xmm1
; AVX512-NEXT:    vmovdqa %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512-NEXT:    vmovdqa 48(%r8), %xmm14
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm1 = xmm1[8],xmm4[8],xmm1[9],xmm4[9],xmm1[10],xmm4[10],xmm1[11],xmm4[11],xmm1[12],xmm4[12],xmm1[13],xmm4[13],xmm1[14],xmm4[14],xmm1[15],xmm4[15]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm1[0,1,1,3,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm8 = xmm1[2,1,3,3,4,5,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm8, %ymm4, %ymm4
; AVX512-NEXT:    vmovdqu %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm4 = xmm1[0,1,2,3,4,5,5,7]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm1[0,1,2,3,6,5,7,7]
; AVX512-NEXT:    vinserti128 $1, %xmm1, %ymm4, %ymm8
...
; AVX512-NEXT:    vinserti128 $1, %xmm1, %ymm4, %ymm1
; AVX512-NEXT:    vmovdqu %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512-NEXT:    vpunpcklbw {{.*#+}} xmm1 = xmm10[0],xmm5[0],xmm10[1],xmm5[1],xmm10[2],xmm5[2],xmm10[3],xmm5[3],xmm10[4],xmm5[4],xmm10[5],xmm5[5],xmm10[6],xmm5[6],xmm10[7],xmm5[7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm1[0,0,2,1,4,5,6,7]
...
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm1[0,1,1,3,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm12 = xmm1[2,1,3,3,4,5,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm12, %ymm4, %ymm4
; AVX512-NEXT:    vmovdqu %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512-NEXT:    vmovdqa 32(%rdx), %xmm4
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm12 = xmm1[0,1,2,3,4,5,5,7]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm1[0,1,2,3,6,5,7,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm1, %ymm12, %ymm26
...
; AVX512-NEXT:    vinserti32x4 $1, %xmm12, %ymm3, %ymm29
...
; AVX512-NEXT:    vinserti32x4 $1, %xmm2, %ymm3, %ymm31
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm10[8],xmm5[8],xmm10[9],xmm5[9],xmm10[10],xmm5[10],xmm10[11],xmm5[11],xmm10[12],xmm5[12],xmm10[13],xmm5[13],xmm10[14],xmm5[14],xmm10[15],xmm5[15]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm2[0,0,2,1,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm2[0,2,2,3,4,5,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm5, %ymm3, %ymm23
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm2[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm2[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm2, %ymm3, %ymm20
...
; AVX512-NEXT:    vinserti32x4 $1, %xmm5, %ymm3, %ymm19
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm2[0,1,2,3,4,5,5,7]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm2[0,1,2,3,6,5,7,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm2, %ymm3, %ymm18
; AVX512-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm4[0],xmm0[0],xmm4[1],xmm0[1],xmm4[2],xmm0[2],xmm4[3],xmm0[3],xmm4[4],xmm0[4],xmm4[5],xmm0[5],xmm4[6],xmm0[6],xmm4[7],xmm0[7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm2[0,0,2,1,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm10 = xmm2[0,2,2,3,4,5,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm10, %ymm3, %ymm30
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm2[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm2[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm2, %ymm3, %ymm24
; AVX512-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm12[0],xmm1[0],xmm12[1],xmm1[1],xmm12[2],xmm1[2],xmm12[3],xmm1[3],xmm12[4],xmm1[4],xmm12[5],xmm1[5],xmm12[6],xmm1[6],xmm12[7],xmm1[7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm2[0,0,2,1,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm10 = xmm2[0,2,2,3,4,5,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm10, %ymm3, %ymm22
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm2[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm2[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm2, %ymm3, %ymm21
; AVX512-NEXT:    vmovdqa 32(%r9), %xmm2
; AVX512-NEXT:    vmovdqa 32(%r8), %xmm10
; AVX512-NEXT:    vpunpcklbw {{.*#+}} xmm3 = xmm10[0],xmm2[0],xmm10[1],xmm2[1],xmm10[2],xmm2[2],xmm10[3],xmm2[3],xmm10[4],xmm2[4],xmm10[5],xmm2[5],xmm10[6],xmm2[6],xmm10[7],xmm2[7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm13 = xmm3[0,1,1,3,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm14 = xmm3[2,1,3,3,4,5,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm14, %ymm13, %ymm17
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm13 = xmm3[0,1,2,3,4,5,5,7]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm3[0,1,2,3,6,5,7,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm3, %ymm13, %ymm16
...
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm12[8],xmm1[8],xmm12[9],xmm1[9],xmm12[10],xmm1[10],xmm12[11],xmm1[11],xmm12[12],xmm1[12],xmm12[13],xmm1[13],xmm12[14],xmm1[14],xmm12[15],xmm1[15]
...
; AVX512-NEXT:    vmovdqa %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512-NEXT:    vmovdqa 16(%rax), %xmm0
; AVX512-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm0[0],xmm1[0],xmm0[1],xmm1[1],xmm0[2],xmm1[2],xmm0[3],xmm1[3],xmm0[4],xmm1[4],xmm0[5],xmm1[5],xmm0[6],xmm1[6],xmm0[7],xmm1[7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm0[0,0,2,1,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm0[0,2,2,3,4,5,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm4, %ymm1, %ymm25
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm0[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm0, %ymm1, %ymm27
; AVX512-NEXT:    vmovdqa 16(%r9), %xmm15
; AVX512-NEXT:    vmovdqa 16(%r8), %xmm14
; AVX512-NEXT:    vpunpcklbw {{.*#+}} xmm10 = xmm14[0],xmm15[0],xmm14[1],xmm15[1],xmm14[2],xmm15[2],xmm14[3],xmm15[3],xmm14[4],xmm15[4],xmm14[5],xmm15[5],xmm14[6],xmm15[6],xmm14[7],xmm15[7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm10[0,1,1,3,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm6 = xmm10[2,1,3,3,4,5,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm6, %ymm0, %ymm28
; AVX512-NEXT:    vmovdqa (%rsi), %xmm1
; AVX512-NEXT:    vmovdqa %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512-NEXT:    vmovdqa (%rdi), %xmm0
; AVX512-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm1[8],xmm2[8],xmm1[9],xmm2[9],xmm1[10],xmm2[10],xmm1[11],xmm2[11],xmm1[12],xmm2[12],xmm1[13],xmm2[13],xmm1[14],xmm2[14],xmm1[15],xmm2[15]
; AVX512-NEXT:    vpshufd {{.*#+}} xmm11 = xmm0[2,3,2,3]
; AVX512-NEXT:    vpshufd {{.*#+}} xmm9 = xmm0[3,3,3,3]
; AVX512-NEXT:    vpmovzxwq {{.*#+}} xmm1 = xmm0[0],zero,zero,zero,xmm0[1],zero,zero,zero
; AVX512-NEXT:    vpshufd {{.*#+}} xmm0 = xmm0[1,1,1,1]
...
; AVX512-NEXT:    vpshufd {{.*#+}} ymm5 = ymm7[2,1,3,3,6,5,7,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm5, %zmm4, %zmm6
; AVX512-NEXT:    vpbroadcastq {{.*#+}} zmm7 = [65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535]
; AVX512-NEXT:    vpternlogq {{.*#+}} zmm6 = zmm6 ^ (zmm7 & (zmm6 ^ zmm3))
...
; AVX512-NEXT:    vpshufd {{.*#+}} ymm5 = ymm8[0,2,2,3,4,6,6,7]
...
; AVX512-NEXT:    vpandq %zmm8, %zmm4, %zmm4
; AVX512-NEXT:    movw $-21846, %ax # imm = 0xAAAA
; AVX512-NEXT:    kmovw %eax, %k1
; AVX512-NEXT:    vpord %zmm3, %zmm4, %zmm6 {%k1}
; AVX512-NEXT:    vpmovzxwq {{.*#+}} xmm3 = xmm11[0],zero,zero,zero,xmm11[1],zero,zero,zero
...
; AVX512-NEXT:    vpshufd $246, {{[-0-9]+}}(%r{{[sb]}}p), %ymm3 # 32-byte Folded Reload
; AVX512-NEXT:    # ymm3 = mem[2,1,3,3,6,5,7,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm3, %zmm1, %zmm9
; AVX512-NEXT:    vpternlogq {{.*#+}} zmm9 = zmm9 ^ (zmm7 & (zmm9 ^ zmm0))
...
; AVX512-NEXT:    vpshufd {{.*#+}} ymm3 = ymm26[0,2,2,3,4,6,6,7]
...
; AVX512-NEXT:    vpmovzxwq {{.*#+}} xmm0 = xmm0[0],zero,zero,zero,xmm0[1],zero,zero,zero
; AVX512-NEXT:    vpshufd {{.*#+}} xmm1 = xmm2[3,3,3,3]
; AVX512-NEXT:    vpmovzxwq {{.*#+}} xmm1 = xmm1[0],zero,zero,zero,xmm1[1],zero,zero,zero
; AVX512-NEXT:    vinserti128 $1, %xmm1, %ymm0, %ymm0
...
; AVX512-NEXT:    vpshufd {{.*#+}} ymm1 = ymm29[0,1,1,3,4,5,5,7]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm2 = ymm31[2,1,3,3,6,5,7,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm2, %zmm1, %zmm11
; AVX512-NEXT:    vpternlogq {{.*#+}} zmm11 = zmm11 ^ (zmm7 & (zmm11 ^ zmm0))
; AVX512-NEXT:    vpshufd {{.*#+}} ymm0 = ymm23[0,0,2,1,4,4,6,5]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm1 = ymm20[0,2,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm1, %zmm0, %zmm0
...
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm10[0,1,2,3,4,5,5,7]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm10[0,1,2,3,6,5,7,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm1, %ymm0, %ymm18
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm12[8],xmm13[8],xmm12[9],xmm13[9],xmm12[10],xmm13[10],xmm12[11],xmm13[11],xmm12[12],xmm13[12],xmm12[13],xmm13[13],xmm12[14],xmm13[14],xmm12[15],xmm13[15]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm0[0,0,2,1,4,5,6,7]
...
; AVX512-NEXT:    vpshufd {{.*#+}} xmm2 = xmm1[2,3,2,3]
; AVX512-NEXT:    vpmovzxwq {{.*#+}} xmm2 = xmm2[0],zero,zero,zero,xmm2[1],zero,zero,zero
; AVX512-NEXT:    vpshufd {{.*#+}} xmm4 = xmm1[3,3,3,3]
; AVX512-NEXT:    vpmovzxwq {{.*#+}} xmm4 = xmm4[0],zero,zero,zero,xmm4[1],zero,zero,zero
; AVX512-NEXT:    vinserti128 $1, %xmm4, %ymm2, %ymm2
; AVX512-NEXT:    vpmovzxwq {{.*#+}} xmm4 = xmm1[0],zero,zero,zero,xmm1[1],zero,zero,zero
; AVX512-NEXT:    vpshufd {{.*#+}} xmm1 = xmm1[1,1,1,1]
; AVX512-NEXT:    vpmovzxwq {{.*#+}} xmm1 = xmm1[0],zero,zero,zero,xmm1[1],zero,zero,zero
; AVX512-NEXT:    vinserti128 $1, %xmm1, %ymm4, %ymm1
; AVX512-NEXT:    vinserti64x4 $1, %ymm2, %zmm1, %zmm1
; AVX512-NEXT:    vpshufd {{.*#+}} ymm2 = ymm30[0,1,1,3,4,5,5,7]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm4 = ymm24[2,1,3,3,6,5,7,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm4, %zmm2, %zmm2
; AVX512-NEXT:    vpternlogq {{.*#+}} zmm2 = zmm2 ^ (zmm7 & (zmm2 ^ zmm1))
; AVX512-NEXT:    vpshufd {{.*#+}} ymm1 = ymm22[0,0,2,1,4,4,6,5]
...
; AVX512-NEXT:    vpandq %zmm8, %zmm4, %zmm4
; AVX512-NEXT:    vpord %zmm1, %zmm4, %zmm2 {%k1}
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm0[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm0, %ymm1, %ymm19
; AVX512-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX512-NEXT:    vpunpckhbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm0, %xmm0 # 16-byte Folded Reload
; AVX512-NEXT:    # xmm0 = xmm0[8],mem[8],xmm0[9],mem[9],xmm0[10],mem[10],xmm0[11],mem[11],xmm0[12],mem[12],xmm0[13],mem[13],xmm0[14],mem[14],xmm0[15],mem[15]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm0[0,0,2,1,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm0[0,2,2,3,4,5,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm4, %ymm1, %ymm21
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm4 = xmm0[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm0, %ymm4, %ymm22
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm14[8],xmm15[8],xmm14[9],xmm15[9],xmm14[10],xmm15[10],xmm14[11],xmm15[11],xmm14[12],xmm15[12],xmm14[13],xmm15[13],xmm14[14],xmm15[14],xmm14[15],xmm15[15]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm0[0,1,1,3,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm10 = xmm0[2,1,3,3,4,5,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm10, %ymm4, %ymm23
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm10 = xmm0[0,1,2,3,4,5,5,7]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,6,5,7,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm0, %ymm10, %ymm26
; AVX512-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX512-NEXT:    vpunpcklbw (%rsp), %xmm0, %xmm0 # 16-byte Folded Reload
; AVX512-NEXT:    # xmm0 = xmm0[0],mem[0],xmm0[1],mem[1],xmm0[2],mem[2],xmm0[3],mem[3],xmm0[4],mem[4],xmm0[5],mem[5],xmm0[6],mem[6],xmm0[7],mem[7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm13 = xmm0[0,0,2,1,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm14 = xmm0[0,2,2,3,4,5,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm14, %ymm13, %ymm13
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm14 = xmm0[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm0, %ymm14, %ymm14
; AVX512-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX512-NEXT:    vpunpcklbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm0, %xmm0 # 16-byte Folded Reload
; AVX512-NEXT:    # xmm0 = xmm0[0],mem[0],xmm0[1],mem[1],xmm0[2],mem[2],xmm0[3],mem[3],xmm0[4],mem[4],xmm0[5],mem[5],xmm0[6],mem[6],xmm0[7],mem[7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm15 = xmm0[0,0,2,1,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm0[0,2,2,3,4,5,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm1, %ymm15, %ymm15
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm0[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm0, %ymm1, %ymm16
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm1 = xmm5[8],xmm3[8],xmm5[9],xmm3[9],xmm5[10],xmm3[10],xmm5[11],xmm3[11],xmm5[12],xmm3[12],xmm5[13],xmm3[13],xmm5[14],xmm3[14],xmm5[15],xmm3[15]
; AVX512-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX512-NEXT:    vpunpcklbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm0, %xmm0 # 16-byte Folded Reload
; AVX512-NEXT:    # xmm0 = xmm0[0],mem[0],xmm0[1],mem[1],xmm0[2],mem[2],xmm0[3],mem[3],xmm0[4],mem[4],xmm0[5],mem[5],xmm0[6],mem[6],xmm0[7],mem[7]
...
; AVX512-NEXT:    vinserti128 $1, %xmm5, %ymm3, %ymm3
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm5 = xmm0[0,1,2,3,4,5,5,7]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,6,5,7,7]
; AVX512-NEXT:    vinserti128 $1, %xmm0, %ymm5, %ymm5
; AVX512-NEXT:    vmovdqa 16(%rsi), %xmm0
; AVX512-NEXT:    vmovdqa 16(%rdi), %xmm12
; AVX512-NEXT:    vpunpcklbw {{.*#+}} xmm4 = xmm12[0],xmm0[0],xmm12[1],xmm0[1],xmm12[2],xmm0[2],xmm12[3],xmm0[3],xmm12[4],xmm0[4],xmm12[5],xmm0[5],xmm12[6],xmm0[6],xmm12[7],xmm0[7]
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm12[8],xmm0[8],xmm12[9],xmm0[9],xmm12[10],xmm0[10],xmm12[11],xmm0[11],xmm12[12],xmm0[12],xmm12[13],xmm0[13],xmm12[14],xmm0[14],xmm12[15],xmm0[15]
; AVX512-NEXT:    vpshufd {{.*#+}} xmm12 = xmm1[2,3,2,3]
; AVX512-NEXT:    vpmovzxwq {{.*#+}} xmm12 = xmm12[0],zero,zero,zero,xmm12[1],zero,zero,zero
; AVX512-NEXT:    vpshufd {{.*#+}} xmm17 = xmm1[3,3,3,3]
; AVX512-NEXT:    vpmovzxwq {{.*#+}} xmm17 = xmm17[0],zero,zero,zero,xmm17[1],zero,zero,zero
; AVX512-NEXT:    vinserti32x4 $1, %xmm17, %ymm12, %ymm12
; AVX512-NEXT:    vpmovzxwq {{.*#+}} xmm17 = xmm1[0],zero,zero,zero,xmm1[1],zero,zero,zero
; AVX512-NEXT:    vpshufd {{.*#+}} xmm1 = xmm1[1,1,1,1]
; AVX512-NEXT:    vpmovzxwq {{.*#+}} xmm1 = xmm1[0],zero,zero,zero,xmm1[1],zero,zero,zero
; AVX512-NEXT:    vinserti32x4 $1, %xmm1, %ymm17, %ymm1
...
; AVX512-NEXT:    vpshufd $246, {{[-0-9]+}}(%r{{[sb]}}p), %ymm17 # 32-byte Folded Reload
; AVX512-NEXT:    # ymm17 = mem[2,1,3,3,6,5,7,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm17, %zmm12, %zmm17
; AVX512-NEXT:    vpternlogq {{.*#+}} zmm17 = zmm17 ^ (zmm7 & (zmm17 ^ zmm1))
; AVX512-NEXT:    vpshufd $96, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1 # 32-byte Folded Reload
; AVX512-NEXT:    # ymm1 = mem[0,0,2,1,4,4,6,5]
; AVX512-NEXT:    vpshufd $232, {{[-0-9]+}}(%r{{[sb]}}p), %ymm12 # 32-byte Folded Reload
; AVX512-NEXT:    # ymm12 = mem[0,2,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm12, %zmm1, %zmm1
; AVX512-NEXT:    vpandnq %zmm1, %zmm8, %zmm1
...
; AVX512-NEXT:    vinserti64x4 $1, %ymm24, %zmm12, %zmm12
; AVX512-NEXT:    vpandq %zmm8, %zmm12, %zmm12
; AVX512-NEXT:    vpord %zmm1, %zmm12, %zmm17 {%k1}
; AVX512-NEXT:    vpshufd {{.*#+}} xmm1 = xmm4[2,3,2,3]
; AVX512-NEXT:    vpshufd {{.*#+}} xmm12 = xmm4[3,3,3,3]
; AVX512-NEXT:    vpmovzxwq {{.*#+}} xmm24 = xmm4[0],zero,zero,zero,xmm4[1],zero,zero,zero
; AVX512-NEXT:    vpshufd {{.*#+}} xmm4 = xmm4[1,1,1,1]
; AVX512-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm10 # 16-byte Reload
; AVX512-NEXT:    vpunpcklbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm10, %xmm10 # 16-byte Folded Reload
; AVX512-NEXT:    # xmm10 = xmm10[0],mem[0],xmm10[1],mem[1],xmm10[2],mem[2],xmm10[3],mem[3],xmm10[4],mem[4],xmm10[5],mem[5],xmm10[6],mem[6],xmm10[7],mem[7]
; AVX512-NEXT:    vpmovzxwq {{.*#+}} xmm1 = xmm1[0],zero,zero,zero,xmm1[1],zero,zero,zero
; AVX512-NEXT:    vpmovzxwq {{.*#+}} xmm12 = xmm12[0],zero,zero,zero,xmm12[1],zero,zero,zero
; AVX512-NEXT:    vinserti128 $1, %xmm12, %ymm1, %ymm1
; AVX512-NEXT:    vpmovzxwq {{.*#+}} xmm4 = xmm4[0],zero,zero,zero,xmm4[1],zero,zero,zero
; AVX512-NEXT:    vinserti32x4 $1, %xmm4, %ymm24, %ymm4
; AVX512-NEXT:    vpshufd {{.*#+}} xmm12 = xmm0[2,3,2,3]
; AVX512-NEXT:    vpshufd {{.*#+}} xmm24 = xmm0[3,3,3,3]
...
; AVX512-NEXT:    vpternlogq {{.*#+}} zmm4 = zmm4 ^ (zmm7 & (zmm4 ^ zmm1))
; AVX512-NEXT:    vpshufd {{.*#+}} xmm1 = xmm10[2,3,2,3]
; AVX512-NEXT:    vpshufd {{.*#+}} xmm30 = xmm10[3,3,3,3]
; AVX512-NEXT:    vpmovzxwq {{.*#+}} xmm31 = xmm10[0],zero,zero,zero,xmm10[1],zero,zero,zero
; AVX512-NEXT:    vpshufd {{.*#+}} xmm10 = xmm10[1,1,1,1]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm25 = ymm25[0,0,2,1,4,4,6,5]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm27 = ymm27[0,2,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm27, %zmm25, %zmm25
; AVX512-NEXT:    vpshufd {{.*#+}} ymm27 = ymm28[0,0,2,1,4,4,6,5]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm18 = ymm18[0,2,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm18, %zmm27, %zmm18
; AVX512-NEXT:    vpandnq %zmm25, %zmm8, %zmm25
; AVX512-NEXT:    vpandq %zmm8, %zmm18, %zmm18
; AVX512-NEXT:    vpord %zmm25, %zmm18, %zmm4 {%k1}
; AVX512-NEXT:    vpmovzxwq {{.*#+}} xmm12 = xmm12[0],zero,zero,zero,xmm12[1],zero,zero,zero
; AVX512-NEXT:    vpmovzxwq {{.*#+}} xmm18 = xmm24[0],zero,zero,zero,xmm24[1],zero,zero,zero
; AVX512-NEXT:    vinserti32x4 $1, %xmm18, %ymm12, %ymm12
; AVX512-NEXT:    vpmovzxwq {{.*#+}} xmm0 = xmm0[0],zero,zero,zero,xmm0[1],zero,zero,zero
; AVX512-NEXT:    vinserti32x4 $1, %xmm0, %ymm29, %ymm0
; AVX512-NEXT:    vinserti64x4 $1, %ymm12, %zmm0, %zmm0
; AVX512-NEXT:    vpshufd {{.*#+}} ymm12 = ymm20[0,1,1,3,4,5,5,7]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm18 = ymm19[2,1,3,3,6,5,7,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm18, %zmm12, %zmm12
; AVX512-NEXT:    vpternlogq {{.*#+}} zmm12 = zmm12 ^ (zmm7 & (zmm12 ^ zmm0))
; AVX512-NEXT:    vpshufd {{.*#+}} ymm0 = ymm21[0,0,2,1,4,4,6,5]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm18 = ymm22[0,2,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm18, %zmm0, %zmm0
; AVX512-NEXT:    vpshufd {{.*#+}} ymm18 = ymm23[0,0,2,1,4,4,6,5]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm19 = ymm26[0,2,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm19, %zmm18, %zmm18
; AVX512-NEXT:    vpandnq %zmm0, %zmm8, %zmm0
; AVX512-NEXT:    vpandq %zmm8, %zmm18, %zmm18
; AVX512-NEXT:    vpord %zmm0, %zmm18, %zmm12 {%k1}
; AVX512-NEXT:    vpmovzxwq {{.*#+}} xmm0 = xmm1[0],zero,zero,zero,xmm1[1],zero,zero,zero
; AVX512-NEXT:    vpmovzxwq {{.*#+}} xmm1 = xmm30[0],zero,zero,zero,xmm30[1],zero,zero,zero
; AVX512-NEXT:    vinserti128 $1, %xmm1, %ymm0, %ymm0
; AVX512-NEXT:    vpmovzxwq {{.*#+}} xmm1 = xmm10[0],zero,zero,zero,xmm10[1],zero,zero,zero
; AVX512-NEXT:    vinserti32x4 $1, %xmm1, %ymm31, %ymm1
; AVX512-NEXT:    vinserti64x4 $1, %ymm0, %zmm1, %zmm0
; AVX512-NEXT:    vpshufd {{.*#+}} ymm1 = ymm13[0,1,1,3,4,5,5,7]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm10 = ymm14[2,1,3,3,6,5,7,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm10, %zmm1, %zmm1
; AVX512-NEXT:    vpternlogq {{.*#+}} zmm1 = zmm1 ^ (zmm7 & (zmm1 ^ zmm0))
; AVX512-NEXT:    vpshufd {{.*#+}} ymm0 = ymm15[0,0,2,1,4,4,6,5]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm7 = ymm16[0,2,2,3,4,6,6,7]
...
; AVX512-NEXT:    vpord %zmm0, %zmm3, %zmm1 {%k1}
; AVX512-NEXT:    movq {{[0-9]+}}(%rsp), %rax
...
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm2
; AVX512-FCP-NEXT:    vmovdqa {{.*#+}} ymm13 = [8,9,8,9,4,5,6,7,12,13,10,11,12,13,10,11,8,9,12,13,4,5,6,7,12,13,14,15,12,13,14,15]
...
; AVX512-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm9 = xmm5[0],xmm4[0],xmm5[1],xmm4[1],xmm5[2],xmm4[2],xmm5[3],xmm4[3],xmm5[4],xmm4[4],xmm5[5],xmm4[5],xmm5[6],xmm4[6],xmm5[7],xmm4[7]
...
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm15, %zmm9, %zmm6
...
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
; AVX512-FCP-NEXT:    vpshufb %ymm13, %ymm0, %ymm1
...
; AVX512-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm1[0],xmm6[0],xmm1[1],xmm6[1],xmm1[2],xmm6[2],xmm1[3],xmm6[3],xmm1[4],xmm6[4],xmm1[5],xmm6[5],xmm1[6],xmm6[6],xmm1[7],xmm6[7]
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm2
; AVX512-FCP-NEXT:    vpshufb %ymm13, %ymm2, %ymm3
; AVX512-FCP-NEXT:    vpshufb %ymm8, %ymm2, %ymm2
...
; AVX512-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm9 = xmm5[0],xmm4[0],xmm5[1],xmm4[1],xmm5[2],xmm4[2],xmm5[3],xmm4[3],xmm5[4],xmm4[4],xmm5[5],xmm4[5],xmm5[6],xmm4[6],xmm5[7],xmm4[7]
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm9, %ymm9, %ymm9
; AVX512-FCP-NEXT:    vpshufb %ymm7, %ymm9, %ymm0
; AVX512-FCP-NEXT:    vmovdqa %ymm7, %ymm15
; AVX512-FCP-NEXT:    vpshufb %ymm10, %ymm9, %ymm9
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm0, %zmm9, %zmm23
; AVX512-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm1[8],xmm6[8],xmm1[9],xmm6[9],xmm1[10],xmm6[10],xmm1[11],xmm6[11],xmm1[12],xmm6[12],xmm1[13],xmm6[13],xmm1[14],xmm6[14],xmm1[15],xmm6[15]
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
; AVX512-FCP-NEXT:    vpshufb %ymm13, %ymm0, %ymm1
; AVX512-FCP-NEXT:    vpshufb %ymm8, %ymm0, %ymm0
...
; AVX512-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm6 = xmm5[0],xmm4[0],xmm5[1],xmm4[1],xmm5[2],xmm4[2],xmm5[3],xmm4[3],xmm5[4],xmm4[4],xmm5[5],xmm4[5],xmm5[6],xmm4[6],xmm5[7],xmm4[7]
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm6, %ymm6, %ymm6
; AVX512-FCP-NEXT:    vpshufb %ymm7, %ymm6, %ymm9
; AVX512-FCP-NEXT:    vpshufb %ymm10, %ymm6, %ymm6
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm9, %zmm6, %zmm29
; AVX512-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm1[8],xmm0[8],xmm1[9],xmm0[9],xmm1[10],xmm0[10],xmm1[11],xmm0[11],xmm1[12],xmm0[12],xmm1[13],xmm0[13],xmm1[14],xmm0[14],xmm1[15],xmm0[15]
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
; AVX512-FCP-NEXT:    vpshufb %ymm13, %ymm0, %ymm1
; AVX512-FCP-NEXT:    vpshufb %ymm8, %ymm0, %ymm0
...
; AVX512-FCP-NEXT:    vpshufb %ymm10, %ymm0, %ymm0
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm1, %zmm0, %zmm7
; AVX512-FCP-NEXT:    vmovdqa (%rsi), %xmm1
...
; AVX512-FCP-NEXT:    vpbroadcastq {{.*#+}} zmm1 = [65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535]
; AVX512-FCP-NEXT:    vpternlogq {{.*#+}} zmm0 = zmm14 ^ (zmm1 & (zmm0 ^ zmm14))
; AVX512-FCP-NEXT:    vpbroadcastq {{.*#+}} zmm14 = [65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0]
; AVX512-FCP-NEXT:    vpandnq %zmm19, %zmm14, %zmm6
; AVX512-FCP-NEXT:    vpandq %zmm14, %zmm21, %zmm19
; AVX512-FCP-NEXT:    movw $-21846, %ax # imm = 0xAAAA
; AVX512-FCP-NEXT:    kmovw %eax, %k1
; AVX512-FCP-NEXT:    vpord %zmm6, %zmm19, %zmm0 {%k1}
; AVX512-FCP-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm2 # 16-byte Reload
; AVX512-FCP-NEXT:    vpunpcklbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm2, %xmm6 # 16-byte Folded Reload
; AVX512-FCP-NEXT:    # xmm6 = xmm2[0],mem[0],xmm2[1],mem[1],xmm2[2],mem[2],xmm2[3],mem[3],xmm2[4],mem[4],xmm2[5],mem[5],xmm2[6],mem[6],xmm2[7],mem[7]
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm6, %ymm6, %ymm6
; AVX512-FCP-NEXT:    vpshufb %ymm13, %ymm6, %ymm13
; AVX512-FCP-NEXT:    vpshufb %ymm8, %ymm6, %ymm6
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm13, %zmm6, %zmm8
; AVX512-FCP-NEXT:    vmovdqa 48(%rsi), %xmm13
; AVX512-FCP-NEXT:    vmovdqa 48(%rdi), %xmm2
; AVX512-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm6 = xmm2[0],xmm13[0],xmm2[1],xmm13[1],xmm2[2],xmm13[2],xmm2[3],xmm13[3],xmm2[4],xmm13[4],xmm2[5],xmm13[5],xmm2[6],xmm13[6],xmm2[7],xmm13[7]
; AVX512-FCP-NEXT:    vpshufb %xmm9, %xmm6, %xmm3
; AVX512-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm19 = xmm6[0],zero,zero,zero,xmm6[1],zero,zero,zero
; AVX512-FCP-NEXT:    vinserti32x4 $1, %xmm3, %ymm19, %ymm3
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm6, %ymm6, %ymm6
; AVX512-FCP-NEXT:    vpshufb %ymm5, %ymm6, %ymm6
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm6, %zmm3, %zmm6
; AVX512-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm2[8],xmm13[8],xmm2[9],xmm13[9],xmm2[10],xmm13[10],xmm2[11],xmm13[11],xmm2[12],xmm13[12],xmm2[13],xmm13[13],xmm2[14],xmm13[14],xmm2[15],xmm13[15]
; AVX512-FCP-NEXT:    vpshufb %xmm9, %xmm2, %xmm3
; AVX512-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm13 = xmm2[0],zero,zero,zero,xmm2[1],zero,zero,zero
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm3, %ymm13, %ymm3
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm2
; AVX512-FCP-NEXT:    vpshufb %ymm5, %ymm2, %ymm2
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm2, %zmm3, %zmm19
; AVX512-FCP-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm2 # 16-byte Reload
...
; AVX512-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm11 = xmm3[0],xmm2[0],xmm3[1],xmm2[1],xmm3[2],xmm2[2],xmm3[3],xmm2[3],xmm3[4],xmm2[4],xmm3[5],xmm2[5],xmm3[6],xmm2[6],xmm3[7],xmm2[7]
; AVX512-FCP-NEXT:    vpshufb %xmm9, %xmm11, %xmm13
; AVX512-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm21 = xmm11[0],zero,zero,zero,xmm11[1],zero,zero,zero
; AVX512-FCP-NEXT:    vinserti32x4 $1, %xmm13, %ymm21, %ymm13
...
; AVX512-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm3[8],xmm2[8],xmm3[9],xmm2[9],xmm3[10],xmm2[10],xmm3[11],xmm2[11],xmm3[12],xmm2[12],xmm3[13],xmm2[13],xmm3[14],xmm2[14],xmm3[15],xmm2[15]
; AVX512-FCP-NEXT:    vpshufb %xmm9, %xmm2, %xmm3
; AVX512-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm13 = xmm2[0],zero,zero,zero,xmm2[1],zero,zero,zero
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm3, %ymm13, %ymm3
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm2
...
; AVX512-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm13 = xmm10[0],xmm3[0],xmm10[1],xmm3[1],xmm10[2],xmm3[2],xmm10[3],xmm3[3],xmm10[4],xmm3[4],xmm10[5],xmm3[5],xmm10[6],xmm3[6],xmm10[7],xmm3[7]
; AVX512-FCP-NEXT:    vpshufb %xmm9, %xmm13, %xmm4
; AVX512-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm15 = xmm13[0],zero,zero,zero,xmm13[1],zero,zero,zero
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm4, %ymm15, %ymm4
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm13, %ymm13, %ymm13
; AVX512-FCP-NEXT:    vpshufb %ymm5, %ymm13, %ymm13
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm13, %zmm4, %zmm4
; AVX512-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm3 = xmm10[8],xmm3[8],xmm10[9],xmm3[9],xmm10[10],xmm3[10],xmm10[11],xmm3[11],xmm10[12],xmm3[12],xmm10[13],xmm3[13],xmm10[14],xmm3[14],xmm10[15],xmm3[15]
; AVX512-FCP-NEXT:    vpshufb %xmm9, %xmm3, %xmm10
; AVX512-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm13 = xmm3[0],zero,zero,zero,xmm3[1],zero,zero,zero
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm10, %ymm13, %ymm10
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm3, %ymm3, %ymm3
...
; AVX512-FCP-NEXT:    vpunpcklbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm10, %xmm10 # 16-byte Folded Reload
; AVX512-FCP-NEXT:    # xmm10 = xmm10[0],mem[0],xmm10[1],mem[1],xmm10[2],mem[2],xmm10[3],mem[3],xmm10[4],mem[4],xmm10[5],mem[5],xmm10[6],mem[6],xmm10[7],mem[7]
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm10, %ymm10, %ymm13
; AVX512-FCP-NEXT:    vpshufb %ymm5, %ymm13, %ymm5
; AVX512-FCP-NEXT:    vpshufb %xmm9, %xmm10, %xmm9
; AVX512-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm10 = xmm10[0],zero,zero,zero,xmm10[1],zero,zero,zero
...
; AVX512-FCP-NEXT:    vpandnq {{[-0-9]+}}(%r{{[sb]}}p), %zmm14, %zmm9 # 64-byte Folded Reload
; AVX512-FCP-NEXT:    vpandq (%rsp), %zmm14, %zmm10 # 64-byte Folded Reload
; AVX512-FCP-NEXT:    vpord %zmm9, %zmm10, %zmm6 {%k1}
; AVX512-FCP-NEXT:    vpternlogq {{.*#+}} zmm19 = zmm16 ^ (zmm1 & (zmm19 ^ zmm16))
; AVX512-FCP-NEXT:    vpandnq %zmm17, %zmm14, %zmm9
; AVX512-FCP-NEXT:    vpandq %zmm14, %zmm18, %zmm10
; AVX512-FCP-NEXT:    vpord %zmm9, %zmm10, %zmm19 {%k1}
; AVX512-FCP-NEXT:    vpternlogq {{.*#+}} zmm11 = zmm20 ^ (zmm1 & (zmm11 ^ zmm20))
; AVX512-FCP-NEXT:    vpandnq %zmm22, %zmm14, %zmm9
; AVX512-FCP-NEXT:    vpandq %zmm14, %zmm23, %zmm10
; AVX512-FCP-NEXT:    vpord %zmm9, %zmm10, %zmm11 {%k1}
; AVX512-FCP-NEXT:    vpternlogq {{.*#+}} zmm21 = zmm24 ^ (zmm1 & (zmm21 ^ zmm24))
; AVX512-FCP-NEXT:    vpandnq %zmm25, %zmm14, %zmm9
; AVX512-FCP-NEXT:    vpandq %zmm14, %zmm26, %zmm10
; AVX512-FCP-NEXT:    vpord %zmm9, %zmm10, %zmm21 {%k1}
; AVX512-FCP-NEXT:    vpternlogq {{.*#+}} zmm4 = zmm27 ^ (zmm1 & (zmm4 ^ zmm27))
; AVX512-FCP-NEXT:    vpandnq %zmm28, %zmm14, %zmm9
; AVX512-FCP-NEXT:    vpandq %zmm14, %zmm29, %zmm10
; AVX512-FCP-NEXT:    vpord %zmm9, %zmm10, %zmm4 {%k1}
; AVX512-FCP-NEXT:    vpternlogq {{.*#+}} zmm3 = zmm30 ^ (zmm1 & (zmm3 ^ zmm30))
; AVX512-FCP-NEXT:    vpandnq %zmm31, %zmm14, %zmm9
; AVX512-FCP-NEXT:    vpandq %zmm14, %zmm7, %zmm7
; AVX512-FCP-NEXT:    vpord %zmm9, %zmm7, %zmm3 {%k1}
; AVX512-FCP-NEXT:    vpternlogq {{.*#+}} zmm5 = zmm8 ^ (zmm1 & (zmm5 ^ zmm8))
; AVX512-FCP-NEXT:    vpandnq %zmm12, %zmm14, %zmm1
; AVX512-FCP-NEXT:    vpandq %zmm14, %zmm2, %zmm2
; AVX512-FCP-NEXT:    vpord %zmm1, %zmm2, %zmm5 {%k1}
; AVX512-FCP-NEXT:    movq {{[0-9]+}}(%rsp), %rax
...
; AVX512-FCP-NEXT:    vmovdqa64 %zmm19, 448(%rax)
...
; AVX512DQ-NEXT:    vmovdqa %xmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512DQ-NEXT:    vmovdqa 48(%r9), %xmm13
; AVX512DQ-NEXT:    vmovdqa (%r8), %xmm1
; AVX512DQ-NEXT:    vmovdqa %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512DQ-NEXT:    vmovdqa 48(%r8), %xmm14
; AVX512DQ-NEXT:    vpunpckhbw {{.*#+}} xmm1 = xmm1[8],xmm4[8],xmm1[9],xmm4[9],xmm1[10],xmm4[10],xmm1[11],xmm4[11],xmm1[12],xmm4[12],xmm1[13],xmm4[13],xmm1[14],xmm4[14],xmm1[15],xmm4[15]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm1[0,1,1,3,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm8 = xmm1[2,1,3,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm8, %ymm4, %ymm4
; AVX512DQ-NEXT:    vmovdqu %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm4 = xmm1[0,1,2,3,4,5,5,7]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm1[0,1,2,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm1, %ymm4, %ymm8
...
; AVX512DQ-NEXT:    vinserti128 $1, %xmm1, %ymm4, %ymm1
; AVX512DQ-NEXT:    vmovdqu %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512DQ-NEXT:    vpunpcklbw {{.*#+}} xmm1 = xmm10[0],xmm5[0],xmm10[1],xmm5[1],xmm10[2],xmm5[2],xmm10[3],xmm5[3],xmm10[4],xmm5[4],xmm10[5],xmm5[5],xmm10[6],xmm5[6],xmm10[7],xmm5[7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm1[0,0,2,1,4,5,6,7]
...
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm1[0,1,1,3,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm12 = xmm1[2,1,3,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm12, %ymm4, %ymm4
; AVX512DQ-NEXT:    vmovdqu %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512DQ-NEXT:    vmovdqa 32(%rdx), %xmm4
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm12 = xmm1[0,1,2,3,4,5,5,7]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm1[0,1,2,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm1, %ymm12, %ymm26
...
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm12, %ymm3, %ymm29
...
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm2, %ymm3, %ymm31
; AVX512DQ-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm10[8],xmm5[8],xmm10[9],xmm5[9],xmm10[10],xmm5[10],xmm10[11],xmm5[11],xmm10[12],xmm5[12],xmm10[13],xmm5[13],xmm10[14],xmm5[14],xmm10[15],xmm5[15]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm2[0,0,2,1,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm2[0,2,2,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm5, %ymm3, %ymm23
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm2[0,1,2,3,4,4,6,5]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm2[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm2, %ymm3, %ymm20
...
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm5, %ymm3, %ymm19
...
; AVX512DQ-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm4[0],xmm0[0],xmm4[1],xmm0[1],xmm4[2],xmm0[2],xmm4[3],xmm0[3],xmm4[4],xmm0[4],xmm4[5],xmm0[5],xmm4[6],xmm0[6],xmm4[7],xmm0[7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm2[0,0,2,1,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm10 = xmm2[0,2,2,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm10, %ymm3, %ymm30
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm2[0,1,2,3,4,4,6,5]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm2[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm2, %ymm3, %ymm24
; AVX512DQ-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm12[0],xmm1[0],xmm12[1],xmm1[1],xmm12[2],xmm1[2],xmm12[3],xmm1[3],xmm12[4],xmm1[4],xmm12[5],xmm1[5],xmm12[6],xmm1[6],xmm12[7],xmm1[7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm2[0,0,2,1,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm10 = xmm2[0,2,2,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm10, %ymm3, %ymm22
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm2[0,1,2,3,4,4,6,5]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm2[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm2, %ymm3, %ymm21
; AVX512DQ-NEXT:    vmovdqa 32(%r9), %xmm2
; AVX512DQ-NEXT:    vmovdqa 32(%r8), %xmm10
; AVX512DQ-NEXT:    vpunpcklbw {{.*#+}} xmm3 = xmm10[0],xmm2[0],xmm10[1],xmm2[1],xmm10[2],xmm2[2],xmm10[3],xmm2[3],xmm10[4],xmm2[4],xmm10[5],xmm2[5],xmm10[6],xmm2[6],xmm10[7],xmm2[7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm13 = xmm3[0,1,1,3,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm14 = xmm3[2,1,3,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm14, %ymm13, %ymm17
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm13 = xmm3[0,1,2,3,4,5,5,7]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm3[0,1,2,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm3, %ymm13, %ymm16
...
; AVX512DQ-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm12[8],xmm1[8],xmm12[9],xmm1[9],xmm12[10],xmm1[10],xmm12[11],xmm1[11],xmm12[12],xmm1[12],xmm12[13],xmm1[13],xmm12[14],xmm1[14],xmm12[15],xmm1[15]
...
; AVX512DQ-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512DQ-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm10[8],xmm2[8],xmm10[9],xmm2[9],xmm10[10],xmm2[10],xmm10[11],xmm2[11],xmm10[12],xmm2[12],xmm10[13],xmm2[13],xmm10[14],xmm2[14],xmm10[15],xmm2[15]
...
; AVX512DQ-NEXT:    vmovdqa %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512DQ-NEXT:    vmovdqa 16(%rax), %xmm0
; AVX512DQ-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512DQ-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm0[0],xmm1[0],xmm0[1],xmm1[1],xmm0[2],xmm1[2],xmm0[3],xmm1[3],xmm0[4],xmm1[4],xmm0[5],xmm1[5],xmm0[6],xmm1[6],xmm0[7],xmm1[7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm0[0,0,2,1,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm0[0,2,2,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm4, %ymm1, %ymm25
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm0[0,1,2,3,4,4,6,5]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm0, %ymm1, %ymm27
; AVX512DQ-NEXT:    vmovdqa 16(%r9), %xmm15
; AVX512DQ-NEXT:    vmovdqa 16(%r8), %xmm14
; AVX512DQ-NEXT:    vpunpcklbw {{.*#+}} xmm10 = xmm14[0],xmm15[0],xmm14[1],xmm15[1],xmm14[2],xmm15[2],xmm14[3],xmm15[3],xmm14[4],xmm15[4],xmm14[5],xmm15[5],xmm14[6],xmm15[6],xmm14[7],xmm15[7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm10[0,1,1,3,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm6 = xmm10[2,1,3,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm6, %ymm0, %ymm28
; AVX512DQ-NEXT:    vmovdqa (%rsi), %xmm1
; AVX512DQ-NEXT:    vmovdqa %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512DQ-NEXT:    vmovdqa (%rdi), %xmm0
; AVX512DQ-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; AVX512DQ-NEXT:    vpshufd {{.*#+}} xmm4 = xmm0[3,3,3,3]
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} xmm3 = xmm0[0],zero,zero,zero,xmm0[1],zero,zero,zero
; AVX512DQ-NEXT:    vpshufd {{.*#+}} xmm5 = xmm0[1,1,1,1]
; AVX512DQ-NEXT:    vmovdqa 48(%rsi), %xmm2
; AVX512DQ-NEXT:    vmovdqa 48(%rdi), %xmm1
; AVX512DQ-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm1[0],xmm2[0],xmm1[1],xmm2[1],xmm1[2],xmm2[2],xmm1[3],xmm2[3],xmm1[4],xmm2[4],xmm1[5],xmm2[5],xmm1[6],xmm2[6],xmm1[7],xmm2[7]
; AVX512DQ-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm1[8],xmm2[8],xmm1[9],xmm2[9],xmm1[10],xmm2[10],xmm1[11],xmm2[11],xmm1[12],xmm2[12],xmm1[13],xmm2[13],xmm1[14],xmm2[14],xmm1[15],xmm2[15]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} xmm11 = xmm0[2,3,2,3]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} xmm9 = xmm0[3,3,3,3]
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} xmm1 = xmm0[0],zero,zero,zero,xmm0[1],zero,zero,zero
; AVX512DQ-NEXT:    vpshufd {{.*#+}} xmm0 = xmm0[1,1,1,1]
...
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm5 = ymm7[2,1,3,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm5, %zmm4, %zmm6
; AVX512DQ-NEXT:    vpbroadcastq {{.*#+}} zmm7 = [65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535]
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} zmm6 = zmm6 ^ (zmm7 & (zmm6 ^ zmm3))
...
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm5 = ymm8[0,2,2,3,4,6,6,7]
...
; AVX512DQ-NEXT:    vpandq %zmm8, %zmm4, %zmm4
; AVX512DQ-NEXT:    movw $-21846, %ax # imm = 0xAAAA
; AVX512DQ-NEXT:    kmovw %eax, %k1
; AVX512DQ-NEXT:    vpord %zmm3, %zmm4, %zmm6 {%k1}
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} xmm3 = xmm11[0],zero,zero,zero,xmm11[1],zero,zero,zero
...
; AVX512DQ-NEXT:    vpshufd $246, {{[-0-9]+}}(%r{{[sb]}}p), %ymm3 # 32-byte Folded Reload
; AVX512DQ-NEXT:    # ymm3 = mem[2,1,3,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm3, %zmm1, %zmm9
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} zmm9 = zmm9 ^ (zmm7 & (zmm9 ^ zmm0))
...
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm3 = ymm26[0,2,2,3,4,6,6,7]
...
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} xmm0 = xmm0[0],zero,zero,zero,xmm0[1],zero,zero,zero
; AVX512DQ-NEXT:    vpshufd {{.*#+}} xmm1 = xmm2[3,3,3,3]
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} xmm1 = xmm1[0],zero,zero,zero,xmm1[1],zero,zero,zero
; AVX512DQ-NEXT:    vinserti128 $1, %xmm1, %ymm0, %ymm0
...
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm1 = ymm29[0,1,1,3,4,5,5,7]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm2 = ymm31[2,1,3,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm2, %zmm1, %zmm11
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} zmm11 = zmm11 ^ (zmm7 & (zmm11 ^ zmm0))
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm0 = ymm23[0,0,2,1,4,4,6,5]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm1 = ymm20[0,2,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm1, %zmm0, %zmm0
...
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm10[0,1,2,3,4,5,5,7]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm10[0,1,2,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm1, %ymm0, %ymm18
; AVX512DQ-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm12[8],xmm13[8],xmm12[9],xmm13[9],xmm12[10],xmm13[10],xmm12[11],xmm13[11],xmm12[12],xmm13[12],xmm12[13],xmm13[13],xmm12[14],xmm13[14],xmm12[15],xmm13[15]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm0[0,0,2,1,4,5,6,7]
...
; AVX512DQ-NEXT:    vpshufd {{.*#+}} xmm2 = xmm1[2,3,2,3]
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} xmm2 = xmm2[0],zero,zero,zero,xmm2[1],zero,zero,zero
; AVX512DQ-NEXT:    vpshufd {{.*#+}} xmm4 = xmm1[3,3,3,3]
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} xmm4 = xmm4[0],zero,zero,zero,xmm4[1],zero,zero,zero
; AVX512DQ-NEXT:    vinserti128 $1, %xmm4, %ymm2, %ymm2
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} xmm4 = xmm1[0],zero,zero,zero,xmm1[1],zero,zero,zero
; AVX512DQ-NEXT:    vpshufd {{.*#+}} xmm1 = xmm1[1,1,1,1]
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} xmm1 = xmm1[0],zero,zero,zero,xmm1[1],zero,zero,zero
; AVX512DQ-NEXT:    vinserti128 $1, %xmm1, %ymm4, %ymm1
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm2, %zmm1, %zmm1
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm2 = ymm30[0,1,1,3,4,5,5,7]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm4 = ymm24[2,1,3,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm4, %zmm2, %zmm2
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} zmm2 = zmm2 ^ (zmm7 & (zmm2 ^ zmm1))
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm1 = ymm22[0,0,2,1,4,4,6,5]
...
; AVX512DQ-NEXT:    vpandq %zmm8, %zmm4, %zmm4
; AVX512DQ-NEXT:    vpord %zmm1, %zmm4, %zmm2 {%k1}
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm0[0,1,2,3,4,4,6,5]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm0, %ymm1, %ymm19
; AVX512DQ-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX512DQ-NEXT:    vpunpckhbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm0, %xmm0 # 16-byte Folded Reload
; AVX512DQ-NEXT:    # xmm0 = xmm0[8],mem[8],xmm0[9],mem[9],xmm0[10],mem[10],xmm0[11],mem[11],xmm0[12],mem[12],xmm0[13],mem[13],xmm0[14],mem[14],xmm0[15],mem[15]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm0[0,0,2,1,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm0[0,2,2,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm4, %ymm1, %ymm21
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm4 = xmm0[0,1,2,3,4,4,6,5]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm0, %ymm4, %ymm22
; AVX512DQ-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm14[8],xmm15[8],xmm14[9],xmm15[9],xmm14[10],xmm15[10],xmm14[11],xmm15[11],xmm14[12],xmm15[12],xmm14[13],xmm15[13],xmm14[14],xmm15[14],xmm14[15],xmm15[15]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm0[0,1,1,3,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm10 = xmm0[2,1,3,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm10, %ymm4, %ymm23
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm10 = xmm0[0,1,2,3,4,5,5,7]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm0, %ymm10, %ymm26
; AVX512DQ-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX512DQ-NEXT:    vpunpcklbw (%rsp), %xmm0, %xmm0 # 16-byte Folded Reload
; AVX512DQ-NEXT:    # xmm0 = xmm0[0],mem[0],xmm0[1],mem[1],xmm0[2],mem[2],xmm0[3],mem[3],xmm0[4],mem[4],xmm0[5],mem[5],xmm0[6],mem[6],xmm0[7],mem[7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm13 = xmm0[0,0,2,1,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm14 = xmm0[0,2,2,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm14, %ymm13, %ymm13
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm14 = xmm0[0,1,2,3,4,4,6,5]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm0, %ymm14, %ymm14
; AVX512DQ-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX512DQ-NEXT:    vpunpcklbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm0, %xmm0 # 16-byte Folded Reload
; AVX512DQ-NEXT:    # xmm0 = xmm0[0],mem[0],xmm0[1],mem[1],xmm0[2],mem[2],xmm0[3],mem[3],xmm0[4],mem[4],xmm0[5],mem[5],xmm0[6],mem[6],xmm0[7],mem[7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm15 = xmm0[0,0,2,1,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm0[0,2,2,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm1, %ymm15, %ymm15
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm0[0,1,2,3,4,4,6,5]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm0, %ymm1, %ymm16
; AVX512DQ-NEXT:    vpunpckhbw {{.*#+}} xmm1 = xmm5[8],xmm3[8],xmm5[9],xmm3[9],xmm5[10],xmm3[10],xmm5[11],xmm3[11],xmm5[12],xmm3[12],xmm5[13],xmm3[13],xmm5[14],xmm3[14],xmm5[15],xmm3[15]
; AVX512DQ-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX512DQ-NEXT:    vpunpcklbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm0, %xmm0 # 16-byte Folded Reload
; AVX512DQ-NEXT:    # xmm0 = xmm0[0],mem[0],xmm0[1],mem[1],xmm0[2],mem[2],xmm0[3],mem[3],xmm0[4],mem[4],xmm0[5],mem[5],xmm0[6],mem[6],xmm0[7],mem[7]
...
; AVX512DQ-NEXT:    vinserti128 $1, %xmm5, %ymm3, %ymm3
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm5 = xmm0[0,1,2,3,4,5,5,7]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm0, %ymm5, %ymm5
; AVX512DQ-NEXT:    vmovdqa 16(%rsi), %xmm0
; AVX512DQ-NEXT:    vmovdqa 16(%rdi), %xmm12
; AVX512DQ-NEXT:    vpunpcklbw {{.*#+}} xmm4 = xmm12[0],xmm0[0],xmm12[1],xmm0[1],xmm12[2],xmm0[2],xmm12[3],xmm0[3],xmm12[4],xmm0[4],xmm12[5],xmm0[5],xmm12[6],xmm0[6],xmm12[7],xmm0[7]
; AVX512DQ-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm12[8],xmm0[8],xmm12[9],xmm0[9],xmm12[10],xmm0[10],xmm12[11],xmm0[11],xmm12[12],xmm0[12],xmm12[13],xmm0[13],xmm12[14],xmm0[14],xmm12[15],xmm0[15]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} xmm12 = xmm1[2,3,2,3]
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} xmm12 = xmm12[0],zero,zero,zero,xmm12[1],zero,zero,zero
; AVX512DQ-NEXT:    vpshufd {{.*#+}} xmm17 = xmm1[3,3,3,3]
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} xmm17 = xmm17[0],zero,zero,zero,xmm17[1],zero,zero,zero
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm17, %ymm12, %ymm12
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} xmm17 = xmm1[0],zero,zero,zero,xmm1[1],zero,zero,zero
; AVX512DQ-NEXT:    vpshufd {{.*#+}} xmm1 = xmm1[1,1,1,1]
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} xmm1 = xmm1[0],zero,zero,zero,xmm1[1],zero,zero,zero
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm1, %ymm17, %ymm1
...
; AVX512DQ-NEXT:    vpshufd $246, {{[-0-9]+}}(%r{{[sb]}}p), %ymm17 # 32-byte Folded Reload
; AVX512DQ-NEXT:    # ymm17 = mem[2,1,3,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm17, %zmm12, %zmm17
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} zmm17 = zmm17 ^ (zmm7 & (zmm17 ^ zmm1))
; AVX512DQ-NEXT:    vpshufd $96, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1 # 32-byte Folded Reload
; AVX512DQ-NEXT:    # ymm1 = mem[0,0,2,1,4,4,6,5]
; AVX512DQ-NEXT:    vpshufd $232, {{[-0-9]+}}(%r{{[sb]}}p), %ymm12 # 32-byte Folded Reload
; AVX512DQ-NEXT:    # ymm12 = mem[0,2,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm12, %zmm1, %zmm1
; AVX512DQ-NEXT:    vpandnq %zmm1, %zmm8, %zmm1
...
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm24, %zmm12, %zmm12
; AVX512DQ-NEXT:    vpandq %zmm8, %zmm12, %zmm12
; AVX512DQ-NEXT:    vpord %zmm1, %zmm12, %zmm17 {%k1}
; AVX512DQ-NEXT:    vpshufd {{.*#+}} xmm1 = xmm4[2,3,2,3]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} xmm12 = xmm4[3,3,3,3]
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} xmm24 = xmm4[0],zero,zero,zero,xmm4[1],zero,zero,zero
; AVX512DQ-NEXT:    vpshufd {{.*#+}} xmm4 = xmm4[1,1,1,1]
; AVX512DQ-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm10 # 16-byte Reload
; AVX512DQ-NEXT:    vpunpcklbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm10, %xmm10 # 16-byte Folded Reload
; AVX512DQ-NEXT:    # xmm10 = xmm10[0],mem[0],xmm10[1],mem[1],xmm10[2],mem[2],xmm10[3],mem[3],xmm10[4],mem[4],xmm10[5],mem[5],xmm10[6],mem[6],xmm10[7],mem[7]
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} xmm1 = xmm1[0],zero,zero,zero,xmm1[1],zero,zero,zero
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} xmm12 = xmm12[0],zero,zero,zero,xmm12[1],zero,zero,zero
; AVX512DQ-NEXT:    vinserti128 $1, %xmm12, %ymm1, %ymm1
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} xmm4 = xmm4[0],zero,zero,zero,xmm4[1],zero,zero,zero
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm4, %ymm24, %ymm4
; AVX512DQ-NEXT:    vpshufd {{.*#+}} xmm12 = xmm0[2,3,2,3]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} xmm24 = xmm0[3,3,3,3]
...
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} zmm4 = zmm4 ^ (zmm7 & (zmm4 ^ zmm1))
; AVX512DQ-NEXT:    vpshufd {{.*#+}} xmm1 = xmm10[2,3,2,3]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} xmm30 = xmm10[3,3,3,3]
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} xmm31 = xmm10[0],zero,zero,zero,xmm10[1],zero,zero,zero
; AVX512DQ-NEXT:    vpshufd {{.*#+}} xmm10 = xmm10[1,1,1,1]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm25 = ymm25[0,0,2,1,4,4,6,5]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm27 = ymm27[0,2,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm27, %zmm25, %zmm25
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm27 = ymm28[0,0,2,1,4,4,6,5]
...
; AVX512DQ-NEXT:    vpandq %zmm8, %zmm18, %zmm18
; AVX512DQ-NEXT:    vpord %zmm25, %zmm18, %zmm4 {%k1}
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} xmm12 = xmm12[0],zero,zero,zero,xmm12[1],zero,zero,zero
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} xmm18 = xmm24[0],zero,zero,zero,xmm24[1],zero,zero,zero
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm18, %ymm12, %ymm12
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} xmm0 = xmm0[0],zero,zero,zero,xmm0[1],zero,zero,zero
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm0, %ymm29, %ymm0
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm12, %zmm0, %zmm0
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm12 = ymm20[0,1,1,3,4,5,5,7]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm18 = ymm19[2,1,3,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm18, %zmm12, %zmm12
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} zmm12 = zmm12 ^ (zmm7 & (zmm12 ^ zmm0))
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm0 = ymm21[0,0,2,1,4,4,6,5]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm18 = ymm22[0,2,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm18, %zmm0, %zmm0
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm18 = ymm23[0,0,2,1,4,4,6,5]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm19 = ymm26[0,2,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm19, %zmm18, %zmm18
; AVX512DQ-NEXT:    vpandnq %zmm0, %zmm8, %zmm0
; AVX512DQ-NEXT:    vpandq %zmm8, %zmm18, %zmm18
; AVX512DQ-NEXT:    vpord %zmm0, %zmm18, %zmm12 {%k1}
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} xmm0 = xmm1[0],zero,zero,zero,xmm1[1],zero,zero,zero
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} xmm1 = xmm30[0],zero,zero,zero,xmm30[1],zero,zero,zero
; AVX512DQ-NEXT:    vinserti128 $1, %xmm1, %ymm0, %ymm0
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} xmm1 = xmm10[0],zero,zero,zero,xmm10[1],zero,zero,zero
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm1, %ymm31, %ymm1
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm0, %zmm1, %zmm0
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm1 = ymm13[0,1,1,3,4,5,5,7]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm10 = ymm14[2,1,3,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm10, %zmm1, %zmm1
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} zmm1 = zmm1 ^ (zmm7 & (zmm1 ^ zmm0))
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm0 = ymm15[0,0,2,1,4,4,6,5]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm7 = ymm16[0,2,2,3,4,6,6,7]
...
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm2
; AVX512DQ-FCP-NEXT:    vmovdqa {{.*#+}} ymm13 = [8,9,8,9,4,5,6,7,12,13,10,11,12,13,10,11,8,9,12,13,4,5,6,7,12,13,14,15,12,13,14,15]
...
; AVX512DQ-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm9 = xmm5[0],xmm4[0],xmm5[1],xmm4[1],xmm5[2],xmm4[2],xmm5[3],xmm4[3],xmm5[4],xmm4[4],xmm5[5],xmm4[5],xmm5[6],xmm4[6],xmm5[7],xmm4[7]
...
; AVX512DQ-FCP-NEXT:    vinserti64x4 $1, %ymm15, %zmm9, %zmm6
...
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
; AVX512DQ-FCP-NEXT:    vpshufb %ymm13, %ymm0, %ymm1
...
; AVX512DQ-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm1[0],xmm6[0],xmm1[1],xmm6[1],xmm1[2],xmm6[2],xmm1[3],xmm6[3],xmm1[4],xmm6[4],xmm1[5],xmm6[5],xmm1[6],xmm6[6],xmm1[7],xmm6[7]
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm2
; AVX512DQ-FCP-NEXT:    vpshufb %ymm13, %ymm2, %ymm3
; AVX512DQ-FCP-NEXT:    vpshufb %ymm8, %ymm2, %ymm2
...
; AVX512DQ-FCP-NEXT:    vpshufb %ymm10, %ymm9, %ymm9
; AVX512DQ-FCP-NEXT:    vinserti64x4 $1, %ymm0, %zmm9, %zmm23
; AVX512DQ-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm1[8],xmm6[8],xmm1[9],xmm6[9],xmm1[10],xmm6[10],xmm1[11],xmm6[11],xmm1[12],xmm6[12],xmm1[13],xmm6[13],xmm1[14],xmm6[14],xmm1[15],xmm6[15]
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
; AVX512DQ-FCP-NEXT:    vpshufb %ymm13, %ymm0, %ymm1
; AVX512DQ-FCP-NEXT:    vpshufb %ymm8, %ymm0, %ymm0
...
; AVX512DQ-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm6 = xmm5[0],xmm4[0],xmm5[1],xmm4[1],xmm5[2],xmm4[2],xmm5[3],xmm4[3],xmm5[4],xmm4[4],xmm5[5],xmm4[5],xmm5[6],xmm4[6],xmm5[7],xmm4[7]
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm6, %ymm6, %ymm6
; AVX512DQ-FCP-NEXT:    vpshufb %ymm7, %ymm6, %ymm9
; AVX512DQ-FCP-NEXT:    vpshufb %ymm10, %ymm6, %ymm6
; AVX512DQ-FCP-NEXT:    vinserti64x4 $1, %ymm9, %zmm6, %zmm29
; AVX512DQ-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm1[8],xmm0[8],xmm1[9],xmm0[9],xmm1[10],xmm0[10],xmm1[11],xmm0[11],xmm1[12],xmm0[12],xmm1[13],xmm0[13],xmm1[14],xmm0[14],xmm1[15],xmm0[15]
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
; AVX512DQ-FCP-NEXT:    vpshufb %ymm13, %ymm0, %ymm1
; AVX512DQ-FCP-NEXT:    vpshufb %ymm8, %ymm0, %ymm0
...
; AVX512DQ-FCP-NEXT:    vpmovsxwq {{.*#+}} xmm9 = [1284,1798]
...
; AVX512DQ-FCP-NEXT:    vpbroadcastq {{.*#+}} zmm1 = [65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535]
; AVX512DQ-FCP-NEXT:    vpternlogq {{.*#+}} zmm0 = zmm14 ^ (zmm1 & (zmm0 ^ zmm14))
; AVX512DQ-FCP-NEXT:    vpbroadcastq {{.*#+}} zmm14 = [65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0]
; AVX512DQ-FCP-NEXT:    vpandnq %zmm19, %zmm14, %zmm6
; AVX512DQ-FCP-NEXT:    vpandq %zmm14, %zmm21, %zmm19
; AVX512DQ-FCP-NEXT:    movw $-21846, %ax # imm = 0xAAAA
; AVX512DQ-FCP-NEXT:    kmovw %eax, %k1
; AVX512DQ-FCP-NEXT:    vpord %zmm6, %zmm19, %zmm0 {%k1}
; AVX512DQ-FCP-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm2 # 16-byte Reload
; AVX512DQ-FCP-NEXT:    vpunpcklbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm2, %xmm6 # 16-byte Folded Reload
; AVX512DQ-FCP-NEXT:    # xmm6 = xmm2[0],mem[0],xmm2[1],mem[1],xmm2[2],mem[2],xmm2[3],mem[3],xmm2[4],mem[4],xmm2[5],mem[5],xmm2[6],mem[6],xmm2[7],mem[7]
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm6, %ymm6, %ymm6
; AVX512DQ-FCP-NEXT:    vpshufb %ymm13, %ymm6, %ymm13
; AVX512DQ-FCP-NEXT:    vpshufb %ymm8, %ymm6, %ymm6
; AVX512DQ-FCP-NEXT:    vinserti64x4 $1, %ymm13, %zmm6, %zmm8
; AVX512DQ-FCP-NEXT:    vmovdqa 48(%rsi), %xmm13
; AVX512DQ-FCP-NEXT:    vmovdqa 48(%rdi), %xmm2
; AVX512DQ-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm6 = xmm2[0],xmm13[0],xmm2[1],xmm13[1],xmm2[2],xmm13[2],xmm2[3],xmm13[3],xmm2[4],xmm13[4],xmm2[5],xmm13[5],xmm2[6],xmm13[6],xmm2[7],xmm13[7]
; AVX512DQ-FCP-NEXT:    vpshufb %xmm9, %xmm6, %xmm3
; AVX512DQ-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm19 = xmm6[0],zero,zero,zero,xmm6[1],zero,zero,zero
; AVX512DQ-FCP-NEXT:    vinserti32x4 $1, %xmm3, %ymm19, %ymm3
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm6, %ymm6, %ymm6
; AVX512DQ-FCP-NEXT:    vpshufb %ymm5, %ymm6, %ymm6
; AVX512DQ-FCP-NEXT:    vinserti64x4 $1, %ymm6, %zmm3, %zmm6
; AVX512DQ-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm2[8],xmm13[8],xmm2[9],xmm13[9],xmm2[10],xmm13[10],xmm2[11],xmm13[11],xmm2[12],xmm13[12],xmm2[13],xmm13[13],xmm2[14],xmm13[14],xmm2[15],xmm13[15]
; AVX512DQ-FCP-NEXT:    vpshufb %xmm9, %xmm2, %xmm3
; AVX512DQ-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm13 = xmm2[0],zero,zero,zero,xmm2[1],zero,zero,zero
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm3, %ymm13, %ymm3
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm2
; AVX512DQ-FCP-NEXT:    vpshufb %ymm5, %ymm2, %ymm2
; AVX512DQ-FCP-NEXT:    vinserti64x4 $1, %ymm2, %zmm3, %zmm19
; AVX512DQ-FCP-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm2 # 16-byte Reload
...
; AVX512DQ-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm11 = xmm3[0],xmm2[0],xmm3[1],xmm2[1],xmm3[2],xmm2[2],xmm3[3],xmm2[3],xmm3[4],xmm2[4],xmm3[5],xmm2[5],xmm3[6],xmm2[6],xmm3[7],xmm2[7]
; AVX512DQ-FCP-NEXT:    vpshufb %xmm9, %xmm11, %xmm13
; AVX512DQ-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm21 = xmm11[0],zero,zero,zero,xmm11[1],zero,zero,zero
; AVX512DQ-FCP-NEXT:    vinserti32x4 $1, %xmm13, %ymm21, %ymm13
...
; AVX512DQ-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm3[8],xmm2[8],xmm3[9],xmm2[9],xmm3[10],xmm2[10],xmm3[11],xmm2[11],xmm3[12],xmm2[12],xmm3[13],xmm2[13],xmm3[14],xmm2[14],xmm3[15],xmm2[15]
; AVX512DQ-FCP-NEXT:    vpshufb %xmm9, %xmm2, %xmm3
; AVX512DQ-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm13 = xmm2[0],zero,zero,zero,xmm2[1],zero,zero,zero
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm3, %ymm13, %ymm3
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm2
...
; AVX512DQ-FCP-NEXT:    # xmm2 = xmm2[0],mem[0],xmm2[1],mem[1],xmm2[2],mem[2],xmm2[3],mem[3],xmm2[4],mem[4],xmm2[5],mem[5],xmm2[6],mem[6],xmm2[7],mem[7]
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm2
; AVX512DQ-FCP-NEXT:    vpshufb %ymm15, %ymm2, %ymm3
; AVX512DQ-FCP-NEXT:    vpshufb %ymm10, %ymm2, %ymm2
; AVX512DQ-FCP-NEXT:    vinserti64x4 $1, %ymm3, %zmm2, %zmm2
; AVX512DQ-FCP-NEXT:    vmovdqa 16(%rsi), %xmm3
; AVX512DQ-FCP-NEXT:    vmovdqa 16(%rdi), %xmm10
; AVX512DQ-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm13 = xmm10[0],xmm3[0],xmm10[1],xmm3[1],xmm10[2],xmm3[2],xmm10[3],xmm3[3],xmm10[4],xmm3[4],xmm10[5],xmm3[5],xmm10[6],xmm3[6],xmm10[7],xmm3[7]
; AVX512DQ-FCP-NEXT:    vpshufb %xmm9, %xmm13, %xmm4
; AVX512DQ-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm15 = xmm13[0],zero,zero,zero,xmm13[1],zero,zero,zero
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm4, %ymm15, %ymm4
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm13, %ymm13, %ymm13
; AVX512DQ-FCP-NEXT:    vpshufb %ymm5, %ymm13, %ymm13
; AVX512DQ-FCP-NEXT:    vinserti64x4 $1, %ymm13, %zmm4, %zmm4
; AVX512DQ-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm3 = xmm10[8],xmm3[8],xmm10[9],xmm3[9],xmm10[10],xmm3[10],xmm10[11],xmm3[11],xmm10[12],xmm3[12],xmm10[13],xmm3[13],xmm10[14],xmm3[14],xmm10[15],xmm3[15]
; AVX512DQ-FCP-NEXT:    vpshufb %xmm9, %xmm3, %xmm10
; AVX512DQ-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm13 = xmm3[0],zero,zero,zero,xmm3[1],zero,zero,zero
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm10, %ymm13, %ymm10
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm3, %ymm3, %ymm3
...
; AVX512DQ-FCP-NEXT:    vpunpcklbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm10, %xmm10 # 16-byte Folded Reload
; AVX512DQ-FCP-NEXT:    # xmm10 = xmm10[0],mem[0],xmm10[1],mem[1],xmm10[2],mem[2],xmm10[3],mem[3],xmm10[4],mem[4],xmm10[5],mem[5],xmm10[6],mem[6],xmm10[7],mem[7]
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm10, %ymm10, %ymm13
; AVX512DQ-FCP-NEXT:    vpshufb %ymm5, %ymm13, %ymm5
; AVX512DQ-FCP-NEXT:    vpshufb %xmm9, %xmm10, %xmm9
; AVX512DQ-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm10 = xmm10[0],zero,zero,zero,xmm10[1],zero,zero,zero
...
; AVX512DQ-FCP-NEXT:    vpandnq {{[-0-9]+}}(%r{{[sb]}}p), %zmm14, %zmm9 # 64-byte Folded Reload
; AVX512DQ-FCP-NEXT:    vpandq (%rsp), %zmm14, %zmm10 # 64-byte Folded Reload
; AVX512DQ-FCP-NEXT:    vpord %zmm9, %zmm10, %zmm6 {%k1}
; AVX512DQ-FCP-NEXT:    vpternlogq {{.*#+}} zmm19 = zmm16 ^ (zmm1 & (zmm19 ^ zmm16))
; AVX512DQ-FCP-NEXT:    vpandnq %zmm17, %zmm14, %zmm9
; AVX512DQ-FCP-NEXT:    vpandq %zmm14, %zmm18, %zmm10
; AVX512DQ-FCP-NEXT:    vpord %zmm9, %zmm10, %zmm19 {%k1}
; AVX512DQ-FCP-NEXT:    vpternlogq {{.*#+}} zmm11 = zmm20 ^ (zmm1 & (zmm11 ^ zmm20))
; AVX512DQ-FCP-NEXT:    vpandnq %zmm22, %zmm14, %zmm9
; AVX512DQ-FCP-NEXT:    vpandq %zmm14, %zmm23, %zmm10
; AVX512DQ-FCP-NEXT:    vpord %zmm9, %zmm10, %zmm11 {%k1}
; AVX512DQ-FCP-NEXT:    vpternlogq {{.*#+}} zmm21 = zmm24 ^ (zmm1 & (zmm21 ^ zmm24))
; AVX512DQ-FCP-NEXT:    vpandnq %zmm25, %zmm14, %zmm9
; AVX512DQ-FCP-NEXT:    vpandq %zmm14, %zmm26, %zmm10
; AVX512DQ-FCP-NEXT:    vpord %zmm9, %zmm10, %zmm21 {%k1}
; AVX512DQ-FCP-NEXT:    vpternlogq {{.*#+}} zmm4 = zmm27 ^ (zmm1 & (zmm4 ^ zmm27))
; AVX512DQ-FCP-NEXT:    vpandnq %zmm28, %zmm14, %zmm9
; AVX512DQ-FCP-NEXT:    vpandq %zmm14, %zmm29, %zmm10
; AVX512DQ-FCP-NEXT:    vpord %zmm9, %zmm10, %zmm4 {%k1}
; AVX512DQ-FCP-NEXT:    vpternlogq {{.*#+}} zmm3 = zmm30 ^ (zmm1 & (zmm3 ^ zmm30))
; AVX512DQ-FCP-NEXT:    vpandnq %zmm31, %zmm14, %zmm9
; AVX512DQ-FCP-NEXT:    vpandq %zmm14, %zmm7, %zmm7
; AVX512DQ-FCP-NEXT:    vpord %zmm9, %zmm7, %zmm3 {%k1}
; AVX512DQ-FCP-NEXT:    vpternlogq {{.*#+}} zmm5 = zmm8 ^ (zmm1 & (zmm5 ^ zmm8))
; AVX512DQ-FCP-NEXT:    vpandnq %zmm12, %zmm14, %zmm1
; AVX512DQ-FCP-NEXT:    vpandq %zmm14, %zmm2, %zmm2
; AVX512DQ-FCP-NEXT:    vpord %zmm1, %zmm2, %zmm5 {%k1}
; AVX512DQ-FCP-NEXT:    movq {{[0-9]+}}(%rsp), %rax
...
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm19, 448(%rax)
...
; AVX512BW-FCP-NEXT:    vpermw %zmm6, %zmm8, %zmm0 {%k1}
...
; AVX512BW-FCP-NEXT:    vmovdqa 32(%r8), %xmm1
...
; AVX512BW-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm24 = xmm1[0],xmm31[0],xmm1[1],xmm31[1],xmm1[2],xmm31[2],xmm1[3],xmm31[3],xmm1[4],xmm31[4],xmm1[5],xmm31[5],xmm1[6],xmm31[6],xmm1[7],xmm31[7]
...
; AVX512BW-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm1 = xmm1[8],xmm31[8],xmm1[9],xmm31[9],xmm1[10],xmm31[10],xmm1[11],xmm31[11],xmm1[12],xmm31[12],xmm1[13],xmm31[13],xmm1[14],xmm31[14],xmm1[15],xmm31[15]
; AVX512BW-FCP-NEXT:    vpermw %zmm1, %zmm13, %zmm21
; AVX512BW-FCP-NEXT:    vpermw %zmm22, %zmm14, %zmm21 {%k2}
; AVX512BW-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm1 = xmm23[0],xmm25[0],xmm23[1],xmm25[1],xmm23[2],xmm25[2],xmm23[3],xmm25[3],xmm23[4],xmm25[4],xmm23[5],xmm25[5],xmm23[6],xmm25[6],xmm23[7],xmm25[7]
; AVX512BW-FCP-NEXT:    vpshufb %xmm5, %xmm1, %xmm22
; AVX512BW-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm27 = xmm1[0],zero,zero,zero,xmm1[1],zero,zero,zero
...
; AVX512BW-FCP-NEXT:    vinserti64x4 $1, %ymm1, %zmm22, %zmm22
; AVX512BW-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm1 = xmm27[0],xmm26[0],xmm27[1],xmm26[1],xmm27[2],xmm26[2],xmm27[3],xmm26[3],xmm27[4],xmm26[4],xmm27[5],xmm26[5],xmm27[6],xmm26[6],xmm27[7],xmm26[7]
; AVX512BW-FCP-NEXT:    vpermw %zmm1, %zmm8, %zmm22 {%k1}
; AVX512BW-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm1 = xmm23[8],xmm25[8],xmm23[9],xmm25[9],xmm23[10],xmm25[10],xmm23[11],xmm25[11],xmm23[12],xmm25[12],xmm23[13],xmm25[13],xmm23[14],xmm25[14],xmm23[15],xmm25[15]
; AVX512BW-FCP-NEXT:    vpshufb %xmm5, %xmm1, %xmm23
; AVX512BW-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm25 = xmm1[0],zero,zero,zero,xmm1[1],zero,zero,zero
; AVX512BW-FCP-NEXT:    vinserti32x4 $1, %xmm23, %ymm25, %ymm23
; AVX512BW-FCP-NEXT:    vinserti128 $1, %xmm1, %ymm1, %ymm1
; AVX512BW-FCP-NEXT:    vpshufb %ymm4, %ymm1, %ymm1
; AVX512BW-FCP-NEXT:    vinserti64x4 $1, %ymm1, %zmm23, %zmm1
...
; AVX512BW-FCP-NEXT:    vpermw %zmm23, %zmm8, %zmm1 {%k1}
...
; AVX512DQ-BW-FCP-NEXT:    vpermw %zmm6, %zmm8, %zmm0 {%k1}
...
; AVX512DQ-BW-FCP-NEXT:    vmovdqa 32(%r8), %xmm1
...
; AVX512DQ-BW-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm24 = xmm1[0],xmm31[0],xmm1[1],xmm31[1],xmm1[2],xmm31[2],xmm1[3],xmm31[3],xmm1[4],xmm31[4],xmm1[5],xmm31[5],xmm1[6],xmm31[6],xmm1[7],xmm31[7]
...
; AVX512DQ-BW-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm1 = xmm1[8],xmm31[8],xmm1[9],xmm31[9],xmm1[10],xmm31[10],xmm1[11],xmm31[11],xmm1[12],xmm31[12],xmm1[13],xmm31[13],xmm1[14],xmm31[14],xmm1[15],xmm31[15]
; AVX512DQ-BW-FCP-NEXT:    vpermw %zmm1, %zmm13, %zmm21
; AVX512DQ-BW-FCP-NEXT:    vpermw %zmm22, %zmm14, %zmm21 {%k2}
; AVX512DQ-BW-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm1 = xmm23[0],xmm25[0],xmm23[1],xmm25[1],xmm23[2],xmm25[2],xmm23[3],xmm25[3],xmm23[4],xmm25[4],xmm23[5],xmm25[5],xmm23[6],xmm25[6],xmm23[7],xmm25[7]
; AVX512DQ-BW-FCP-NEXT:    vpshufb %xmm5, %xmm1, %xmm22
; AVX512DQ-BW-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm27 = xmm1[0],zero,zero,zero,xmm1[1],zero,zero,zero
...
; AVX512DQ-BW-FCP-NEXT:    vinserti64x4 $1, %ymm1, %zmm22, %zmm22
; AVX512DQ-BW-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm1 = xmm27[0],xmm26[0],xmm27[1],xmm26[1],xmm27[2],xmm26[2],xmm27[3],xmm26[3],xmm27[4],xmm26[4],xmm27[5],xmm26[5],xmm27[6],xmm26[6],xmm27[7],xmm26[7]
; AVX512DQ-BW-FCP-NEXT:    vpermw %zmm1, %zmm8, %zmm22 {%k1}
; AVX512DQ-BW-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm1 = xmm23[8],xmm25[8],xmm23[9],xmm25[9],xmm23[10],xmm25[10],xmm23[11],xmm25[11],xmm23[12],xmm25[12],xmm23[13],xmm25[13],xmm23[14],xmm25[14],xmm23[15],xmm25[15]
; AVX512DQ-BW-FCP-NEXT:    vpshufb %xmm5, %xmm1, %xmm23
; AVX512DQ-BW-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm25 = xmm1[0],zero,zero,zero,xmm1[1],zero,zero,zero
; AVX512DQ-BW-FCP-NEXT:    vinserti32x4 $1, %xmm23, %ymm25, %ymm23
; AVX512DQ-BW-FCP-NEXT:    vinserti128 $1, %xmm1, %ymm1, %ymm1
; AVX512DQ-BW-FCP-NEXT:    vpshufb %ymm4, %ymm1, %ymm1
; AVX512DQ-BW-FCP-NEXT:    vinserti64x4 $1, %ymm1, %zmm23, %zmm1
...
; AVX512DQ-BW-FCP-NEXT:    vpermw %zmm23, %zmm8, %zmm1 {%k1}
