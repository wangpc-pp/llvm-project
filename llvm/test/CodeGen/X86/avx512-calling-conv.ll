...
; FASTISEL-NEXT:    korb %k5, %k1, %k1
; FASTISEL-NEXT:    kmovw {{[-0-9]+}}(%r{{[sb]}}p), %k0 ## 2-byte Reload
; FASTISEL-NEXT:    kandb %k0, %k1, %k1
; FASTISEL-NEXT:    kmovb {{[0-9]+}}(%rsp), %k5
; FASTISEL-NEXT:    kshiftlb $7, %k5, %k5
