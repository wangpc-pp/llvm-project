...
; AVX-NEXT:    vmovlhps {{.*#+}} xmm3 = xmm14[0],xmm2[0]
...
; AVX-NEXT:    vinsertps {{.*#+}} xmm0 = xmm13[1],xmm5[1],zero,zero
; AVX-NEXT:    vunpcklps {{.*#+}} xmm1 = xmm13[0],xmm5[0],xmm13[1],xmm5[1]
; AVX-NEXT:    vinsertf128 $1, %xmm0, %ymm1, %ymm0
; AVX-NEXT:    vunpcklps {{.*#+}} xmm1 = xmm12[0],xmm11[0],xmm12[1],xmm11[1]
; AVX-NEXT:    vmovlhps {{.*#+}} xmm3 = xmm11[0],xmm12[0]
; AVX-NEXT:    vshufps {{.*#+}} xmm3 = xmm3[0,1,2,0]
; AVX-NEXT:    vinsertf128 $1, %xmm1, %ymm3, %ymm1
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm1[2,3],ymm0[4,5],ymm1[6,7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX-NEXT:    vinsertps {{.*#+}} xmm0 = xmm4[1],xmm10[1],zero,zero
; AVX-NEXT:    vunpcklps {{.*#+}} xmm1 = xmm4[0],xmm10[0],xmm4[1],xmm10[1]
; AVX-NEXT:    vinsertf128 $1, %xmm0, %ymm1, %ymm0
; AVX-NEXT:    vmovlhps {{.*#+}} xmm1 = xmm6[0],xmm8[0]
; AVX-NEXT:    vshufps {{.*#+}} xmm1 = xmm1[0,1,2,0]
; AVX-NEXT:    vunpcklps {{.*#+}} xmm3 = xmm8[0],xmm6[0],xmm8[1],xmm6[1]
...
; AVX-NEXT:    vunpckhps {{.*#+}} xmm4 = xmm2[2],xmm14[2],xmm2[3],xmm14[3]
; AVX-NEXT:    vinsertps {{.*#+}} xmm2 = zero,zero,xmm2[2],xmm14[2]
; AVX-NEXT:    vinsertf128 $1, %xmm4, %ymm2, %ymm2
; AVX-NEXT:    vunpckhps {{.*#+}} xmm4 = xmm7[2],xmm9[2],xmm7[3],xmm9[3]
; AVX-NEXT:    vshufps {{.*#+}} xmm7 = xmm9[3,0],xmm7[3,0]
...
; AVX-NEXT:    vunpckhps {{.*#+}} xmm4 = xmm12[2],xmm11[2],xmm12[3],xmm11[3]
; AVX-NEXT:    vinsertps {{.*#+}} xmm7 = zero,zero,xmm12[2],xmm11[2]
; AVX-NEXT:    vinsertf128 $1, %xmm4, %ymm7, %ymm4
; AVX-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm9 # 16-byte Reload
; AVX-NEXT:    vunpckhps {{.*#+}} xmm7 = xmm9[2],xmm5[2],xmm9[3],xmm5[3]
; AVX-NEXT:    vshufps {{.*#+}} xmm5 = xmm5[3,0],xmm9[3,0]
...
; AVX-NEXT:    vunpckhps {{.*#+}} xmm5 = xmm8[2],xmm6[2],xmm8[3],xmm6[3]
...
; AVX-NEXT:    vunpckhps {{.*#+}} xmm6 = xmm8[2],xmm7[2],xmm8[3],xmm7[3]
; AVX-NEXT:    vshufps {{.*#+}} xmm7 = xmm7[3,0],xmm8[3,0]
; AVX-NEXT:    vshufps {{.*#+}} xmm7 = xmm7[2,0,2,3]
...
; AVX-NEXT:    vshufps {{.*#+}} xmm6 = xmm15[3,0],xmm13[3,0]
...
; AVX-NEXT:    vmovaps 16(%rdi), %xmm13
; AVX-NEXT:    vmovaps 16(%rsi), %xmm14
; AVX-NEXT:    vinsertps {{.*#+}} xmm0 = xmm13[1],xmm14[1],zero,zero
; AVX-NEXT:    vunpcklps {{.*#+}} xmm1 = xmm13[0],xmm14[0],xmm13[1],xmm14[1]
; AVX-NEXT:    vinsertf128 $1, %xmm0, %ymm1, %ymm0
...
; AVX-NEXT:    vmovaps %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vinsertps {{.*#+}} xmm0 = xmm1[1],xmm2[1],zero,zero
...
; AVX-NEXT:    vmovlhps {{.*#+}} xmm1 = xmm12[0],xmm10[0]
; AVX-NEXT:    vshufps {{.*#+}} xmm1 = xmm1[0,1,2,0]
; AVX-NEXT:    vunpcklps {{.*#+}} xmm2 = xmm10[0],xmm12[0],xmm10[1],xmm12[1]
; AVX-NEXT:    vinsertf128 $1, %xmm2, %ymm1, %ymm1
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm1[2,3],ymm0[4,5],ymm1[6,7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX-NEXT:    vmovlhps {{.*#+}} xmm1 = xmm8[0],xmm5[0]
; AVX-NEXT:    vshufps {{.*#+}} xmm1 = xmm1[0,1,2,0]
; AVX-NEXT:    vunpcklps {{.*#+}} xmm2 = xmm5[0],xmm8[0],xmm5[1],xmm8[1]
; AVX-NEXT:    vinsertf128 $1, %xmm2, %ymm1, %ymm1
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm1[2,3],ymm0[4,5],ymm1[6,7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX-NEXT:    vinsertps {{.*#+}} xmm0 = xmm9[1],xmm6[1],zero,zero
; AVX-NEXT:    vunpcklps {{.*#+}} xmm1 = xmm9[0],xmm6[0],xmm9[1],xmm6[1]
; AVX-NEXT:    vinsertf128 $1, %xmm0, %ymm1, %ymm0
; AVX-NEXT:    vmovaps (%rcx), %xmm2
; AVX-NEXT:    vmovaps (%rdx), %xmm1
; AVX-NEXT:    vmovlhps {{.*#+}} xmm7 = xmm2[0],xmm1[0]
; AVX-NEXT:    vshufps {{.*#+}} xmm7 = xmm7[0,1,2,0]
; AVX-NEXT:    vunpcklps {{.*#+}} xmm15 = xmm1[0],xmm2[0],xmm1[1],xmm2[1]
...
; AVX-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm7[2],xmm15[2],xmm7[3],xmm15[3]
; AVX-NEXT:    vinsertps {{.*#+}} xmm7 = zero,zero,xmm7[2],xmm15[2]
; AVX-NEXT:    vinsertf128 $1, %xmm0, %ymm7, %ymm0
; AVX-NEXT:    vunpckhps {{.*#+}} xmm7 = xmm13[2],xmm14[2],xmm13[3],xmm14[3]
; AVX-NEXT:    vshufps {{.*#+}} xmm15 = xmm14[3,0],xmm13[3,0]
...
; AVX-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm7[2],xmm13[2],xmm7[3],xmm13[3]
; AVX-NEXT:    vinsertps {{.*#+}} xmm7 = zero,zero,xmm7[2],xmm13[2]
; AVX-NEXT:    vinsertf128 $1, %xmm0, %ymm7, %ymm0
; AVX-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm13 # 16-byte Reload
; AVX-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm14 # 16-byte Reload
; AVX-NEXT:    vunpckhps {{.*#+}} xmm7 = xmm14[2],xmm13[2],xmm14[3],xmm13[3]
; AVX-NEXT:    vshufps {{.*#+}} xmm15 = xmm13[3,0],xmm14[3,0]
; AVX-NEXT:    vshufps {{.*#+}} xmm15 = xmm15[2,0,2,3]
; AVX-NEXT:    vinsertf128 $1, %xmm15, %ymm7, %ymm7
; AVX-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0,1],ymm0[2,3],ymm7[4,5],ymm0[6,7]
; AVX-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm13 # 16-byte Reload
; AVX-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm14 # 16-byte Reload
; AVX-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm13[2],xmm14[2],xmm13[3],xmm14[3]
; AVX-NEXT:    vinsertps {{.*#+}} xmm15 = zero,zero,xmm13[2],xmm14[2]
; AVX-NEXT:    vinsertf128 $1, %xmm0, %ymm15, %ymm0
; AVX-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm13 # 16-byte Reload
; AVX-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm14 # 16-byte Reload
; AVX-NEXT:    vunpckhps {{.*#+}} xmm15 = xmm14[2],xmm13[2],xmm14[3],xmm13[3]
; AVX-NEXT:    vshufps {{.*#+}} xmm14 = xmm13[3,0],xmm14[3,0]
...
; AVX-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm13 # 16-byte Reload
; AVX-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm15 # 16-byte Reload
; AVX-NEXT:    vunpckhps {{.*#+}} xmm14 = xmm13[2],xmm15[2],xmm13[3],xmm15[3]
; AVX-NEXT:    vinsertps {{.*#+}} xmm15 = zero,zero,xmm13[2],xmm15[2]
; AVX-NEXT:    vinsertf128 $1, %xmm14, %ymm15, %ymm14
; AVX-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm13 # 16-byte Reload
; AVX-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm15 # 16-byte Reload
; AVX-NEXT:    vunpckhps {{.*#+}} xmm15 = xmm15[2],xmm13[2],xmm15[3],xmm13[3]
...
; AVX-NEXT:    vblendps {{.*#+}} ymm14 = ymm13[0,1],ymm14[2,3],ymm13[4,5],ymm14[6,7]
; AVX-NEXT:    vunpckhps {{.*#+}} xmm13 = xmm10[2],xmm12[2],xmm10[3],xmm12[3]
; AVX-NEXT:    vinsertps {{.*#+}} xmm10 = zero,zero,xmm10[2],xmm12[2]
; AVX-NEXT:    vinsertf128 $1, %xmm13, %ymm10, %ymm10
; AVX-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm13 # 16-byte Reload
; AVX-NEXT:    vmovaps (%rsp), %xmm15 # 16-byte Reload
; AVX-NEXT:    vunpckhps {{.*#+}} xmm12 = xmm15[2],xmm13[2],xmm15[3],xmm13[3]
; AVX-NEXT:    vshufps {{.*#+}} xmm13 = xmm13[3,0],xmm15[3,0]
; AVX-NEXT:    vshufps {{.*#+}} xmm13 = xmm13[2,0,2,3]
; AVX-NEXT:    vinsertf128 $1, %xmm13, %ymm12, %ymm12
; AVX-NEXT:    vblendps {{.*#+}} ymm10 = ymm12[0,1],ymm10[2,3],ymm12[4,5],ymm10[6,7]
; AVX-NEXT:    vunpckhps {{.*#+}} xmm12 = xmm5[2],xmm8[2],xmm5[3],xmm8[3]
; AVX-NEXT:    vinsertps {{.*#+}} xmm5 = zero,zero,xmm5[2],xmm8[2]
...
; AVX-NEXT:    vshufps {{.*#+}} xmm12 = xmm12[3,0],xmm13[3,0]
; AVX-NEXT:    vshufps {{.*#+}} xmm12 = xmm12[2,0,2,3]
; AVX-NEXT:    vinsertf128 $1, %xmm12, %ymm8, %ymm8
; AVX-NEXT:    vblendps {{.*#+}} ymm5 = ymm8[0,1],ymm5[2,3],ymm8[4,5],ymm5[6,7]
; AVX-NEXT:    vunpckhps {{.*#+}} xmm8 = xmm3[2],xmm4[2],xmm3[3],xmm4[3]
...
; AVX-NEXT:    vshufps {{.*#+}} xmm8 = xmm11[3,0],xmm8[3,0]
; AVX-NEXT:    vshufps {{.*#+}} xmm8 = xmm8[2,0,2,3]
; AVX-NEXT:    vinsertf128 $1, %xmm8, %ymm4, %ymm4
; AVX-NEXT:    vblendps {{.*#+}} ymm3 = ymm4[0,1],ymm3[2,3],ymm4[4,5],ymm3[6,7]
; AVX-NEXT:    vunpckhps {{.*#+}} xmm4 = xmm1[2],xmm2[2],xmm1[3],xmm2[3]
; AVX-NEXT:    vinsertps {{.*#+}} xmm1 = zero,zero,xmm1[2],xmm2[2]
; AVX-NEXT:    vinsertf128 $1, %xmm4, %ymm1, %ymm1
; AVX-NEXT:    vunpckhps {{.*#+}} xmm2 = xmm9[2],xmm6[2],xmm9[3],xmm6[3]
; AVX-NEXT:    vshufps {{.*#+}} xmm4 = xmm6[3,0],xmm9[3,0]
...
; AVX-NEXT:    vmovaps %ymm10, 224(%r8)
; AVX-NEXT:    vmovaps %ymm14, 160(%r8)
; AVX-NEXT:    vmovaps %ymm0, 352(%r8)
; AVX-NEXT:    vmovaps %ymm7, 288(%r8)
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX-NEXT:    vmovaps %ymm0, 96(%r8)
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX-NEXT:    vmovaps %ymm0, (%r8)
...
; AVX:       # %bb.0:
; AVX-NEXT:    subq $1272, %rsp # imm = 0x4F8
...
; AVX-NEXT:    vinsertps {{.*#+}} xmm0 = xmm8[1],xmm15[1],zero,zero
; AVX-NEXT:    vunpcklps {{.*#+}} xmm1 = xmm8[0],xmm15[0],xmm8[1],xmm15[1]
; AVX-NEXT:    vinsertf128 $1, %xmm0, %ymm1, %ymm0
...
; AVX-NEXT:    vinsertf128 $1, %xmm0, %ymm1, %ymm0
; AVX-NEXT:    vmovlhps {{.*#+}} xmm1 = xmm7[0],xmm14[0]
; AVX-NEXT:    vshufps {{.*#+}} xmm1 = xmm1[0,1,2,0]
; AVX-NEXT:    vunpcklps {{.*#+}} xmm2 = xmm14[0],xmm7[0],xmm14[1],xmm7[1]
; AVX-NEXT:    vinsertf128 $1, %xmm2, %ymm1, %ymm1
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm1[2,3],ymm0[4,5],ymm1[6,7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovaps 48(%rdi), %xmm2
...
; AVX-NEXT:    vmovaps %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vmovlhps {{.*#+}} xmm1 = xmm9[0],xmm2[0]
; AVX-NEXT:    vshufps {{.*#+}} xmm1 = xmm1[0,1,2,0]
...
; AVX-NEXT:    vunpcklps {{.*#+}} xmm1 = xmm1[0],xmm2[0],xmm1[1],xmm2[1]
; AVX-NEXT:    vinsertf128 $1, %xmm0, %ymm1, %ymm0
; AVX-NEXT:    vmovaps 208(%rcx), %xmm2
; AVX-NEXT:    vmovaps %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vmovaps 208(%rdx), %xmm13
...
; AVX-NEXT:    vmovlhps {{.*#+}} xmm1 = xmm12[0],xmm11[0]
; AVX-NEXT:    vshufps {{.*#+}} xmm1 = xmm1[0,1,2,0]
; AVX-NEXT:    vunpcklps {{.*#+}} xmm2 = xmm11[0],xmm12[0],xmm11[1],xmm12[1]
; AVX-NEXT:    vinsertf128 $1, %xmm2, %ymm1, %ymm1
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm1[2,3],ymm0[4,5],ymm1[6,7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX-NEXT:    vunpcklps {{.*#+}} xmm1 = xmm2[0],xmm1[0],xmm2[1],xmm1[1]
; AVX-NEXT:    vinsertf128 $1, %xmm0, %ymm1, %ymm0
; AVX-NEXT:    vmovaps 240(%rcx), %xmm10
; AVX-NEXT:    vmovaps 240(%rdx), %xmm9
...
; AVX-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm1[2],xmm2[2],xmm1[3],xmm2[3]
; AVX-NEXT:    vinsertps {{.*#+}} xmm1 = zero,zero,xmm1[2],xmm2[2]
; AVX-NEXT:    vinsertf128 $1, %xmm0, %ymm1, %ymm0
; AVX-NEXT:    vunpckhps {{.*#+}} xmm1 = xmm8[2],xmm15[2],xmm8[3],xmm15[3]
; AVX-NEXT:    vshufps {{.*#+}} xmm2 = xmm15[3,0],xmm8[3,0]
; AVX-NEXT:    vshufps {{.*#+}} xmm2 = xmm2[2,0,2,3]
; AVX-NEXT:    vinsertf128 $1, %xmm2, %ymm1, %ymm1
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1],ymm0[2,3],ymm1[4,5],ymm0[6,7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX-NEXT:    vinsertps {{.*#+}} xmm1 = zero,zero,xmm2[2],xmm1[2]
; AVX-NEXT:    vinsertf128 $1, %xmm0, %ymm1, %ymm0
...
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1],ymm0[2,3],ymm1[4,5],ymm0[6,7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm14[2],xmm7[2],xmm14[3],xmm7[3]
; AVX-NEXT:    vinsertps {{.*#+}} xmm1 = zero,zero,xmm14[2],xmm7[2]
; AVX-NEXT:    vinsertf128 $1, %xmm0, %ymm1, %ymm0
; AVX-NEXT:    vunpckhps {{.*#+}} xmm1 = xmm3[2],xmm4[2],xmm3[3],xmm4[3]
; AVX-NEXT:    vshufps {{.*#+}} xmm2 = xmm4[3,0],xmm3[3,0]
; AVX-NEXT:    vshufps {{.*#+}} xmm2 = xmm2[2,0,2,3]
; AVX-NEXT:    vinsertf128 $1, %xmm2, %ymm1, %ymm1
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1],ymm0[2,3],ymm1[4,5],ymm0[6,7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX-NEXT:    vunpckhps {{.*#+}} xmm1 = xmm3[2],xmm2[2],xmm3[3],xmm2[3]
; AVX-NEXT:    vshufps {{.*#+}} xmm2 = xmm2[3,0],xmm3[3,0]
; AVX-NEXT:    vshufps {{.*#+}} xmm2 = xmm2[2,0,2,3]
; AVX-NEXT:    vinsertf128 $1, %xmm2, %ymm1, %ymm1
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1],ymm0[2,3],ymm1[4,5],ymm0[6,7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX-NEXT:    vshufps {{.*#+}} xmm2 = xmm2[2,0,2,3]
; AVX-NEXT:    vinsertf128 $1, %xmm2, %ymm1, %ymm1
; AVX-NEXT:    vblendps {{.*#+}} ymm8 = ymm1[0,1],ymm0[2,3],ymm1[4,5],ymm0[6,7]
; AVX-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm1 # 16-byte Reload
; AVX-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm2 # 16-byte Reload
; AVX-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm1[2],xmm2[2],xmm1[3],xmm2[3]
; AVX-NEXT:    vinsertps {{.*#+}} xmm1 = zero,zero,xmm1[2],xmm2[2]
...
; AVX-NEXT:    vshufps {{.*#+}} xmm2 = xmm2[2,0,2,3]
; AVX-NEXT:    vinsertf128 $1, %xmm2, %ymm1, %ymm1
; AVX-NEXT:    vblendps {{.*#+}} ymm6 = ymm1[0,1],ymm0[2,3],ymm1[4,5],ymm0[6,7]
; AVX-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm1 # 16-byte Reload
; AVX-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm2 # 16-byte Reload
; AVX-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm1[2],xmm2[2],xmm1[3],xmm2[3]
; AVX-NEXT:    vinsertps {{.*#+}} xmm1 = zero,zero,xmm1[2],xmm2[2]
...
; AVX-NEXT:    vshufps {{.*#+}} xmm2 = xmm2[2,0,2,3]
; AVX-NEXT:    vinsertf128 $1, %xmm2, %ymm1, %ymm1
; AVX-NEXT:    vblendps {{.*#+}} ymm5 = ymm1[0,1],ymm0[2,3],ymm1[4,5],ymm0[6,7]
; AVX-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm1 # 16-byte Reload
; AVX-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm2 # 16-byte Reload
; AVX-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm1[2],xmm2[2],xmm1[3],xmm2[3]
; AVX-NEXT:    vinsertps {{.*#+}} xmm1 = zero,zero,xmm1[2],xmm2[2]
...
; AVX-NEXT:    vshufps {{.*#+}} xmm2 = xmm2[2,0,2,3]
; AVX-NEXT:    vinsertf128 $1, %xmm2, %ymm1, %ymm1
; AVX-NEXT:    vblendps {{.*#+}} ymm4 = ymm1[0,1],ymm0[2,3],ymm1[4,5],ymm0[6,7]
; AVX-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm1 # 16-byte Reload
; AVX-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm2 # 16-byte Reload
; AVX-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm1[2],xmm2[2],xmm1[3],xmm2[3]
; AVX-NEXT:    vinsertps {{.*#+}} xmm1 = zero,zero,xmm1[2],xmm2[2]
...
; AVX-NEXT:    vshufps {{.*#+}} xmm2 = xmm2[2,0,2,3]
; AVX-NEXT:    vinsertf128 $1, %xmm2, %ymm1, %ymm1
; AVX-NEXT:    vblendps {{.*#+}} ymm3 = ymm1[0,1],ymm0[2,3],ymm1[4,5],ymm0[6,7]
; AVX-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm1 # 16-byte Reload
; AVX-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm2 # 16-byte Reload
; AVX-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm1[2],xmm2[2],xmm1[3],xmm2[3]
; AVX-NEXT:    vinsertps {{.*#+}} xmm1 = zero,zero,xmm1[2],xmm2[2]
...
; AVX-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm2 # 16-byte Reload
; AVX-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm14 # 16-byte Reload
; AVX-NEXT:    vunpckhps {{.*#+}} xmm1 = xmm14[2],xmm2[2],xmm14[3],xmm2[3]
; AVX-NEXT:    vshufps {{.*#+}} xmm2 = xmm2[3,0],xmm14[3,0]
; AVX-NEXT:    vshufps {{.*#+}} xmm2 = xmm2[2,0,2,3]
; AVX-NEXT:    vinsertf128 $1, %xmm2, %ymm1, %ymm1
...
; AVX-NEXT:    vinsertps {{.*#+}} xmm1 = zero,zero,xmm1[2],xmm14[2]
; AVX-NEXT:    vinsertf128 $1, %xmm0, %ymm1, %ymm0
; AVX-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm14 # 16-byte Reload
; AVX-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm15 # 16-byte Reload
; AVX-NEXT:    vunpckhps {{.*#+}} xmm1 = xmm15[2],xmm14[2],xmm15[3],xmm14[3]
; AVX-NEXT:    vshufps {{.*#+}} xmm14 = xmm14[3,0],xmm15[3,0]
; AVX-NEXT:    vshufps {{.*#+}} xmm14 = xmm14[2,0,2,3]
; AVX-NEXT:    vinsertf128 $1, %xmm14, %ymm1, %ymm1
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1],ymm0[2,3],ymm1[4,5],ymm0[6,7]
; AVX-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm14 # 16-byte Reload
; AVX-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm15 # 16-byte Reload
; AVX-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm14[2],xmm15[2],xmm14[3],xmm15[3]
; AVX-NEXT:    vinsertps {{.*#+}} xmm14 = zero,zero,xmm14[2],xmm15[2]
...
; AVX-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm15 # 16-byte Reload
; AVX-NEXT:    vunpckhps {{.*#+}} xmm14 = xmm13[2],xmm15[2],xmm13[3],xmm15[3]
; AVX-NEXT:    vinsertps {{.*#+}} xmm13 = zero,zero,xmm13[2],xmm15[2]
...
; AVX-NEXT:    vunpckhps {{.*#+}} xmm14 = xmm11[2],xmm12[2],xmm11[3],xmm12[3]
; AVX-NEXT:    vinsertps {{.*#+}} xmm11 = zero,zero,xmm11[2],xmm12[2]
; AVX-NEXT:    vinsertf128 $1, %xmm14, %ymm11, %ymm11
; AVX-NEXT:    vmovaps (%rsp), %xmm14 # 16-byte Reload
; AVX-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm15 # 16-byte Reload
; AVX-NEXT:    vunpckhps {{.*#+}} xmm12 = xmm15[2],xmm14[2],xmm15[3],xmm14[3]
; AVX-NEXT:    vshufps {{.*#+}} xmm14 = xmm14[3,0],xmm15[3,0]
; AVX-NEXT:    vshufps {{.*#+}} xmm14 = xmm14[2,0,2,3]
; AVX-NEXT:    vinsertf128 $1, %xmm14, %ymm12, %ymm12
; AVX-NEXT:    vblendps {{.*#+}} ymm11 = ymm12[0,1],ymm11[2,3],ymm12[4,5],ymm11[6,7]
; AVX-NEXT:    vunpckhps {{.*#+}} xmm12 = xmm9[2],xmm10[2],xmm9[3],xmm10[3]
; AVX-NEXT:    vinsertps {{.*#+}} xmm9 = zero,zero,xmm9[2],xmm10[2]
; AVX-NEXT:    vinsertf128 $1, %xmm12, %ymm9, %ymm9
; AVX-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm12 # 16-byte Reload
; AVX-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm14 # 16-byte Reload
; AVX-NEXT:    vunpckhps {{.*#+}} xmm10 = xmm14[2],xmm12[2],xmm14[3],xmm12[3]
; AVX-NEXT:    vshufps {{.*#+}} xmm12 = xmm12[3,0],xmm14[3,0]
; AVX-NEXT:    vshufps {{.*#+}} xmm12 = xmm12[2,0,2,3]
; AVX-NEXT:    vinsertf128 $1, %xmm12, %ymm10, %ymm10
; AVX-NEXT:    vblendps {{.*#+}} ymm9 = ymm10[0,1],ymm9[2,3],ymm10[4,5],ymm9[6,7]
; AVX-NEXT:    vmovaps %ymm9, 992(%r8)
; AVX-NEXT:    vmovaps %ymm11, 928(%r8)
; AVX-NEXT:    vmovaps %ymm13, 864(%r8)
; AVX-NEXT:    vmovaps %ymm0, 800(%r8)
; AVX-NEXT:    vmovaps %ymm1, 736(%r8)
; AVX-NEXT:    vmovaps %ymm2, 672(%r8)
; AVX-NEXT:    vmovaps %ymm3, 608(%r8)
; AVX-NEXT:    vmovaps %ymm4, 544(%r8)
; AVX-NEXT:    vmovaps %ymm5, 480(%r8)
; AVX-NEXT:    vmovaps %ymm6, 416(%r8)
; AVX-NEXT:    vmovaps %ymm7, 352(%r8)
; AVX-NEXT:    vmovaps %ymm8, 288(%r8)
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX-NEXT:    vmovaps %ymm0, (%r8)
; AVX-NEXT:    addq $1272, %rsp # imm = 0x4F8
; AVX-NEXT:    vzeroupper
; AVX-NEXT:    retq
;
