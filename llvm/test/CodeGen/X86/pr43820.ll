...
; CHECK-NEXT:    shrdq $24, %rax, {{[-0-9]+}}(%r{{[sb]}}p) # 8-byte Folded Spill
; CHECK-NEXT:    movq {{[-0-9]+}}(%r{{[sb]}}p), %rcx # 8-byte Reload
; CHECK-NEXT:    shrdq $24, %rcx, %rax
; CHECK-NEXT:    movq %rax, %rcx
; CHECK-NEXT:    shrdq $24, %rbp, {{[-0-9]+}}(%r{{[sb]}}p) # 8-byte Folded Spill
; CHECK-NEXT:    shrdq $24, %r13, %rbp
; CHECK-NEXT:    shrdq $24, %r12, %r13
; CHECK-NEXT:    shrdq $24, %rbx, %r12
; CHECK-NEXT:    shrdq $24, %rdi, %rbx
; CHECK-NEXT:    shrdq $24, %rdx, %rdi
; CHECK-NEXT:    shrdq $24, %rsi, %rdx
; CHECK-NEXT:    movq {{[-0-9]+}}(%r{{[sb]}}p), %rax # 8-byte Reload
; CHECK-NEXT:    movq %rdx, 112(%rax)
; CHECK-NEXT:    movq %rdi, 104(%rax)
; CHECK-NEXT:    movq %rbx, 96(%rax)
; CHECK-NEXT:    movq %r12, 88(%rax)
; CHECK-NEXT:    movq %r13, 80(%rax)
; CHECK-NEXT:    movq %rbp, 72(%rax)
; CHECK-NEXT:    movq {{[-0-9]+}}(%r{{[sb]}}p), %rdx # 8-byte Reload
; CHECK-NEXT:    movq %rdx, 64(%rax)
; CHECK-NEXT:    movq %rcx, 56(%rax)
; CHECK-NEXT:    movq {{[-0-9]+}}(%r{{[sb]}}p), %rdx # 8-byte Reload
; CHECK-NEXT:    movq %rdx, 48(%rax)
; CHECK-NEXT:    movq %r8, 40(%rax)
; CHECK-NEXT:    movq %r9, 32(%rax)
; CHECK-NEXT:    movq %r11, 24(%rax)
; CHECK-NEXT:    movq %r14, 16(%rax)
; CHECK-NEXT:    movq %r15, 8(%rax)
