...
define void @foo(i32 %M, i32 %N, i32 %K, ptr %A, ptr %B_rcr4, ptr %C, i32 %c_row_from, i32 %c_row_to, i32 %c_row_tile, i32 %c_col_from, i32 %c_col_to, i32 %c_col_tile) {
  ...
  ; CHECK-NEXT:   MOV32mr %stack.6, 1, $noreg, 0, $noreg, [[LEA64_32r1]] :: (store (s32) into %stack.6)
  ...
  ; CHECK-NEXT:   [[MOVSX64rr32_2:%[0-9]+]]:gr64 = MOVSX64rr32 [[COPY3]].sub_32bit
  ...
  ; CHECK-NEXT:   MOV64mr %stack.7, 1, $noreg, 0, $noreg, [[MOVSX64rm32_1]] :: (store (s64) into %stack.7)
  ...
  ; CHECK-NEXT:   MOV64mr %stack.10, 1, $noreg, 0, $noreg, [[MOVSX64rr32_6]] :: (store (s64) into %stack.10)
  ...
  ; CHECK-NEXT:   MOV64mr %stack.11, 1, $noreg, 0, $noreg, [[LEA64r]] :: (store (s64) into %stack.11)
  ; CHECK-NEXT:   [[COPY7:%[0-9]+]]:gr64_nosp = COPY [[MOVSX64rr32_2]]
  ...
  ; CHECK-NEXT:   [[COPY8:%[0-9]+]]:gr64 = IMUL64rr [[COPY8]], [[COPY7]], implicit-def dead $eflags
  ; CHECK-NEXT:   [[COPY8:%[0-9]+]]:gr64 = SHL64ri [[COPY8]], 2, implicit-def dead $eflags
  ; CHECK-NEXT:   MOV64mr %stack.12, 1, $noreg, 0, $noreg, [[COPY8]] :: (store (s64) into %stack.12)
  ...
  ; CHECK-NEXT:   MOV32mr %stack.14, 1, $noreg, 0, $noreg, [[LEA64_32r3]] :: (store (s32) into %stack.14)
  ; CHECK-NEXT:   MOV32mr %stack.15, 1, $noreg, 0, $noreg, [[COPY4]] :: (store (s32) into %stack.15)
  ; CHECK-NEXT: {{  $}}
  ...
  ; CHECK-NEXT:   [[MOV32rm5:%[0-9]+]]:gr32 = MOV32rm %stack.6, 1, $noreg, 0, $noreg :: (load (s32) from %stack.6)
  ; CHECK-NEXT:   [[MOV64rm2:%[0-9]+]]:gr64 = MOV64rm %stack.7, 1, $noreg, 0, $noreg :: (load (s64) from %stack.7)
  ...
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT:   [[MOV64rm4:%[0-9]+]]:gr64 = MOV64rm %stack.8, 1, $noreg, 0, $noreg :: (load (s64) from %stack.8)
  ...
  ; CHECK-NEXT:   MOV64mr %stack.16, 1, $noreg, 0, $noreg, [[MOV64rm4]] :: (store (s64) into %stack.16)
  ...
  ; CHECK-NEXT:   [[MOV64rm5:%[0-9]+]]:gr64 = MOV64rm %stack.11, 1, $noreg, 0, $noreg :: (load (s64) from %stack.11)
  ...
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT:   [[MOV64rm7:%[0-9]+]]:gr64 = MOV64rm %stack.8, 1, $noreg, 0, $noreg :: (load (s64) from %stack.8)
  ; CHECK-NEXT:   [[MOV64rm7:%[0-9]+]]:gr64 = ADD64rm [[MOV64rm7]], %stack.9, 1, $noreg, 0, $noreg, implicit-def dead $eflags :: (load (s64) from %stack.9)
  ; CHECK-NEXT:   [[MOV64rm8:%[0-9]+]]:gr64 = MOV64rm %stack.12, 1, $noreg, 0, $noreg :: (load (s64) from %stack.12)
  ; CHECK-NEXT:   ADD64mr %stack.11, 1, $noreg, 0, $noreg, [[MOV64rm8]], implicit-def dead $eflags :: (store (s64) into %stack.11)
  ; CHECK-NEXT:   MOV64mr %stack.8, 1, $noreg, 0, $noreg, [[MOV64rm7]] :: (store (s64) into %stack.8)
  ; CHECK-NEXT:   CMP64rm [[MOV64rm7]], %stack.10, 1, $noreg, 0, $noreg, implicit-def $eflags :: (load (s64) from %stack.10)
  ...
  ; CHECK-NEXT:   [[MOV64rm9:%[0-9]+]]:gr64 = MOV64rm %stack.16, 1, $noreg, 0, $noreg :: (load (s64) from %stack.16)
  ; CHECK-NEXT:   [[PTILELOADDV:%[0-9]+]]:tile = PTILELOADDV [[MOV32rm3]].sub_16bit, [[COPY4]].sub_16bit, [[MOV64rm9]], 1, [[MOVSX64rr32_]], 0, $noreg
  ; CHECK-NEXT:   [[COPY9:%[0-9]+]]:gr64_nosp = MOVSX64rr32 [[COPY9]].sub_32bit
  ; CHECK-NEXT:   [[COPY10:%[0-9]+]]:gr64 = COPY [[COPY1]]
  ; CHECK-NEXT:   [[COPY11:%[0-9]+]]:gr64 = COPY [[MOVSX64rr32_]]
  ; CHECK-NEXT:   [[COPY12:%[0-9]+]]:gr64 = COPY [[COPY7]]
  ; CHECK-NEXT:   [[COPY13:%[0-9]+]]:gr32 = COPY [[MOV32rm3]]
  ; CHECK-NEXT:   [[COPY14:%[0-9]+]]:gr64 = COPY [[MOV32rm2]]
  ; CHECK-NEXT:   [[LEA64r2:%[0-9]+]]:gr64 = LEA64r [[COPY10]], 1, [[COPY9]], 0, $noreg
  ; CHECK-NEXT:   [[COPY15:%[0-9]+]]:gr32 = COPY [[MOV32rm5]]
  ; CHECK-NEXT:   [[COPY16:%[0-9]+]]:gr64 = COPY [[MOV64rm3]]
  ; CHECK-NEXT:   [[COPY17:%[0-9]+]]:gr64 = COPY [[MOV64rm2]]
  ; CHECK-NEXT:   [[COPY18:%[0-9]+]]:gr64 = COPY [[MOV64rm1]]
  ; CHECK-NEXT:   [[COPY19:%[0-9]+]]:gr64_nosp = COPY [[MOV64rm]]
  ; CHECK-NEXT:   [[MOV32rm7:%[0-9]+]]:gr32 = MOV32rm %stack.2, 1, $noreg, 0, $noreg :: (load (s32) from %stack.2)
  ; CHECK-NEXT:   [[PTILELOADDV1:%[0-9]+]]:tile = PTILELOADDV [[MOV32rm7]].sub_16bit, [[COPY15]].sub_16bit, [[LEA64r2]], 1, [[COPY19]], 0, $noreg
  ; CHECK-NEXT:   [[MOV64rm:%[0-9]+]]:gr64 = COPY [[COPY19]]
  ; CHECK-NEXT:   [[MOV64rm1:%[0-9]+]]:gr64 = COPY [[COPY18]]
  ; CHECK-NEXT:   [[MOV64rm2:%[0-9]+]]:gr64 = COPY [[COPY17]]
  ; CHECK-NEXT:   [[MOV64rm3:%[0-9]+]]:gr64 = COPY [[COPY16]]
  ; CHECK-NEXT:   [[MOV32rm5:%[0-9]+]]:gr32 = COPY [[COPY15]]
  ; CHECK-NEXT:   [[MOV32rm2:%[0-9]+]]:gr64_nosp = COPY [[COPY14]]
  ; CHECK-NEXT:   [[MOV32rm3:%[0-9]+]]:gr32 = COPY [[COPY13]]
  ; CHECK-NEXT:   [[COPY4:%[0-9]+]]:gr32 = MOV32rm %stack.15, 1, $noreg, 0, $noreg :: (load (s32) from %stack.15)
  ; CHECK-NEXT:   [[COPY7:%[0-9]+]]:gr64_nosp = COPY [[COPY12]]
  ; CHECK-NEXT:   [[MOVSX64rr32_:%[0-9]+]]:gr64_nosp = COPY [[COPY11]]
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:gr64 = COPY [[COPY10]]
  ; CHECK-NEXT:   [[PTILEZEROV:%[0-9]+]]:tile = PTDPBSSDV [[MOV32rm3]].sub_16bit, [[MOV32rm5]].sub_16bit, [[COPY4]].sub_16bit, [[PTILEZEROV]], [[PTILELOADDV]], [[PTILELOADDV1]]
  ; CHECK-NEXT:   PTILESTOREDV [[MOV32rm3]].sub_16bit, [[MOV32rm2]].sub_16bit, [[MOV64rm5]], 1, [[COPY7]], 0, $noreg, [[PTILEZEROV]]
  ...
  ; CHECK-NEXT:   [[COPY9:%[0-9]+]].sub_32bit:gr64_nosp = ADD32rr [[COPY9]].sub_32bit, [[MOV32rm5]], implicit-def dead $eflags
