...
; THUMBV7-NEXT:    ldr r0, [sp, #88]
; THUMBV7-NEXT:    ldr.w lr, [sp, #92]
; THUMBV7-NEXT:    umull r1, r5, r2, r4
; THUMBV7-NEXT:    umull r10, r9, lr, r2
; THUMBV7-NEXT:    str r1, [sp, #24] @ 4-byte Spill
; THUMBV7-NEXT:    umull r1, r11, r3, r0
; THUMBV7-NEXT:    umull r0, r7, r0, r2
; THUMBV7-NEXT:    str r1, [sp, #12] @ 4-byte Spill
; THUMBV7-NEXT:    ldr r1, [sp, #84]
; THUMBV7-NEXT:    str r0, [sp, #32] @ 4-byte Spill
; THUMBV7-NEXT:    ldrd r6, r0, [sp, #72]
; THUMBV7-NEXT:    umull r6, r12, r1, r6
; THUMBV7-NEXT:    str r6, [sp, #16] @ 4-byte Spill
; THUMBV7-NEXT:    umull r6, r1, r0, r4
; THUMBV7-NEXT:    str r6, [sp, #8] @ 4-byte Spill
; THUMBV7-NEXT:    ldr r6, [sp, #84]
; THUMBV7-NEXT:    umull r6, r2, r2, r6
; THUMBV7-NEXT:    strd r6, r2, [sp] @ 8-byte Folded Spill
; THUMBV7-NEXT:    ldr r2, [sp, #72]
; THUMBV7-NEXT:    umull r2, r6, r2, r4
; THUMBV7-NEXT:    str r2, [sp, #28] @ 4-byte Spill
; THUMBV7-NEXT:    ldr r2, [sp, #24] @ 4-byte Reload
; THUMBV7-NEXT:    str r6, [sp, #20] @ 4-byte Spill
; THUMBV7-NEXT:    movs r6, #0
; THUMBV7-NEXT:    str.w r2, [r8]
; THUMBV7-NEXT:    umlal r5, r6, r3, r4
; THUMBV7-NEXT:    ldr r2, [sp, #12] @ 4-byte Reload
; THUMBV7-NEXT:    add.w r4, r10, r2
; THUMBV7-NEXT:    adds r2, r7, r4
; THUMBV7-NEXT:    str r2, [sp, #12] @ 4-byte Spill
; THUMBV7-NEXT:    mov.w r2, #0
; THUMBV7-NEXT:    ldr r4, [sp, #84]
; THUMBV7-NEXT:    adc r2, r2, #0
; THUMBV7-NEXT:    str r2, [sp, #24] @ 4-byte Spill
...
; THUMBV7-NEXT:    ldr r1, [sp, #16] @ 4-byte Reload
...
; THUMBV7-NEXT:    ldr r2, [sp, #4] @ 4-byte Reload
; THUMBV7-NEXT:    adcs r2, r6
; THUMBV7-NEXT:    ldr r6, [sp, #84]
; THUMBV7-NEXT:    adc r7, r4, #0
; THUMBV7-NEXT:    umlal r2, r7, r3, r6
; THUMBV7-NEXT:    ldr r6, [sp, #20] @ 4-byte Reload
; THUMBV7-NEXT:    adds r1, r1, r6
; THUMBV7-NEXT:    adc r4, r4, #0
; THUMBV7-NEXT:    orrs r0, r4
; THUMBV7-NEXT:    orrs r0, r5
; THUMBV7-NEXT:    ldrd r5, r4, [sp, #28] @ 8-byte Folded Reload
; THUMBV7-NEXT:    adds r5, r5, r4
; THUMBV7-NEXT:    ldr r4, [sp, #12] @ 4-byte Reload
...
; THUMBV7-NEXT:    str.w r2, [r8, #8]
; THUMBV7-NEXT:    adcs r1, r7
; THUMBV7-NEXT:    str.w r1, [r8, #12]
; THUMBV7-NEXT:    orr.w r1, r3, r9
; THUMBV7-NEXT:    ldr r2, [sp, #24] @ 4-byte Reload
; THUMBV7-NEXT:    orr.w r1, r1, r11
