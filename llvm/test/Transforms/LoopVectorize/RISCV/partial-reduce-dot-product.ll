...
; V-NEXT:    [[TMP10:%.*]] = call i64 @llvm.experimental.get.vector.length.i64.i64(i64 [[AVL]], i32 4, i1 true)
; V-NEXT:    [[TMP6:%.*]] = getelementptr i8, ptr [[A]], i64 [[INDEX]]
; V-NEXT:    [[TMP0:%.*]] = trunc i64 [[TMP10]] to i32
...
; V-NEXT:    [[TMP5:%.*]] = trunc i64 [[TMP10]] to i32
; V-NEXT:    [[WIDE_LOAD1:%.*]] = call <vscale x 4 x i8> @llvm.vp.load.nxv4i8.p0(ptr align 1 [[TMP9]], <vscale x 4 x i1> splat (i1 true), i32 [[TMP5]])
...
; V-NEXT:    [[TMP16:%.*]] = trunc i64 [[TMP10]] to i32
; V-NEXT:    [[TMP13]] = call <vscale x 4 x i32> @llvm.vp.merge.nxv4i32(<vscale x 4 x i1> splat (i1 true), <vscale x 4 x i32> [[TMP7]], <vscale x 4 x i32> [[VEC_PHI]], i32 [[TMP16]])
...
; ZVDOT4A8I-NEXT:    [[TMP7:%.*]] = call i64 @llvm.experimental.get.vector.length.i64.i64(i64 [[AVL]], i32 4, i1 true)
; ZVDOT4A8I-NEXT:    [[TMP6:%.*]] = getelementptr i8, ptr [[A]], i64 [[INDEX]]
; ZVDOT4A8I-NEXT:    [[TMP0:%.*]] = trunc i64 [[TMP7]] to i32
...
; ZVDOT4A8I-NEXT:    [[TMP4:%.*]] = trunc i64 [[TMP7]] to i32
; ZVDOT4A8I-NEXT:    [[WIDE_LOAD1:%.*]] = call <vscale x 4 x i8> @llvm.vp.load.nxv4i8.p0(ptr align 1 [[TMP9]], <vscale x 4 x i1> splat (i1 true), i32 [[TMP4]])
...
; ZVDOT4A8I-NEXT:    [[TMP15:%.*]] = trunc i64 [[TMP7]] to i32
; ZVDOT4A8I-NEXT:    [[TMP10:%.*]] = call <vscale x 4 x i32> @llvm.vp.merge.nxv4i32(<vscale x 4 x i1> splat (i1 true), <vscale x 4 x i32> [[TMP12]], <vscale x 4 x i32> zeroinitializer, i32 [[TMP15]])
