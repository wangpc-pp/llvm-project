...
; IF-EVL-NEXT:    [[TMP21:%.*]] = call i64 @llvm.experimental.get.vector.length.i64.i64(i64 [[TMP9]], i32 4, i1 true)
...
; IF-EVL-NEXT:    [[TMP5:%.*]] = trunc i64 [[TMP21]] to i32
; IF-EVL-NEXT:    [[VP_OP_LOAD3:%.*]] = call <vscale x 4 x i32> @llvm.vp.load.nxv4i32.p0(ptr align 4 [[TMP19]], <vscale x 4 x i1> [[TMP17]], i32 [[TMP5]])
; IF-EVL-NEXT:    [[VP_OP:%.*]] = add <vscale x 4 x i32> [[VP_OP_LOAD]], [[VP_OP_LOAD3]]
; IF-EVL-NEXT:    [[TMP7:%.*]] = trunc i64 [[TMP21]] to i32
; IF-EVL-NEXT:    call void @llvm.vp.store.nxv4i32.p0(<vscale x 4 x i32> [[VP_OP]], ptr align 4 [[TMP19]], <vscale x 4 x i1> [[TMP17]], i32 [[TMP7]])
