...
; CHECK-NEXT:    [[TMP1:%.*]] = trunc i64 [[TMP10]] to i32
...
; CHECK-NEXT:    call void @llvm.vp.store.nxv2i64.p0(<vscale x 2 x i64> [[REVERSE]], ptr align 8 [[TMP9]], <vscale x 2 x i1> splat (i1 true), i32 [[TMP13]])
