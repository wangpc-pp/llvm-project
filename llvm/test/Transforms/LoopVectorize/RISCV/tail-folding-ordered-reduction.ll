...
; IF-EVL-NEXT:    [[TMP15:%.*]] = call i64 @llvm.experimental.get.vector.length.i64.i64(i64 [[TMP9]], i32 4, i1 true)
...
; IF-EVL-NEXT:    [[TMP3:%.*]] = trunc i64 [[TMP15]] to i32
; IF-EVL-NEXT:    [[TMP14]] = call float @llvm.vp.reduce.fadd.nxv4f32(float [[VEC_PHI]], <vscale x 4 x float> [[VP_OP_LOAD]], <vscale x 4 x i1> splat (i1 true), i32 [[TMP3]])
