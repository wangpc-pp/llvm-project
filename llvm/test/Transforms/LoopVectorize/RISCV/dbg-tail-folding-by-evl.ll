...
; CHECK-NEXT:    [[TMP16:%.*]] = getelementptr i64, ptr [[TMP10]], i64 [[TMP12]], !dbg [[DBG8:![0-9]+]]
; CHECK-NEXT:    [[TMP13:%.*]] = trunc i64 [[TMP5]] to i32, !dbg [[DBG8]]
; CHECK-NEXT:    [[TMP14:%.*]] = call <vscale x 2 x i64> @llvm.experimental.vp.reverse.nxv2i64(<vscale x 2 x i64> [[TMP7]], <vscale x 2 x i1> splat (i1 true), i32 [[TMP13]]), !dbg [[DBG8]]
; CHECK-NEXT:    [[TMP15:%.*]] = trunc i64 [[TMP5]] to i32, !dbg [[DBG8]]
; CHECK-NEXT:    call void @llvm.vp.store.nxv2i64.p0(<vscale x 2 x i64> [[TMP14]], ptr align 8 [[TMP16]], <vscale x 2 x i1> splat (i1 true), i32 [[TMP15]]), !dbg [[DBG8]]
