...
; IF-EVL-NEXT:    [[TMP20:%.*]] = call i64 @llvm.experimental.get.vector.length.i64.i64(i64 [[TMP11]], i32 4, i1 true)
...
; IF-EVL-NEXT:    [[TMP4:%.*]] = trunc i64 [[TMP20]] to i32
; IF-EVL-NEXT:    [[VP_OP_LOAD1:%.*]] = call <vscale x 4 x i32> @llvm.vp.load.nxv4i32.p0(ptr align 4 [[TMP16]], <vscale x 4 x i1> splat (i1 true), i32 [[TMP4]])
...
; IF-EVL-NEXT:    [[TMP7:%.*]] = trunc i64 [[TMP20]] to i32
; IF-EVL-NEXT:    call void @llvm.vp.store.nxv4i32.p0(<vscale x 4 x i32> [[VP_OP]], ptr align 4 [[TMP18]], <vscale x 4 x i1> splat (i1 true), i32 [[TMP7]])
