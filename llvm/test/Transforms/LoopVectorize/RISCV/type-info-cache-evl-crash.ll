...
; CHECK-NEXT:    [[TMP4:%.*]] = trunc i64 [[TMP20]] to i32
; CHECK-NEXT:    [[VP_OP_LOAD:%.*]] = call <vscale x 8 x i8> @llvm.vp.load.nxv8i8.p0(ptr align 1 [[TMP13]], <vscale x 8 x i1> splat (i1 true), i32 [[TMP4]]), !alias.scope [[META0:![0-9]+]]
...
; CHECK-NEXT:    [[TMP9:%.*]] = trunc i64 [[TMP20]] to i32
; CHECK-NEXT:    call void @llvm.vp.scatter.nxv8i8.nxv8p0(<vscale x 8 x i8> [[TMP24]], <vscale x 8 x ptr> align 1 [[BROADCAST_SPLAT]], <vscale x 8 x i1> splat (i1 true), i32 [[TMP9]]), !alias.scope [[META3:![0-9]+]], !noalias [[META0]]
