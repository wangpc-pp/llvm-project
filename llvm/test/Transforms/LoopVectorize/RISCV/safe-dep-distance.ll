...
; CHECK-NEXT:    [[TMP8:%.*]] = trunc i64 [[TMP11]] to i32
...
; CHECK-NEXT:    [[TMP5:%.*]] = trunc i64 [[TMP11]] to i32
; CHECK-NEXT:    call void @llvm.vp.store.nxv2i64.p0(<vscale x 2 x i64> [[VP_OP_LOAD]], ptr align 32 [[TMP10]], <vscale x 2 x i1> splat (i1 true), i32 [[TMP5]])
