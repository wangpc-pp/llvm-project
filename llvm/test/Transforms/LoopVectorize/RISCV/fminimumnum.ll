...
; CHECK-NEXT:    [[TMP20:%.*]] = call i64 @llvm.experimental.get.vector.length.i64.i64(i64 [[AVL]], i32 8, i1 true)
; CHECK-NEXT:    [[TMP2:%.*]] = getelementptr inbounds nuw [4096 x half], ptr [[INPUT1]], i64 0, i64 [[INDEX]]
; CHECK-NEXT:    [[TMP13:%.*]] = trunc i64 [[TMP20]] to i32
...
; CHECK-NEXT:    [[TMP11:%.*]] = trunc i64 [[TMP20]] to i32
; CHECK-NEXT:    [[WIDE_LOAD5:%.*]] = call <vscale x 8 x half> @llvm.vp.load.nxv8f16.p0(ptr align 2 [[TMP4]], <vscale x 8 x i1> splat (i1 true), i32 [[TMP11]])
...
; CHECK-NEXT:    [[TMP16:%.*]] = trunc i64 [[TMP20]] to i32
; CHECK-NEXT:    call void @llvm.vp.store.nxv8f16.p0(<vscale x 8 x half> [[TMP17]], ptr align 2 [[TMP7]], <vscale x 8 x i1> splat (i1 true), i32 [[TMP16]])
...
; ZVFHMIN-NEXT:    [[TMP16:%.*]] = call i64 @llvm.experimental.get.vector.length.i64.i64(i64 [[AVL]], i32 8, i1 true)
; ZVFHMIN-NEXT:    [[TMP13:%.*]] = getelementptr inbounds nuw [4096 x half], ptr [[INPUT1]], i64 0, i64 [[INDEX]]
; ZVFHMIN-NEXT:    [[TMP19:%.*]] = trunc i64 [[TMP16]] to i32
...
; ZVFHMIN-NEXT:    [[TMP20:%.*]] = trunc i64 [[TMP16]] to i32
; ZVFHMIN-NEXT:    [[WIDE_LOAD5:%.*]] = call <vscale x 8 x half> @llvm.vp.load.nxv8f16.p0(ptr align 2 [[TMP15]], <vscale x 8 x i1> splat (i1 true), i32 [[TMP20]])
...
; ZVFHMIN-NEXT:    [[TMP21:%.*]] = trunc i64 [[TMP16]] to i32
; ZVFHMIN-NEXT:    call void @llvm.vp.store.nxv8f16.p0(<vscale x 8 x half> [[TMP17]], ptr align 2 [[TMP18]], <vscale x 8 x i1> splat (i1 true), i32 [[TMP21]])
