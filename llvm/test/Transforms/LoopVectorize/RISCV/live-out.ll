...
; RV64-NEXT:    [[TMP2:%.*]] = call i64 @llvm.experimental.get.vector.length.i64.i64(i64 [[AVL]], i32 4, i1 true)
; RV64-NEXT:    [[TMP1:%.*]] = getelementptr i32, ptr [[P]], i64 [[CURRENT_ITERATION_IV]]
; RV64-NEXT:    [[TMP0:%.*]] = trunc i64 [[TMP2]] to i32
...
; RV32-NEXT:    [[TMP2:%.*]] = call i64 @llvm.experimental.get.vector.length.i64.i64(i64 [[AVL]], i32 4, i1 true)
; RV32-NEXT:    [[TMP1:%.*]] = getelementptr i32, ptr [[P]], i64 [[CURRENT_ITERATION_IV]]
; RV32-NEXT:    [[TMP0:%.*]] = trunc i64 [[TMP2]] to i32
...
; RV32:       [[MIDDLE_BLOCK]]:
; RV32-NEXT:    [[TMP6:%.*]] = trunc i64 [[TMP2]] to i32
; RV32-NEXT:    [[TMP4:%.*]] = sub i32 [[TMP6]], 1
...
; ZVE32X-NEXT:    [[TMP2:%.*]] = call i64 @llvm.experimental.get.vector.length.i64.i64(i64 [[AVL]], i32 4, i1 true)
; ZVE32X-NEXT:    [[TMP1:%.*]] = getelementptr i32, ptr [[P]], i64 [[CURRENT_ITERATION_IV]]
; ZVE32X-NEXT:    [[TMP0:%.*]] = trunc i64 [[TMP2]] to i32
...
; ZVE32X:       [[MIDDLE_BLOCK]]:
; ZVE32X-NEXT:    [[TMP6:%.*]] = trunc i64 [[TMP2]] to i32
; ZVE32X-NEXT:    [[TMP4:%.*]] = sub i32 [[TMP6]], 1
