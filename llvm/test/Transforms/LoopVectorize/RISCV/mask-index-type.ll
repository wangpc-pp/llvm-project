...
; VLENUNK-NEXT:    [[TMP15:%.*]] = call i64 @llvm.experimental.get.vector.length.i64.i64(i64 [[AVL]], i32 4, i1 true)
...
; VLENUNK-NEXT:    [[TMP7:%.*]] = trunc i64 [[TMP15]] to i32
...
; VLENUNK-NEXT:    [[TMP8:%.*]] = trunc i64 [[TMP15]] to i32
; VLENUNK-NEXT:    call void @llvm.vp.store.nxv4i32.p0(<vscale x 4 x i32> [[TMP17]], ptr align 4 [[TMP18]], <vscale x 4 x i1> splat (i1 true), i32 [[TMP8]])
