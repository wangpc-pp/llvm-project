...
// CHECK-NEXT:     xtheadfmemidxlx      1.0       'XTHeadFMemIdxLX' (T-Head FP Indexed Load Memory Operations)
// CHECK-NEXT:     xtheadfmemidxsx      1.0       'XTHeadFMemIdxSX' (T-Head FP Indexed Store Memory Operations)
...
// CHECK-NEXT:     xtheadmemidxlx       1.0       'XTHeadMemIdxLX' (T-Head Indexed Load Memory Operations)
// CHECK-NEXT:     xtheadmemidxlxia     1.0       'XTHeadMemIdxLXIA' (T-Head Post-Increment Indexed Memory Operations)
// CHECK-NEXT:     xtheadmemidxlxib     1.0       'XTHeadMemIdxLXIB' (T-Head Post-Increment Indexed Memory Operations)
// CHECK-NEXT:     xtheadmemidxsx       1.0       'XTHeadMemIdxSX' (T-Head Indexed Store Memory Operations)
// CHECK-NEXT:     xtheadmemidxsxia     1.0       'XTHeadMemIdxSXIA' (T-Head Post-Increment Indexed Memory Operations)
// CHECK-NEXT:     xtheadmemidxsxib     1.0       'XTHeadMemIdxSXIB' (T-Head Post-Increment Indexed Memory Operations)
